...
class CommutativeMatcher138431(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138431._instance is None:
            CommutativeMatcher138431._instance = CommutativeMatcher138431()
        return CommutativeMatcher138431._instance
