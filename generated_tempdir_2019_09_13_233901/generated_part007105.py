...
class CommutativeMatcher66343(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher66343._instance is None:
            CommutativeMatcher66343._instance = CommutativeMatcher66343()
        return CommutativeMatcher66343._instance
