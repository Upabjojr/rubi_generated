...
class CommutativeMatcher60059(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60059._instance is None:
            CommutativeMatcher60059._instance = CommutativeMatcher60059()
        return CommutativeMatcher60059._instance
