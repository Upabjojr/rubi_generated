...
class CommutativeMatcher101292(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher101292._instance is None:
            CommutativeMatcher101292._instance = CommutativeMatcher101292()
        return CommutativeMatcher101292._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher101297.get()
                tmp7 = subjects6
                subjects6 = []
                for s in tmp7:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher101300.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001226 import *
from collections import deque
from .generated_part001225 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset