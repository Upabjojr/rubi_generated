...
class CommutativeMatcher126519(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126519._instance is None:
            CommutativeMatcher126519._instance = CommutativeMatcher126519()
        return CommutativeMatcher126519._instance
