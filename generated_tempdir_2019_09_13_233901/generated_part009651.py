...
class CommutativeMatcher13543(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13543._instance is None:
            CommutativeMatcher13543._instance = CommutativeMatcher13543()
        return CommutativeMatcher13543._instance
