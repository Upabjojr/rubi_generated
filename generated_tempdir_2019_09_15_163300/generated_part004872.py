...
class CommutativeMatcher12622(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12622._instance is None:
            CommutativeMatcher12622._instance = CommutativeMatcher12622()
        return CommutativeMatcher12622._instance
