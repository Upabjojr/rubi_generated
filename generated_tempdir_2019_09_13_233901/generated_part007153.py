...
class CommutativeMatcher113992(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113992._instance is None:
            CommutativeMatcher113992._instance = CommutativeMatcher113992()
        return CommutativeMatcher113992._instance
