...
class CommutativeMatcher81244(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81244._instance is None:
            CommutativeMatcher81244._instance = CommutativeMatcher81244()
        return CommutativeMatcher81244._instance
