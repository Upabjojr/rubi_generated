...
class CommutativeMatcher67335(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67335._instance is None:
            CommutativeMatcher67335._instance = CommutativeMatcher67335()
        return CommutativeMatcher67335._instance
