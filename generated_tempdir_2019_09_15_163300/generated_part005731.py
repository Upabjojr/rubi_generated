...
class CommutativeMatcher32398(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32398._instance is None:
            CommutativeMatcher32398._instance = CommutativeMatcher32398()
        return CommutativeMatcher32398._instance
