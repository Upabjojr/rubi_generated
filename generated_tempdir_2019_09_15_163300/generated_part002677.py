...
class CommutativeMatcher93096(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93096._instance is None:
            CommutativeMatcher93096._instance = CommutativeMatcher93096()
        return CommutativeMatcher93096._instance
