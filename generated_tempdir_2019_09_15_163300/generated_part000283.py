...
class CommutativeMatcher140806(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140806._instance is None:
            CommutativeMatcher140806._instance = CommutativeMatcher140806()
        return CommutativeMatcher140806._instance
