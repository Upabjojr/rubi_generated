...
class CommutativeMatcher106590(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106590._instance is None:
            CommutativeMatcher106590._instance = CommutativeMatcher106590()
        return CommutativeMatcher106590._instance
