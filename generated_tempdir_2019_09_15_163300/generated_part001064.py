...
class CommutativeMatcher51604(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher51604._instance is None:
            CommutativeMatcher51604._instance = CommutativeMatcher51604()
        return CommutativeMatcher51604._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher51607.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
                ...
                for pattern_index, subst2 in matcher.match(tmp4, subst1):
                    ...
                    if pattern_index == 0:
                        ...
                        if len(subjects) == 0:
                            pass
                            # 0: (d + e/(f + x*g))**p /; (cons_f2) and (cons_f3) and (cons_f8) and (cons_f29) and (cons_f50) and (cons_f127) and (cons_f210) and (cons_f5)
                            yield 0, subst2
            ...
            if len(subjects) >= 1:
                ...
                try:
                    ...
                    if len(subjects) == 0:
                        pass
                        # 1: RFx**p /; (cons_f5) and (cons_f1200)
                        yield 1, subst2
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects8) >= 1 and isinstance(subjects8[0], Add):
                ...
                matcher = CommutativeMatcher51657.get()
                tmp11 = subjects10
                subjects10 = []
                for s in tmp11:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001073 import *
from .generated_part001065 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset