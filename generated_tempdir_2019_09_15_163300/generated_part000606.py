...
class CommutativeMatcher42554(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42554._instance is None:
            CommutativeMatcher42554._instance = CommutativeMatcher42554()
        return CommutativeMatcher42554._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42561.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part000607 import *
from multiset import Multiset