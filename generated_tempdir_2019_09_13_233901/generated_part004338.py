...
class CommutativeMatcher149685(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149685._instance is None:
            CommutativeMatcher149685._instance = CommutativeMatcher149685()
        return CommutativeMatcher149685._instance
