...
class CommutativeMatcher135235(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135235._instance is None:
            CommutativeMatcher135235._instance = CommutativeMatcher135235()
        return CommutativeMatcher135235._instance
