...
class CommutativeMatcher20749(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20749._instance is None:
            CommutativeMatcher20749._instance = CommutativeMatcher20749()
        return CommutativeMatcher20749._instance
