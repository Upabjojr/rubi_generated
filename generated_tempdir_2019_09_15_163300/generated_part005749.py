...
class CommutativeMatcher21199(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21199._instance is None:
            CommutativeMatcher21199._instance = CommutativeMatcher21199()
        return CommutativeMatcher21199._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21203.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part005750 import *
from multiset import Multiset