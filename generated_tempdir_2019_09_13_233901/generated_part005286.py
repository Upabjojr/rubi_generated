...
class CommutativeMatcher129498(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129498._instance is None:
            CommutativeMatcher129498._instance = CommutativeMatcher129498()
        return CommutativeMatcher129498._instance
