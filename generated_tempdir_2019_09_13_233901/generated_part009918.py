...
class CommutativeMatcher134899(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134899._instance is None:
            CommutativeMatcher134899._instance = CommutativeMatcher134899()
        return CommutativeMatcher134899._instance
