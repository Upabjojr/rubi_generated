...
class CommutativeMatcher117118(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117118._instance is None:
            CommutativeMatcher117118._instance = CommutativeMatcher117118()
        return CommutativeMatcher117118._instance
