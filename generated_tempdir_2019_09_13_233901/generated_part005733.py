...
class CommutativeMatcher21150(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21150._instance is None:
            CommutativeMatcher21150._instance = CommutativeMatcher21150()
        return CommutativeMatcher21150._instance
