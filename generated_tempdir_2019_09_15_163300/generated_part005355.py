...
class CommutativeMatcher33516(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33516._instance is None:
            CommutativeMatcher33516._instance = CommutativeMatcher33516()
        return CommutativeMatcher33516._instance
