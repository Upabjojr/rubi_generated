...
class CommutativeMatcher145873(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145873._instance is None:
            CommutativeMatcher145873._instance = CommutativeMatcher145873()
        return CommutativeMatcher145873._instance
