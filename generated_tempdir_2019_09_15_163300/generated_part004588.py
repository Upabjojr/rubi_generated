...
class CommutativeMatcher61883(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61883._instance is None:
            CommutativeMatcher61883._instance = CommutativeMatcher61883()
        return CommutativeMatcher61883._instance
