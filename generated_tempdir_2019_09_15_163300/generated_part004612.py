...
class CommutativeMatcher129484(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129484._instance is None:
            CommutativeMatcher129484._instance = CommutativeMatcher129484()
        return CommutativeMatcher129484._instance
