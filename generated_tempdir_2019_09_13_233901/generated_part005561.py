...
class CommutativeMatcher20903(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20903._instance is None:
            CommutativeMatcher20903._instance = CommutativeMatcher20903()
        return CommutativeMatcher20903._instance
