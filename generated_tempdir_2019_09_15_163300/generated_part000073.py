...
class CommutativeMatcher41678(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41678._instance is None:
            CommutativeMatcher41678._instance = CommutativeMatcher41678()
        return CommutativeMatcher41678._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41685.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000074 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset