...
class CommutativeMatcher129403(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129403._instance is None:
            CommutativeMatcher129403._instance = CommutativeMatcher129403()
        return CommutativeMatcher129403._instance
