...
class CommutativeMatcher49610(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49610._instance is None:
            CommutativeMatcher49610._instance = CommutativeMatcher49610()
        return CommutativeMatcher49610._instance
