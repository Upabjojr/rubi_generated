...
class CommutativeMatcher149861(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149861._instance is None:
            CommutativeMatcher149861._instance = CommutativeMatcher149861()
        return CommutativeMatcher149861._instance
