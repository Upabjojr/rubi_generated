...
class CommutativeMatcher23474(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23474._instance is None:
            CommutativeMatcher23474._instance = CommutativeMatcher23474()
        return CommutativeMatcher23474._instance
