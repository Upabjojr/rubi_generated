...
class CommutativeMatcher40934(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40934._instance is None:
            CommutativeMatcher40934._instance = CommutativeMatcher40934()
        return CommutativeMatcher40934._instance
