...
class CommutativeMatcher43377(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43377._instance is None:
            CommutativeMatcher43377._instance = CommutativeMatcher43377()
        return CommutativeMatcher43377._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43384.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000500 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset