...
class CommutativeMatcher67218(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67218._instance is None:
            CommutativeMatcher67218._instance = CommutativeMatcher67218()
        return CommutativeMatcher67218._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher67222.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009657 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset