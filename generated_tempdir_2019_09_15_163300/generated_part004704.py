...
class CommutativeMatcher21737(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21737._instance is None:
            CommutativeMatcher21737._instance = CommutativeMatcher21737()
        return CommutativeMatcher21737._instance
