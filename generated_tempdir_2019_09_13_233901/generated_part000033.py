...
class CommutativeMatcher41527(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41527._instance is None:
            CommutativeMatcher41527._instance = CommutativeMatcher41527()
        return CommutativeMatcher41527._instance
