...
class CommutativeMatcher42033(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42033._instance is None:
            CommutativeMatcher42033._instance = CommutativeMatcher42033()
        return CommutativeMatcher42033._instance
