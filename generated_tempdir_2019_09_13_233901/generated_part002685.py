...
class CommutativeMatcher126465(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126465._instance is None:
            CommutativeMatcher126465._instance = CommutativeMatcher126465()
        return CommutativeMatcher126465._instance
