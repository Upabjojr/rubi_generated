...
class CommutativeMatcher116896(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116896._instance is None:
            CommutativeMatcher116896._instance = CommutativeMatcher116896()
        return CommutativeMatcher116896._instance
