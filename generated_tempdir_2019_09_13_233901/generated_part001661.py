...
class CommutativeMatcher133692(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133692._instance is None:
            CommutativeMatcher133692._instance = CommutativeMatcher133692()
        return CommutativeMatcher133692._instance
