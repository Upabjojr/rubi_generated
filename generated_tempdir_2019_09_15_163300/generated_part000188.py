...
class CommutativeMatcher41196(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41196._instance is None:
            CommutativeMatcher41196._instance = CommutativeMatcher41196()
        return CommutativeMatcher41196._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41203.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part000189 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset