...
class CommutativeMatcher60204(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60204._instance is None:
            CommutativeMatcher60204._instance = CommutativeMatcher60204()
        return CommutativeMatcher60204._instance
