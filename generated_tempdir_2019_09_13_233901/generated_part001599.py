...
class CommutativeMatcher104453(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104453._instance is None:
            CommutativeMatcher104453._instance = CommutativeMatcher104453()
        return CommutativeMatcher104453._instance
