...
class CommutativeMatcher33625(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33625._instance is None:
            CommutativeMatcher33625._instance = CommutativeMatcher33625()
        return CommutativeMatcher33625._instance
