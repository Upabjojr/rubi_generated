...
class CommutativeMatcher120635(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120635._instance is None:
            CommutativeMatcher120635._instance = CommutativeMatcher120635()
        return CommutativeMatcher120635._instance
