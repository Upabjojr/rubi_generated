...
class CommutativeMatcher117034(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117034._instance is None:
            CommutativeMatcher117034._instance = CommutativeMatcher117034()
        return CommutativeMatcher117034._instance
