...
class CommutativeMatcher40667(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40667._instance is None:
            CommutativeMatcher40667._instance = CommutativeMatcher40667()
        return CommutativeMatcher40667._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher40674.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000130 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset