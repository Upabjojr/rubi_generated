...
class CommutativeMatcher104552(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104552._instance is None:
            CommutativeMatcher104552._instance = CommutativeMatcher104552()
        return CommutativeMatcher104552._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], log):
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                    ...
                    matcher = CommutativeMatcher104565.get()
                    tmp17 = subjects16
                    subjects16 = []
                    for s in tmp17:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher104575.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001614 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part001615 import *