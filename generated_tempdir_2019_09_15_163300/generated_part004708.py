...
class CommutativeMatcher21751(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21751._instance is None:
            CommutativeMatcher21751._instance = CommutativeMatcher21751()
        return CommutativeMatcher21751._instance
