...
class CommutativeMatcher94920(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher94920._instance is None:
            CommutativeMatcher94920._instance = CommutativeMatcher94920()
        return CommutativeMatcher94920._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher94924.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from .generated_part004580 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset