...
class CommutativeMatcher21486(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21486._instance is None:
            CommutativeMatcher21486._instance = CommutativeMatcher21486()
        return CommutativeMatcher21486._instance
