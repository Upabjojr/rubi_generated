...
class CommutativeMatcher26390(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26390._instance is None:
            CommutativeMatcher26390._instance = CommutativeMatcher26390()
        return CommutativeMatcher26390._instance
