...
class CommutativeMatcher124234(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124234._instance is None:
            CommutativeMatcher124234._instance = CommutativeMatcher124234()
        return CommutativeMatcher124234._instance
