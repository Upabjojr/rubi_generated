...
class CommutativeMatcher32912(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32912._instance is None:
            CommutativeMatcher32912._instance = CommutativeMatcher32912()
        return CommutativeMatcher32912._instance
