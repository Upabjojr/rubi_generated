...
class CommutativeMatcher42857(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42857._instance is None:
            CommutativeMatcher42857._instance = CommutativeMatcher42857()
        return CommutativeMatcher42857._instance
