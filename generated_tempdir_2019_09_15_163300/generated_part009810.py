...
class CommutativeMatcher67170(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67170._instance is None:
            CommutativeMatcher67170._instance = CommutativeMatcher67170()
        return CommutativeMatcher67170._instance
