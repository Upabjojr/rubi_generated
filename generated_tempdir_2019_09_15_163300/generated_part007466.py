...
class CommutativeMatcher25302(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25302._instance is None:
            CommutativeMatcher25302._instance = CommutativeMatcher25302()
        return CommutativeMatcher25302._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25306.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part007467 import *