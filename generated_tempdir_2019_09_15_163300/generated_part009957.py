...
class CommutativeMatcher47406(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher47406._instance is None:
            CommutativeMatcher47406._instance = CommutativeMatcher47406()
        return CommutativeMatcher47406._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher47410.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009958 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset