...
class CommutativeMatcher111634(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111634._instance is None:
            CommutativeMatcher111634._instance = CommutativeMatcher111634()
        return CommutativeMatcher111634._instance
