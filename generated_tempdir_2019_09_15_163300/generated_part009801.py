...
class CommutativeMatcher58096(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58096._instance is None:
            CommutativeMatcher58096._instance = CommutativeMatcher58096()
        return CommutativeMatcher58096._instance
