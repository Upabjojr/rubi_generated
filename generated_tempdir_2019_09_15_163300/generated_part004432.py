...
class CommutativeMatcher128918(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128918._instance is None:
            CommutativeMatcher128918._instance = CommutativeMatcher128918()
        return CommutativeMatcher128918._instance
