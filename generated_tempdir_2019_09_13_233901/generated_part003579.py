...
class CommutativeMatcher91266(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher91266._instance is None:
            CommutativeMatcher91266._instance = CommutativeMatcher91266()
        return CommutativeMatcher91266._instance
