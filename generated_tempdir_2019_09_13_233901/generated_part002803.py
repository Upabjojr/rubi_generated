...
class CommutativeMatcher64972(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64972._instance is None:
            CommutativeMatcher64972._instance = CommutativeMatcher64972()
        return CommutativeMatcher64972._instance
