...
class CommutativeMatcher22492(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22492._instance is None:
            CommutativeMatcher22492._instance = CommutativeMatcher22492()
        return CommutativeMatcher22492._instance
