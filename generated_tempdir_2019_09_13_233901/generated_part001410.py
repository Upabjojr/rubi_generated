...
class CommutativeMatcher83418(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher83418._instance is None:
            CommutativeMatcher83418._instance = CommutativeMatcher83418()
        return CommutativeMatcher83418._instance
