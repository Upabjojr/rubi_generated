...
class CommutativeMatcher104189(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104189._instance is None:
            CommutativeMatcher104189._instance = CommutativeMatcher104189()
        return CommutativeMatcher104189._instance
