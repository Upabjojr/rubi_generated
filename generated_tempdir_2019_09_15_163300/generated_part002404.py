...
class CommutativeMatcher23512(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23512._instance is None:
            CommutativeMatcher23512._instance = CommutativeMatcher23512()
        return CommutativeMatcher23512._instance
