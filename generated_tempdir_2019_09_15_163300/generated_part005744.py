...
class CommutativeMatcher32453(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32453._instance is None:
            CommutativeMatcher32453._instance = CommutativeMatcher32453()
        return CommutativeMatcher32453._instance
