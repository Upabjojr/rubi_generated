...
class CommutativeMatcher46958(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46958._instance is None:
            CommutativeMatcher46958._instance = CommutativeMatcher46958()
        return CommutativeMatcher46958._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher46962.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from .generated_part006722 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset