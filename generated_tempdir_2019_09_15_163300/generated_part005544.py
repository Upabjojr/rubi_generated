...
class CommutativeMatcher20835(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20835._instance is None:
            CommutativeMatcher20835._instance = CommutativeMatcher20835()
        return CommutativeMatcher20835._instance
