...
class CommutativeMatcher60079(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60079._instance is None:
            CommutativeMatcher60079._instance = CommutativeMatcher60079()
        return CommutativeMatcher60079._instance
