...
class CommutativeMatcher42182(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42182._instance is None:
            CommutativeMatcher42182._instance = CommutativeMatcher42182()
        return CommutativeMatcher42182._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42189.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000549 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset