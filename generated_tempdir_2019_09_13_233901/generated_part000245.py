...
class CommutativeMatcher111162(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111162._instance is None:
            CommutativeMatcher111162._instance = CommutativeMatcher111162()
        return CommutativeMatcher111162._instance
