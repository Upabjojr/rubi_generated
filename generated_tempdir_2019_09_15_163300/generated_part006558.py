...
class CommutativeMatcher57440(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher57440._instance is None:
            CommutativeMatcher57440._instance = CommutativeMatcher57440()
        return CommutativeMatcher57440._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher57444.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006559 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset