...
class CommutativeMatcher13992(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13992._instance is None:
            CommutativeMatcher13992._instance = CommutativeMatcher13992()
        return CommutativeMatcher13992._instance
