...
class CommutativeMatcher22823(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22823._instance is None:
            CommutativeMatcher22823._instance = CommutativeMatcher22823()
        return CommutativeMatcher22823._instance
