...
class CommutativeMatcher116675(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116675._instance is None:
            CommutativeMatcher116675._instance = CommutativeMatcher116675()
        return CommutativeMatcher116675._instance
