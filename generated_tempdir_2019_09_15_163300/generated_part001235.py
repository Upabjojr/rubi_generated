...
class CommutativeMatcher13260(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13260._instance is None:
            CommutativeMatcher13260._instance = CommutativeMatcher13260()
        return CommutativeMatcher13260._instance
