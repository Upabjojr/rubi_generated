...
class CommutativeMatcher23265(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23265._instance is None:
            CommutativeMatcher23265._instance = CommutativeMatcher23265()
        return CommutativeMatcher23265._instance
