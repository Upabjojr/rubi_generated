...
class CommutativeMatcher40771(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40771._instance is None:
            CommutativeMatcher40771._instance = CommutativeMatcher40771()
        return CommutativeMatcher40771._instance
