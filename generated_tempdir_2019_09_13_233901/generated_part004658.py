...
class CommutativeMatcher21612(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21612._instance is None:
            CommutativeMatcher21612._instance = CommutativeMatcher21612()
        return CommutativeMatcher21612._instance
