...
class CommutativeMatcher33169(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33169._instance is None:
            CommutativeMatcher33169._instance = CommutativeMatcher33169()
        return CommutativeMatcher33169._instance
