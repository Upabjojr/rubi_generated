...
class CommutativeMatcher41411(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41411._instance is None:
            CommutativeMatcher41411._instance = CommutativeMatcher41411()
        return CommutativeMatcher41411._instance
