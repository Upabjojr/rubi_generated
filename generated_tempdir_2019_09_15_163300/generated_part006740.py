...
class CommutativeMatcher46997(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46997._instance is None:
            CommutativeMatcher46997._instance = CommutativeMatcher46997()
        return CommutativeMatcher46997._instance
