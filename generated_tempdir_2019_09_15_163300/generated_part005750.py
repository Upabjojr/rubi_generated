...
class CommutativeMatcher21203(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21203._instance is None:
            CommutativeMatcher21203._instance = CommutativeMatcher21203()
        return CommutativeMatcher21203._instance
