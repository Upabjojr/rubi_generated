...
class CommutativeMatcher69049(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69049._instance is None:
            CommutativeMatcher69049._instance = CommutativeMatcher69049()
        return CommutativeMatcher69049._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher69053.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part001241 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset