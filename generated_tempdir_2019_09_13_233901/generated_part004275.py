...
class CommutativeMatcher134301(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134301._instance is None:
            CommutativeMatcher134301._instance = CommutativeMatcher134301()
        return CommutativeMatcher134301._instance
