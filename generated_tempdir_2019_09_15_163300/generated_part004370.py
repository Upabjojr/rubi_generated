...
class CommutativeMatcher128598(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128598._instance is None:
            CommutativeMatcher128598._instance = CommutativeMatcher128598()
        return CommutativeMatcher128598._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects12) >= 1 and isinstance(subjects12[0], Mul):
                ...
                matcher = CommutativeMatcher136183.get()
                tmp26 = subjects25
                subjects25 = []
                for s in tmp26:
...
from .generated_part004371 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset