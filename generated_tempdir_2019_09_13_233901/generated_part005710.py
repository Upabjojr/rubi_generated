...
class CommutativeMatcher93348(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93348._instance is None:
            CommutativeMatcher93348._instance = CommutativeMatcher93348()
        return CommutativeMatcher93348._instance
