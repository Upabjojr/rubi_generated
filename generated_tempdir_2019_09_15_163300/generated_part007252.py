...
class CommutativeMatcher49603(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49603._instance is None:
            CommutativeMatcher49603._instance = CommutativeMatcher49603()
        return CommutativeMatcher49603._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher49610.get()
            tmp17 = subjects16
            subjects16 = []
            for s in tmp17:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007253 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset