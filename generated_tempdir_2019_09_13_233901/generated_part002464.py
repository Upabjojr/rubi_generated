...
class CommutativeMatcher123606(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123606._instance is None:
            CommutativeMatcher123606._instance = CommutativeMatcher123606()
        return CommutativeMatcher123606._instance
