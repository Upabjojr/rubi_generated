...
class CommutativeMatcher21631(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21631._instance is None:
            CommutativeMatcher21631._instance = CommutativeMatcher21631()
        return CommutativeMatcher21631._instance
