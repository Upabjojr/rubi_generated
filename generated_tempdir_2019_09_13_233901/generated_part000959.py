...
class CommutativeMatcher120397(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120397._instance is None:
            CommutativeMatcher120397._instance = CommutativeMatcher120397()
        return CommutativeMatcher120397._instance
