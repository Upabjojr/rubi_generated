...
class CommutativeMatcher58124(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58124._instance is None:
            CommutativeMatcher58124._instance = CommutativeMatcher58124()
        return CommutativeMatcher58124._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher58128.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part009588 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset