...
class CommutativeMatcher116453(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116453._instance is None:
            CommutativeMatcher116453._instance = CommutativeMatcher116453()
        return CommutativeMatcher116453._instance
