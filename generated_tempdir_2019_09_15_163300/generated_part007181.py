...
class CommutativeMatcher65594(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65594._instance is None:
            CommutativeMatcher65594._instance = CommutativeMatcher65594()
        return CommutativeMatcher65594._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher65598.get()
            tmp24 = subjects23
            subjects23 = []
            for s in tmp24:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007182 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset