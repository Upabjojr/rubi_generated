...
class CommutativeMatcher135604(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135604._instance is None:
            CommutativeMatcher135604._instance = CommutativeMatcher135604()
        return CommutativeMatcher135604._instance
