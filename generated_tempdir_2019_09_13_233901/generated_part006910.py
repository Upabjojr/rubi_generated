...
class CommutativeMatcher105123(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105123._instance is None:
            CommutativeMatcher105123._instance = CommutativeMatcher105123()
        return CommutativeMatcher105123._instance
