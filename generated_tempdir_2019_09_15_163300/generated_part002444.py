...
class CommutativeMatcher78376(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78376._instance is None:
            CommutativeMatcher78376._instance = CommutativeMatcher78376()
        return CommutativeMatcher78376._instance
