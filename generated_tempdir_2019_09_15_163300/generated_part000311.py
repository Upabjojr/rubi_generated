...
class CommutativeMatcher149482(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149482._instance is None:
            CommutativeMatcher149482._instance = CommutativeMatcher149482()
        return CommutativeMatcher149482._instance
