...
class CommutativeMatcher61907(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61907._instance is None:
            CommutativeMatcher61907._instance = CommutativeMatcher61907()
        return CommutativeMatcher61907._instance
