...
class CommutativeMatcher93152(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93152._instance is None:
            CommutativeMatcher93152._instance = CommutativeMatcher93152()
        return CommutativeMatcher93152._instance
