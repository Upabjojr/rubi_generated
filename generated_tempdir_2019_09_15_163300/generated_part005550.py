...
class CommutativeMatcher20869(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20869._instance is None:
            CommutativeMatcher20869._instance = CommutativeMatcher20869()
        return CommutativeMatcher20869._instance
