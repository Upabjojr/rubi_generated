...
class CommutativeMatcher31901(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31901._instance is None:
            CommutativeMatcher31901._instance = CommutativeMatcher31901()
        return CommutativeMatcher31901._instance
