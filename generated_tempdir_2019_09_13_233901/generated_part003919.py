...
class CommutativeMatcher113069(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113069._instance is None:
            CommutativeMatcher113069._instance = CommutativeMatcher113069()
        return CommutativeMatcher113069._instance
