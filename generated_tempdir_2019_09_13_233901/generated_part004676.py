...
class CommutativeMatcher21656(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21656._instance is None:
            CommutativeMatcher21656._instance = CommutativeMatcher21656()
        return CommutativeMatcher21656._instance
