...
class CommutativeMatcher64946(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64946._instance is None:
            CommutativeMatcher64946._instance = CommutativeMatcher64946()
        return CommutativeMatcher64946._instance
