...
class CommutativeMatcher110351(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110351._instance is None:
            CommutativeMatcher110351._instance = CommutativeMatcher110351()
        return CommutativeMatcher110351._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher110355.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from .generated_part001095 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset