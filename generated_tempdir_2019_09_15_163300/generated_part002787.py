...
class CommutativeMatcher22862(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22862._instance is None:
            CommutativeMatcher22862._instance = CommutativeMatcher22862()
        return CommutativeMatcher22862._instance
