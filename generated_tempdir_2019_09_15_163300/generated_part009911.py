...
class CommutativeMatcher135055(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135055._instance is None:
            CommutativeMatcher135055._instance = CommutativeMatcher135055()
        return CommutativeMatcher135055._instance
