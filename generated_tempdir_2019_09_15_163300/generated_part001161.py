...
class CommutativeMatcher51790(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher51790._instance is None:
            CommutativeMatcher51790._instance = CommutativeMatcher51790()
        return CommutativeMatcher51790._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher51798.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher51803.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001162 import *
from .generated_part001163 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset