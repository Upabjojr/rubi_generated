...
class CommutativeMatcher33286(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33286._instance is None:
            CommutativeMatcher33286._instance = CommutativeMatcher33286()
        return CommutativeMatcher33286._instance
