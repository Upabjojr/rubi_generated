...
class CommutativeMatcher48058(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher48058._instance is None:
            CommutativeMatcher48058._instance = CommutativeMatcher48058()
        return CommutativeMatcher48058._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher48062.get()
            tmp8 = subjects7
            subjects7 = []
            for s in tmp8:
...
from .generated_part007609 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset