...
class CommutativeMatcher104790(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104790._instance is None:
            CommutativeMatcher104790._instance = CommutativeMatcher104790()
        return CommutativeMatcher104790._instance
