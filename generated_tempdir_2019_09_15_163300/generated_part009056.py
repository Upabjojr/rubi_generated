...
class CommutativeMatcher97596(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher97596._instance is None:
            CommutativeMatcher97596._instance = CommutativeMatcher97596()
        return CommutativeMatcher97596._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher97603.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009057 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset