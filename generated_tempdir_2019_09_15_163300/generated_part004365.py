...
class CommutativeMatcher64766(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64766._instance is None:
            CommutativeMatcher64766._instance = CommutativeMatcher64766()
        return CommutativeMatcher64766._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], log):
                ...
                if len(subjects16) >= 1 and isinstance(subjects16[0], Mul):
                    ...
                    matcher = CommutativeMatcher106570.get()
                    tmp30 = subjects29
                    subjects29 = []
                    for s in tmp30:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher64770.get()
            tmp33 = subjects32
            subjects32 = []
            for s in tmp33:
                matcher.add_subject(s)
...
from .generated_part004367 import *
from .generated_part004366 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset