...
class CommutativeMatcher41628(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41628._instance is None:
            CommutativeMatcher41628._instance = CommutativeMatcher41628()
        return CommutativeMatcher41628._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41635.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part000044 import *