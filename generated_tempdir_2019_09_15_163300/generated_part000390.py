...
class CommutativeMatcher43084(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43084._instance is None:
            CommutativeMatcher43084._instance = CommutativeMatcher43084()
        return CommutativeMatcher43084._instance
