...
class CommutativeMatcher63087(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63087._instance is None:
            CommutativeMatcher63087._instance = CommutativeMatcher63087()
        return CommutativeMatcher63087._instance
