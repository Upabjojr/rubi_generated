...
class CommutativeMatcher96463(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher96463._instance is None:
            CommutativeMatcher96463._instance = CommutativeMatcher96463()
        return CommutativeMatcher96463._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher96467.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
