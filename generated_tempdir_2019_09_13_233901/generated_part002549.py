...
class CommutativeMatcher22335(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22335._instance is None:
            CommutativeMatcher22335._instance = CommutativeMatcher22335()
        return CommutativeMatcher22335._instance
