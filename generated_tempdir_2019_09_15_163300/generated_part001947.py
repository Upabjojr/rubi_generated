...
class CommutativeMatcher31375(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31375._instance is None:
            CommutativeMatcher31375._instance = CommutativeMatcher31375()
        return CommutativeMatcher31375._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher31384.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part001948 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset