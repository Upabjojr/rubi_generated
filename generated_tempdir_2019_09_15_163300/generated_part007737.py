...
class CommutativeMatcher56438(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher56438._instance is None:
            CommutativeMatcher56438._instance = CommutativeMatcher56438()
        return CommutativeMatcher56438._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher134594.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007738 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset