...
class CommutativeMatcher51981(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher51981._instance is None:
            CommutativeMatcher51981._instance = CommutativeMatcher51981()
        return CommutativeMatcher51981._instance
    ...
    def get_match_iter(subject):
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                        ...
                        matcher = CommutativeMatcher51990.get()
                        tmp11 = subjects10
                        subjects10 = []
                        for s in tmp11:
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Add):
                    ...
                    matcher = CommutativeMatcher51995.get()
                    tmp15 = subjects14
                    subjects14 = []
                    for s in tmp15:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher52005.get()
            tmp19 = subjects18
            subjects18 = []
            for s in tmp19:
                matcher.add_subject(s)
...
from .generated_part001272 import *
from .generated_part001275 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001273 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset