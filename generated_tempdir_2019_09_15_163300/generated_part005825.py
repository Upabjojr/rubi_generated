...
class CommutativeMatcher21434(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21434._instance is None:
            CommutativeMatcher21434._instance = CommutativeMatcher21434()
        return CommutativeMatcher21434._instance
