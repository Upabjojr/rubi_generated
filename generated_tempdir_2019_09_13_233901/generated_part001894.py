...
class CommutativeMatcher31159(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31159._instance is None:
            CommutativeMatcher31159._instance = CommutativeMatcher31159()
        return CommutativeMatcher31159._instance
