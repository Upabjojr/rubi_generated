...
class CommutativeMatcher104565(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104565._instance is None:
            CommutativeMatcher104565._instance = CommutativeMatcher104565()
        return CommutativeMatcher104565._instance
