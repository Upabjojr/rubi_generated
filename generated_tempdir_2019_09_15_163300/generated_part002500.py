...
class CommutativeMatcher93268(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93268._instance is None:
            CommutativeMatcher93268._instance = CommutativeMatcher93268()
        return CommutativeMatcher93268._instance
