...
class CommutativeMatcher41449(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41449._instance is None:
            CommutativeMatcher41449._instance = CommutativeMatcher41449()
        return CommutativeMatcher41449._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41456.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part000025 import *