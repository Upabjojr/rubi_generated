...
class CommutativeMatcher133285(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133285._instance is None:
            CommutativeMatcher133285._instance = CommutativeMatcher133285()
        return CommutativeMatcher133285._instance
