...
class CommutativeMatcher116473(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116473._instance is None:
            CommutativeMatcher116473._instance = CommutativeMatcher116473()
        return CommutativeMatcher116473._instance
