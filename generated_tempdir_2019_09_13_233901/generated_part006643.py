...
class CommutativeMatcher59430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59430._instance is None:
            CommutativeMatcher59430._instance = CommutativeMatcher59430()
        return CommutativeMatcher59430._instance
