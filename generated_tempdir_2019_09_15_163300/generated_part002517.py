...
class CommutativeMatcher22222(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22222._instance is None:
            CommutativeMatcher22222._instance = CommutativeMatcher22222()
        return CommutativeMatcher22222._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22226.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from .generated_part002518 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset