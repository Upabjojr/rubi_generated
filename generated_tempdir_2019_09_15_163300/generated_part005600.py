...
class CommutativeMatcher21011(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21011._instance is None:
            CommutativeMatcher21011._instance = CommutativeMatcher21011()
        return CommutativeMatcher21011._instance
