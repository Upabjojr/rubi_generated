...
class CommutativeMatcher105103(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105103._instance is None:
            CommutativeMatcher105103._instance = CommutativeMatcher105103()
        return CommutativeMatcher105103._instance
