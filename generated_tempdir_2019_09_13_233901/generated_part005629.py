...
class CommutativeMatcher59933(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59933._instance is None:
            CommutativeMatcher59933._instance = CommutativeMatcher59933()
        return CommutativeMatcher59933._instance
