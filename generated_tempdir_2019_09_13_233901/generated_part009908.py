...
class CommutativeMatcher134761(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134761._instance is None:
            CommutativeMatcher134761._instance = CommutativeMatcher134761()
        return CommutativeMatcher134761._instance
