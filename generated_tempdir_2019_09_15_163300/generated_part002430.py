...
class CommutativeMatcher23601(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23601._instance is None:
            CommutativeMatcher23601._instance = CommutativeMatcher23601()
        return CommutativeMatcher23601._instance
