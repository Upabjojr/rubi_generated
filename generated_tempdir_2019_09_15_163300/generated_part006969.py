...
class CommutativeMatcher116768(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116768._instance is None:
            CommutativeMatcher116768._instance = CommutativeMatcher116768()
        return CommutativeMatcher116768._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher116783.get()
                    tmp24 = subjects23
                    subjects23 = []
                    for s in tmp24:
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher117273.get()
                    tmp37 = subjects36
                    subjects36 = []
                    for s in tmp37:
                        matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher116794.get()
                tmp41 = subjects40
                subjects40 = []
                for s in tmp41:
                    matcher.add_subject(s)
...
from .generated_part006972 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006970 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006971 import *