...
class CommutativeMatcher123575(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123575._instance is None:
            CommutativeMatcher123575._instance = CommutativeMatcher123575()
        return CommutativeMatcher123575._instance
