...
class CommutativeMatcher63820(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63820._instance is None:
            CommutativeMatcher63820._instance = CommutativeMatcher63820()
        return CommutativeMatcher63820._instance
