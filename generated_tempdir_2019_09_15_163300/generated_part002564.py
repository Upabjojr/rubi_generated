...
class CommutativeMatcher22379(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22379._instance is None:
            CommutativeMatcher22379._instance = CommutativeMatcher22379()
        return CommutativeMatcher22379._instance
