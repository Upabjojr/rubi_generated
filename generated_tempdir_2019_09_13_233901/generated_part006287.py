...
class CommutativeMatcher78504(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78504._instance is None:
            CommutativeMatcher78504._instance = CommutativeMatcher78504()
        return CommutativeMatcher78504._instance
