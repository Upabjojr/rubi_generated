...
class CommutativeMatcher69742(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69742._instance is None:
            CommutativeMatcher69742._instance = CommutativeMatcher69742()
        return CommutativeMatcher69742._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher69746.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part002082 import *