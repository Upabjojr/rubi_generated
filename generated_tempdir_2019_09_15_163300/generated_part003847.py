...
class CommutativeMatcher49324(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49324._instance is None:
            CommutativeMatcher49324._instance = CommutativeMatcher49324()
        return CommutativeMatcher49324._instance
