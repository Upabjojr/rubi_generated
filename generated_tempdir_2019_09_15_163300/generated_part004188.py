...
class CommutativeMatcher105279(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105279._instance is None:
            CommutativeMatcher105279._instance = CommutativeMatcher105279()
        return CommutativeMatcher105279._instance
