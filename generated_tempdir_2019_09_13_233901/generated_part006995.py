...
class CommutativeMatcher121077(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121077._instance is None:
            CommutativeMatcher121077._instance = CommutativeMatcher121077()
        return CommutativeMatcher121077._instance
