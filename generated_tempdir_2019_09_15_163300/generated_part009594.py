...
class CommutativeMatcher110331(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110331._instance is None:
            CommutativeMatcher110331._instance = CommutativeMatcher110331()
        return CommutativeMatcher110331._instance
