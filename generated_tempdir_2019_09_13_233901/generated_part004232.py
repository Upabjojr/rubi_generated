...
class CommutativeMatcher111743(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111743._instance is None:
            CommutativeMatcher111743._instance = CommutativeMatcher111743()
        return CommutativeMatcher111743._instance
