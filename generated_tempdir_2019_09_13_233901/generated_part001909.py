...
class CommutativeMatcher31217(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31217._instance is None:
            CommutativeMatcher31217._instance = CommutativeMatcher31217()
        return CommutativeMatcher31217._instance
