...
class CommutativeMatcher33484(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33484._instance is None:
            CommutativeMatcher33484._instance = CommutativeMatcher33484()
        return CommutativeMatcher33484._instance
