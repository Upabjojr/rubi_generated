...
class CommutativeMatcher61847(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61847._instance is None:
            CommutativeMatcher61847._instance = CommutativeMatcher61847()
        return CommutativeMatcher61847._instance
