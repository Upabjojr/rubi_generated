...
class CommutativeMatcher49309(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49309._instance is None:
            CommutativeMatcher49309._instance = CommutativeMatcher49309()
        return CommutativeMatcher49309._instance
