...
class CommutativeMatcher125414(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125414._instance is None:
            CommutativeMatcher125414._instance = CommutativeMatcher125414()
        return CommutativeMatcher125414._instance
