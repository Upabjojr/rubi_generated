...
class CommutativeMatcher41616(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41616._instance is None:
            CommutativeMatcher41616._instance = CommutativeMatcher41616()
        return CommutativeMatcher41616._instance
