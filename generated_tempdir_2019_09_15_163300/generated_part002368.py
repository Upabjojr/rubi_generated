...
class CommutativeMatcher23404(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23404._instance is None:
            CommutativeMatcher23404._instance = CommutativeMatcher23404()
        return CommutativeMatcher23404._instance
