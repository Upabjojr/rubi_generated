...
class CommutativeMatcher150176(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150176._instance is None:
            CommutativeMatcher150176._instance = CommutativeMatcher150176()
        return CommutativeMatcher150176._instance
