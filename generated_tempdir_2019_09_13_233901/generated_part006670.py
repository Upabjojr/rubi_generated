...
class CommutativeMatcher136066(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136066._instance is None:
            CommutativeMatcher136066._instance = CommutativeMatcher136066()
        return CommutativeMatcher136066._instance
