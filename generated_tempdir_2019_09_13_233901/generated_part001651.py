...
class CommutativeMatcher133665(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133665._instance is None:
            CommutativeMatcher133665._instance = CommutativeMatcher133665()
        return CommutativeMatcher133665._instance
