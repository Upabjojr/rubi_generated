...
class CommutativeMatcher78367(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78367._instance is None:
            CommutativeMatcher78367._instance = CommutativeMatcher78367()
        return CommutativeMatcher78367._instance
