...
class CommutativeMatcher67222(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67222._instance is None:
            CommutativeMatcher67222._instance = CommutativeMatcher67222()
        return CommutativeMatcher67222._instance
