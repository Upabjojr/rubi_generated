...
class CommutativeMatcher125606(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125606._instance is None:
            CommutativeMatcher125606._instance = CommutativeMatcher125606()
        return CommutativeMatcher125606._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], log):
                ...
                if len(subjects8) >= 1 and isinstance(subjects8[0], Mul):
                    ...
                    matcher = CommutativeMatcher133397.get()
                    tmp22 = subjects21
                    subjects21 = []
                    for s in tmp22:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher125613.get()
            tmp28 = subjects27
            subjects27 = []
            for s in tmp28:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part010094 import *
from collections import deque
from .generated_part010093 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset