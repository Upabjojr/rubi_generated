...
class CommutativeMatcher116647(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116647._instance is None:
            CommutativeMatcher116647._instance = CommutativeMatcher116647()
        return CommutativeMatcher116647._instance
