...
class CommutativeMatcher111520(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111520._instance is None:
            CommutativeMatcher111520._instance = CommutativeMatcher111520()
        return CommutativeMatcher111520._instance
