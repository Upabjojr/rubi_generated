...
class CommutativeMatcher21776(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21776._instance is None:
            CommutativeMatcher21776._instance = CommutativeMatcher21776()
        return CommutativeMatcher21776._instance
