...
class CommutativeMatcher120509(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120509._instance is None:
            CommutativeMatcher120509._instance = CommutativeMatcher120509()
        return CommutativeMatcher120509._instance
