...
class CommutativeMatcher33458(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33458._instance is None:
            CommutativeMatcher33458._instance = CommutativeMatcher33458()
        return CommutativeMatcher33458._instance
