...
class CommutativeMatcher23180(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23180._instance is None:
            CommutativeMatcher23180._instance = CommutativeMatcher23180()
        return CommutativeMatcher23180._instance
