...
class CommutativeMatcher21417(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21417._instance is None:
            CommutativeMatcher21417._instance = CommutativeMatcher21417()
        return CommutativeMatcher21417._instance
