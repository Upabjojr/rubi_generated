...
class CommutativeMatcher110427(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110427._instance is None:
            CommutativeMatcher110427._instance = CommutativeMatcher110427()
        return CommutativeMatcher110427._instance
