...
class CommutativeMatcher120612(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120612._instance is None:
            CommutativeMatcher120612._instance = CommutativeMatcher120612()
        return CommutativeMatcher120612._instance
