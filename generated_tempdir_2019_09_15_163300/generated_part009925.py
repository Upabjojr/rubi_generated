...
class CommutativeMatcher135213(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135213._instance is None:
            CommutativeMatcher135213._instance = CommutativeMatcher135213()
        return CommutativeMatcher135213._instance
