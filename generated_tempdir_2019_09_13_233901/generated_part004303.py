...
class CommutativeMatcher128700(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128700._instance is None:
            CommutativeMatcher128700._instance = CommutativeMatcher128700()
        return CommutativeMatcher128700._instance
