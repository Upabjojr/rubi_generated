...
class CommutativeMatcher79169(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79169._instance is None:
            CommutativeMatcher79169._instance = CommutativeMatcher79169()
        return CommutativeMatcher79169._instance
