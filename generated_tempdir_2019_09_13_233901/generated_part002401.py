...
class CommutativeMatcher31727(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31727._instance is None:
            CommutativeMatcher31727._instance = CommutativeMatcher31727()
        return CommutativeMatcher31727._instance
