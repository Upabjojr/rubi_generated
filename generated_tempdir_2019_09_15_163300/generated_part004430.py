...
class CommutativeMatcher128897(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128897._instance is None:
            CommutativeMatcher128897._instance = CommutativeMatcher128897()
        return CommutativeMatcher128897._instance
