...
class CommutativeMatcher23536(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23536._instance is None:
            CommutativeMatcher23536._instance = CommutativeMatcher23536()
        return CommutativeMatcher23536._instance
