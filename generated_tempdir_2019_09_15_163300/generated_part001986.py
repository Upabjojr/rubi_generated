...
class CommutativeMatcher123590(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123590._instance is None:
            CommutativeMatcher123590._instance = CommutativeMatcher123590()
        return CommutativeMatcher123590._instance
