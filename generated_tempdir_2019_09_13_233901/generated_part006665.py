...
class CommutativeMatcher136001(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136001._instance is None:
            CommutativeMatcher136001._instance = CommutativeMatcher136001()
        return CommutativeMatcher136001._instance
