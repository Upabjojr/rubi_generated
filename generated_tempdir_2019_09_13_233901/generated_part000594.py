...
class CommutativeMatcher42469(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42469._instance is None:
            CommutativeMatcher42469._instance = CommutativeMatcher42469()
        return CommutativeMatcher42469._instance
