...
class CommutativeMatcher104298(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104298._instance is None:
            CommutativeMatcher104298._instance = CommutativeMatcher104298()
        return CommutativeMatcher104298._instance
