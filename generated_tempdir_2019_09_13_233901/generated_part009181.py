...
class CommutativeMatcher122630(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122630._instance is None:
            CommutativeMatcher122630._instance = CommutativeMatcher122630()
        return CommutativeMatcher122630._instance
