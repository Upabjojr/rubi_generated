...
class CommutativeMatcher129424(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129424._instance is None:
            CommutativeMatcher129424._instance = CommutativeMatcher129424()
        return CommutativeMatcher129424._instance
