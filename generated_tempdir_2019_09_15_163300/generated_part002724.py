...
class CommutativeMatcher30633(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30633._instance is None:
            CommutativeMatcher30633._instance = CommutativeMatcher30633()
        return CommutativeMatcher30633._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher30642.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002725 import *
from multiset import Multiset