...
class CommutativeMatcher78739(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78739._instance is None:
            CommutativeMatcher78739._instance = CommutativeMatcher78739()
        return CommutativeMatcher78739._instance
