...
class CommutativeMatcher33197(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33197._instance is None:
            CommutativeMatcher33197._instance = CommutativeMatcher33197()
        return CommutativeMatcher33197._instance
