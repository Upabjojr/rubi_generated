...
class CommutativeMatcher113035(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113035._instance is None:
            CommutativeMatcher113035._instance = CommutativeMatcher113035()
        return CommutativeMatcher113035._instance
