...
class CommutativeMatcher21403(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21403._instance is None:
            CommutativeMatcher21403._instance = CommutativeMatcher21403()
        return CommutativeMatcher21403._instance
