...
class CommutativeMatcher124316(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124316._instance is None:
            CommutativeMatcher124316._instance = CommutativeMatcher124316()
        return CommutativeMatcher124316._instance
