...
class CommutativeMatcher124047(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124047._instance is None:
            CommutativeMatcher124047._instance = CommutativeMatcher124047()
        return CommutativeMatcher124047._instance
