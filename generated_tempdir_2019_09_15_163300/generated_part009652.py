...
class CommutativeMatcher67121(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67121._instance is None:
            CommutativeMatcher67121._instance = CommutativeMatcher67121()
        return CommutativeMatcher67121._instance
