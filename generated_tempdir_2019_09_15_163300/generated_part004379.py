...
class CommutativeMatcher136271(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136271._instance is None:
            CommutativeMatcher136271._instance = CommutativeMatcher136271()
        return CommutativeMatcher136271._instance
