...
class CommutativeMatcher13117(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13117._instance is None:
            CommutativeMatcher13117._instance = CommutativeMatcher13117()
        return CommutativeMatcher13117._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13124.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001026 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset