...
class CommutativeMatcher40556(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40556._instance is None:
            CommutativeMatcher40556._instance = CommutativeMatcher40556()
        return CommutativeMatcher40556._instance
