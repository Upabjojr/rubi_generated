...
class CommutativeMatcher126024(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126024._instance is None:
            CommutativeMatcher126024._instance = CommutativeMatcher126024()
        return CommutativeMatcher126024._instance
