...
class CommutativeMatcher135553(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135553._instance is None:
            CommutativeMatcher135553._instance = CommutativeMatcher135553()
        return CommutativeMatcher135553._instance
