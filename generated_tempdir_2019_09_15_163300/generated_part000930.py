...
class CommutativeMatcher144030(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher144030._instance is None:
            CommutativeMatcher144030._instance = CommutativeMatcher144030()
        return CommutativeMatcher144030._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher144038.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher144043.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
...
from .generated_part000931 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000932 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset