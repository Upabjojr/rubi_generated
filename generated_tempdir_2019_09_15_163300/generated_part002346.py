...
class CommutativeMatcher31490(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31490._instance is None:
            CommutativeMatcher31490._instance = CommutativeMatcher31490()
        return CommutativeMatcher31490._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher31499.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002347 import *
from multiset import Multiset