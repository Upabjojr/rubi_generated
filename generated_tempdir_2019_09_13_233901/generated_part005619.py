...
class CommutativeMatcher21076(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21076._instance is None:
            CommutativeMatcher21076._instance = CommutativeMatcher21076()
        return CommutativeMatcher21076._instance
