...
class CommutativeMatcher120685(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120685._instance is None:
            CommutativeMatcher120685._instance = CommutativeMatcher120685()
        return CommutativeMatcher120685._instance
