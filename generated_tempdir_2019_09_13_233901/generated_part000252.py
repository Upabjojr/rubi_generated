...
class CommutativeMatcher111593(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111593._instance is None:
            CommutativeMatcher111593._instance = CommutativeMatcher111593()
        return CommutativeMatcher111593._instance
