...
class CommutativeMatcher32109(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32109._instance is None:
            CommutativeMatcher32109._instance = CommutativeMatcher32109()
        return CommutativeMatcher32109._instance
