...
class CommutativeMatcher22069(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22069._instance is None:
            CommutativeMatcher22069._instance = CommutativeMatcher22069()
        return CommutativeMatcher22069._instance
