...
class CommutativeMatcher23351(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23351._instance is None:
            CommutativeMatcher23351._instance = CommutativeMatcher23351()
        return CommutativeMatcher23351._instance
