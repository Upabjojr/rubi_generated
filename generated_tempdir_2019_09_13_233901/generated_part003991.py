...
class CommutativeMatcher49481(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49481._instance is None:
            CommutativeMatcher49481._instance = CommutativeMatcher49481()
        return CommutativeMatcher49481._instance
