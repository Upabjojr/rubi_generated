...
class CommutativeMatcher49317(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49317._instance is None:
            CommutativeMatcher49317._instance = CommutativeMatcher49317()
        return CommutativeMatcher49317._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher49324.get()
            tmp17 = subjects16
            subjects16 = []
            for s in tmp17:
...
from .generated_part003847 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset