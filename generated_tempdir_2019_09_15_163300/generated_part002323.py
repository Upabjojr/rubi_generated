...
class CommutativeMatcher129353(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129353._instance is None:
            CommutativeMatcher129353._instance = CommutativeMatcher129353()
        return CommutativeMatcher129353._instance
