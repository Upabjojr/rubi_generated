...
class CommutativeMatcher111841(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111841._instance is None:
            CommutativeMatcher111841._instance = CommutativeMatcher111841()
        return CommutativeMatcher111841._instance
