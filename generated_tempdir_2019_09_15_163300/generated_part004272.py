...
class CommutativeMatcher125343(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125343._instance is None:
            CommutativeMatcher125343._instance = CommutativeMatcher125343()
        return CommutativeMatcher125343._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects5) >= 1 and isinstance(subjects5[0], Add):
                ...
                matcher = CommutativeMatcher136935.get()
                tmp13 = subjects12
                subjects12 = []
                for s in tmp13:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects18) >= 1 and isinstance(subjects18[0], Mul):
                ...
                matcher = CommutativeMatcher134301.get()
                tmp32 = subjects31
                subjects31 = []
                for s in tmp32:
                    matcher.add_subject(s)
...
from .generated_part004275 import *
from .generated_part004273 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset