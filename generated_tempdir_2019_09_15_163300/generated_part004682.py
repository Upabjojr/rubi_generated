...
class CommutativeMatcher21675(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21675._instance is None:
            CommutativeMatcher21675._instance = CommutativeMatcher21675()
        return CommutativeMatcher21675._instance
