...
class CommutativeMatcher23005(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23005._instance is None:
            CommutativeMatcher23005._instance = CommutativeMatcher23005()
        return CommutativeMatcher23005._instance
