...
class CommutativeMatcher21946(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21946._instance is None:
            CommutativeMatcher21946._instance = CommutativeMatcher21946()
        return CommutativeMatcher21946._instance
