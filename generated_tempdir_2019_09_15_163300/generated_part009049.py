...
class CommutativeMatcher13362(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13362._instance is None:
            CommutativeMatcher13362._instance = CommutativeMatcher13362()
        return CommutativeMatcher13362._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher13365.get()
                tmp5 = subjects4
                subjects4 = []
                for s in tmp5:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part009050 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset