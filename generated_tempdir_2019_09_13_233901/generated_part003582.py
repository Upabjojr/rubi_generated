...
class CommutativeMatcher64099(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64099._instance is None:
            CommutativeMatcher64099._instance = CommutativeMatcher64099()
        return CommutativeMatcher64099._instance
