...
class CommutativeMatcher146030(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146030._instance is None:
            CommutativeMatcher146030._instance = CommutativeMatcher146030()
        return CommutativeMatcher146030._instance
