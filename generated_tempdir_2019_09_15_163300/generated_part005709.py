...
class CommutativeMatcher93344(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93344._instance is None:
            CommutativeMatcher93344._instance = CommutativeMatcher93344()
        return CommutativeMatcher93344._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher93348.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005710 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset