...
class CommutativeMatcher67097(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67097._instance is None:
            CommutativeMatcher67097._instance = CommutativeMatcher67097()
        return CommutativeMatcher67097._instance
