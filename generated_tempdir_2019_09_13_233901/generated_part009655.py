...
class CommutativeMatcher67212(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67212._instance is None:
            CommutativeMatcher67212._instance = CommutativeMatcher67212()
        return CommutativeMatcher67212._instance
