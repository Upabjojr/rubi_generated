...
class CommutativeMatcher32830(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32830._instance is None:
            CommutativeMatcher32830._instance = CommutativeMatcher32830()
        return CommutativeMatcher32830._instance
