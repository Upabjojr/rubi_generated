...
class CommutativeMatcher46758(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46758._instance is None:
            CommutativeMatcher46758._instance = CommutativeMatcher46758()
        return CommutativeMatcher46758._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher46762.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part004120 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset