...
class CommutativeMatcher22093(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22093._instance is None:
            CommutativeMatcher22093._instance = CommutativeMatcher22093()
        return CommutativeMatcher22093._instance
