...
class CommutativeMatcher68770(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher68770._instance is None:
            CommutativeMatcher68770._instance = CommutativeMatcher68770()
        return CommutativeMatcher68770._instance
