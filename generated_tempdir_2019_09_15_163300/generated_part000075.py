...
class CommutativeMatcher41699(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41699._instance is None:
            CommutativeMatcher41699._instance = CommutativeMatcher41699()
        return CommutativeMatcher41699._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher41702.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects8) >= 1 and isinstance(subjects8[0], Add):
                ...
                matcher = CommutativeMatcher41721.get()
                tmp11 = subjects10
                subjects10 = []
                for s in tmp11:
                    matcher.add_subject(s)
...
from .generated_part000078 import *
from .generated_part000076 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset