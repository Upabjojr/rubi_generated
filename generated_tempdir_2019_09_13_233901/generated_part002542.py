...
class CommutativeMatcher22308(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22308._instance is None:
            CommutativeMatcher22308._instance = CommutativeMatcher22308()
        return CommutativeMatcher22308._instance
