...
class CommutativeMatcher30272(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30272._instance is None:
            CommutativeMatcher30272._instance = CommutativeMatcher30272()
        return CommutativeMatcher30272._instance
