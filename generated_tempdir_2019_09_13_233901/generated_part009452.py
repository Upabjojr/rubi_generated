...
class CommutativeMatcher13489(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13489._instance is None:
            CommutativeMatcher13489._instance = CommutativeMatcher13489()
        return CommutativeMatcher13489._instance
