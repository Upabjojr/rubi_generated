...
class CommutativeMatcher33060(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33060._instance is None:
            CommutativeMatcher33060._instance = CommutativeMatcher33060()
        return CommutativeMatcher33060._instance
