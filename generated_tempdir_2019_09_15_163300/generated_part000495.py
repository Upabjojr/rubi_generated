...
class CommutativeMatcher43354(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43354._instance is None:
            CommutativeMatcher43354._instance = CommutativeMatcher43354()
        return CommutativeMatcher43354._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43361.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000496 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset