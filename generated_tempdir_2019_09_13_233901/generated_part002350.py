...
class CommutativeMatcher23334(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23334._instance is None:
            CommutativeMatcher23334._instance = CommutativeMatcher23334()
        return CommutativeMatcher23334._instance
