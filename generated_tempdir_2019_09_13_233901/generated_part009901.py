...
class CommutativeMatcher105773(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105773._instance is None:
            CommutativeMatcher105773._instance = CommutativeMatcher105773()
        return CommutativeMatcher105773._instance
