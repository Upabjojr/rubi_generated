...
class CommutativeMatcher97431(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher97431._instance is None:
            CommutativeMatcher97431._instance = CommutativeMatcher97431()
        return CommutativeMatcher97431._instance
