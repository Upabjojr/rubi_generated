...
class CommutativeMatcher149573(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149573._instance is None:
            CommutativeMatcher149573._instance = CommutativeMatcher149573()
        return CommutativeMatcher149573._instance
