...
class CommutativeMatcher117226(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117226._instance is None:
            CommutativeMatcher117226._instance = CommutativeMatcher117226()
        return CommutativeMatcher117226._instance
