...
class CommutativeMatcher133371(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133371._instance is None:
            CommutativeMatcher133371._instance = CommutativeMatcher133371()
        return CommutativeMatcher133371._instance
