...
class CommutativeMatcher32794(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32794._instance is None:
            CommutativeMatcher32794._instance = CommutativeMatcher32794()
        return CommutativeMatcher32794._instance
