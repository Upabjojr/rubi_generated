...
class CommutativeMatcher42561(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42561._instance is None:
            CommutativeMatcher42561._instance = CommutativeMatcher42561()
        return CommutativeMatcher42561._instance
