...
class CommutativeMatcher22107(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22107._instance is None:
            CommutativeMatcher22107._instance = CommutativeMatcher22107()
        return CommutativeMatcher22107._instance
