...
class CommutativeMatcher89336(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89336._instance is None:
            CommutativeMatcher89336._instance = CommutativeMatcher89336()
        return CommutativeMatcher89336._instance
