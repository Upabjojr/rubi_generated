...
class CommutativeMatcher65065(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65065._instance is None:
            CommutativeMatcher65065._instance = CommutativeMatcher65065()
        return CommutativeMatcher65065._instance
