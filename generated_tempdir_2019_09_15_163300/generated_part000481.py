...
class CommutativeMatcher43261(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43261._instance is None:
            CommutativeMatcher43261._instance = CommutativeMatcher43261()
        return CommutativeMatcher43261._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43268.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000482 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset