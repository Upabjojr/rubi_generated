...
class CommutativeMatcher145991(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145991._instance is None:
            CommutativeMatcher145991._instance = CommutativeMatcher145991()
        return CommutativeMatcher145991._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher146000.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part007065 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset