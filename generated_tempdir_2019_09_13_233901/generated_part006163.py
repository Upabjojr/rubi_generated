...
class CommutativeMatcher64129(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64129._instance is None:
            CommutativeMatcher64129._instance = CommutativeMatcher64129()
        return CommutativeMatcher64129._instance
