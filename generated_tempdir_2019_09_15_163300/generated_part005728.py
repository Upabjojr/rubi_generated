...
class CommutativeMatcher21137(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21137._instance is None:
            CommutativeMatcher21137._instance = CommutativeMatcher21137()
        return CommutativeMatcher21137._instance
