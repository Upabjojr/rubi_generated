...
class CommutativeMatcher46442(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46442._instance is None:
            CommutativeMatcher46442._instance = CommutativeMatcher46442()
        return CommutativeMatcher46442._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher46445.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects6) >= 1 and isinstance(subjects6[0], Mul):
                ...
                matcher = CommutativeMatcher46484.get()
                tmp9 = subjects8
                subjects8 = []
                for s in tmp9:
                    matcher.add_subject(s)
...
from .generated_part000225 import *
from .generated_part000232 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset