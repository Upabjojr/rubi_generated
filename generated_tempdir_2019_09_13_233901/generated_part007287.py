...
class CommutativeMatcher58598(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58598._instance is None:
            CommutativeMatcher58598._instance = CommutativeMatcher58598()
        return CommutativeMatcher58598._instance
