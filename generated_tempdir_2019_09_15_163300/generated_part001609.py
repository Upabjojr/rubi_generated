...
class CommutativeMatcher104538(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104538._instance is None:
            CommutativeMatcher104538._instance = CommutativeMatcher104538()
        return CommutativeMatcher104538._instance
