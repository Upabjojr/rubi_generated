...
class CommutativeMatcher116556(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116556._instance is None:
            CommutativeMatcher116556._instance = CommutativeMatcher116556()
        return CommutativeMatcher116556._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher116571.get()
                    tmp20 = subjects19
                    subjects19 = []
                    for s in tmp20:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher116582.get()
                tmp24 = subjects23
                subjects23 = []
                for s in tmp24:
                    matcher.add_subject(s)
...
from .generated_part000949 import *
from .generated_part000950 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset