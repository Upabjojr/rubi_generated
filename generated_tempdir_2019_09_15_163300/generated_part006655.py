...
class CommutativeMatcher106340(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106340._instance is None:
            CommutativeMatcher106340._instance = CommutativeMatcher106340()
        return CommutativeMatcher106340._instance
