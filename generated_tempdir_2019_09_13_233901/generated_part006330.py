...
class CommutativeMatcher74428(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74428._instance is None:
            CommutativeMatcher74428._instance = CommutativeMatcher74428()
        return CommutativeMatcher74428._instance
