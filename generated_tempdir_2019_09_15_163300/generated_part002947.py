...
class CommutativeMatcher56970(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher56970._instance is None:
            CommutativeMatcher56970._instance = CommutativeMatcher56970()
        return CommutativeMatcher56970._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher56974.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002948 import *
from multiset import Multiset