...
class CommutativeMatcher77474(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77474._instance is None:
            CommutativeMatcher77474._instance = CommutativeMatcher77474()
        return CommutativeMatcher77474._instance
