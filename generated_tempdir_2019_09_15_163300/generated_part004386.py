...
class CommutativeMatcher136338(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136338._instance is None:
            CommutativeMatcher136338._instance = CommutativeMatcher136338()
        return CommutativeMatcher136338._instance
