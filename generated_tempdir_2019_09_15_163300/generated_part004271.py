...
class CommutativeMatcher134280(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134280._instance is None:
            CommutativeMatcher134280._instance = CommutativeMatcher134280()
        return CommutativeMatcher134280._instance
