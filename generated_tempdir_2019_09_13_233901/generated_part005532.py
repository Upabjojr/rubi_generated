...
class CommutativeMatcher31961(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31961._instance is None:
            CommutativeMatcher31961._instance = CommutativeMatcher31961()
        return CommutativeMatcher31961._instance
