...
class CommutativeMatcher21802(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21802._instance is None:
            CommutativeMatcher21802._instance = CommutativeMatcher21802()
        return CommutativeMatcher21802._instance
