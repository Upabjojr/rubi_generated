...
class CommutativeMatcher61305(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61305._instance is None:
            CommutativeMatcher61305._instance = CommutativeMatcher61305()
        return CommutativeMatcher61305._instance
