...
class CommutativeMatcher30557(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30557._instance is None:
            CommutativeMatcher30557._instance = CommutativeMatcher30557()
        return CommutativeMatcher30557._instance
