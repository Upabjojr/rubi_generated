...
class CommutativeMatcher104513(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104513._instance is None:
            CommutativeMatcher104513._instance = CommutativeMatcher104513()
        return CommutativeMatcher104513._instance
