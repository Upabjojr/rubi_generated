...
class CommutativeMatcher23092(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23092._instance is None:
            CommutativeMatcher23092._instance = CommutativeMatcher23092()
        return CommutativeMatcher23092._instance
