...
class CommutativeMatcher150253(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150253._instance is None:
            CommutativeMatcher150253._instance = CommutativeMatcher150253()
        return CommutativeMatcher150253._instance
