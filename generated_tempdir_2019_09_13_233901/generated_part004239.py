...
class CommutativeMatcher116626(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116626._instance is None:
            CommutativeMatcher116626._instance = CommutativeMatcher116626()
        return CommutativeMatcher116626._instance
