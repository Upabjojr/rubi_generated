...
class CommutativeMatcher46055(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46055._instance is None:
            CommutativeMatcher46055._instance = CommutativeMatcher46055()
        return CommutativeMatcher46055._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher47453.get()
                    tmp29 = subjects28
                    subjects28 = []
                    for s in tmp29:
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher47473.get()
                    tmp42 = subjects41
                    subjects41 = []
                    for s in tmp42:
                        matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher46069.get()
                tmp48 = subjects47
                subjects47 = []
                for s in tmp48:
                    matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher47458.get()
                tmp54 = subjects53
                subjects53 = []
                for s in tmp54:
                    matcher.add_subject(s)
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher47437.get()
                    tmp69 = subjects68
                    subjects68 = []
                    for s in tmp69:
                        matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher47440.get()
                tmp72 = subjects71
                subjects71 = []
                for s in tmp72:
                    matcher.add_subject(s)
...
from .generated_part009964 import *
from .generated_part009968 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part009966 import *
from .generated_part009965 import *
from collections import deque
from .generated_part009963 import *
from .generated_part009969 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset