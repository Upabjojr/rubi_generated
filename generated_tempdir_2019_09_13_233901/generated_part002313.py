...
class CommutativeMatcher67420(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67420._instance is None:
            CommutativeMatcher67420._instance = CommutativeMatcher67420()
        return CommutativeMatcher67420._instance
