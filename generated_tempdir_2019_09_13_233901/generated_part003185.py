...
class CommutativeMatcher60896(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60896._instance is None:
            CommutativeMatcher60896._instance = CommutativeMatcher60896()
        return CommutativeMatcher60896._instance
