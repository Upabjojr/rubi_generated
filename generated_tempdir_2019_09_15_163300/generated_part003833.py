...
class CommutativeMatcher24065(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher24065._instance is None:
            CommutativeMatcher24065._instance = CommutativeMatcher24065()
        return CommutativeMatcher24065._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher24069.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part003834 import *
from multiset import Multiset