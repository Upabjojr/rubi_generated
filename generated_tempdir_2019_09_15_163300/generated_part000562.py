...
class CommutativeMatcher42276(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42276._instance is None:
            CommutativeMatcher42276._instance = CommutativeMatcher42276()
        return CommutativeMatcher42276._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42283.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000563 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset