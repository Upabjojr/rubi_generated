...
class CommutativeMatcher60395(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60395._instance is None:
            CommutativeMatcher60395._instance = CommutativeMatcher60395()
        return CommutativeMatcher60395._instance
