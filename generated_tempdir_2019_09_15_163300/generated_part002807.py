...
class CommutativeMatcher81254(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81254._instance is None:
            CommutativeMatcher81254._instance = CommutativeMatcher81254()
        return CommutativeMatcher81254._instance
