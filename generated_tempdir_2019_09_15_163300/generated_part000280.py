...
class CommutativeMatcher120798(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120798._instance is None:
            CommutativeMatcher120798._instance = CommutativeMatcher120798()
        return CommutativeMatcher120798._instance
