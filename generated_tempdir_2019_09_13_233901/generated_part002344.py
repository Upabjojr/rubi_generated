...
class CommutativeMatcher23315(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23315._instance is None:
            CommutativeMatcher23315._instance = CommutativeMatcher23315()
        return CommutativeMatcher23315._instance
