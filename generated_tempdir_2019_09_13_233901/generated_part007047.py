...
class CommutativeMatcher141127(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141127._instance is None:
            CommutativeMatcher141127._instance = CommutativeMatcher141127()
        return CommutativeMatcher141127._instance
