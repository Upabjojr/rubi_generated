...
class CommutativeMatcher67353(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67353._instance is None:
            CommutativeMatcher67353._instance = CommutativeMatcher67353()
        return CommutativeMatcher67353._instance
