...
class CommutativeMatcher58331(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58331._instance is None:
            CommutativeMatcher58331._instance = CommutativeMatcher58331()
        return CommutativeMatcher58331._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher58335.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part002438 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset