...
class CommutativeMatcher31525(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31525._instance is None:
            CommutativeMatcher31525._instance = CommutativeMatcher31525()
        return CommutativeMatcher31525._instance
