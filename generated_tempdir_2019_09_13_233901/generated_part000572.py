...
class CommutativeMatcher42347(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42347._instance is None:
            CommutativeMatcher42347._instance = CommutativeMatcher42347()
        return CommutativeMatcher42347._instance
