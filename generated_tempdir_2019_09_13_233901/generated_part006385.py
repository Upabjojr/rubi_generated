...
class CommutativeMatcher74217(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74217._instance is None:
            CommutativeMatcher74217._instance = CommutativeMatcher74217()
        return CommutativeMatcher74217._instance
