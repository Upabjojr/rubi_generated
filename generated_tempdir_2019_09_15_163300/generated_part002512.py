...
class CommutativeMatcher22204(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22204._instance is None:
            CommutativeMatcher22204._instance = CommutativeMatcher22204()
        return CommutativeMatcher22204._instance
