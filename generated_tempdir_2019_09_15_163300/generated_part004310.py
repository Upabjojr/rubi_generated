...
class CommutativeMatcher141027(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141027._instance is None:
            CommutativeMatcher141027._instance = CommutativeMatcher141027()
        return CommutativeMatcher141027._instance
