...
class CommutativeMatcher145933(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145933._instance is None:
            CommutativeMatcher145933._instance = CommutativeMatcher145933()
        return CommutativeMatcher145933._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher145942.get()
            tmp23 = subjects22
            subjects22 = []
            for s in tmp23:
...
from .generated_part004329 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset