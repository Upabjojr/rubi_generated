...
class CommutativeMatcher22664(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22664._instance is None:
            CommutativeMatcher22664._instance = CommutativeMatcher22664()
        return CommutativeMatcher22664._instance
