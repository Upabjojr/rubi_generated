...
class CommutativeMatcher97739(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher97739._instance is None:
            CommutativeMatcher97739._instance = CommutativeMatcher97739()
        return CommutativeMatcher97739._instance
