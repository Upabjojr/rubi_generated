...
class CommutativeMatcher23021(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23021._instance is None:
            CommutativeMatcher23021._instance = CommutativeMatcher23021()
        return CommutativeMatcher23021._instance
