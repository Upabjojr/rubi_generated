...
class CommutativeMatcher21176(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21176._instance is None:
            CommutativeMatcher21176._instance = CommutativeMatcher21176()
        return CommutativeMatcher21176._instance
