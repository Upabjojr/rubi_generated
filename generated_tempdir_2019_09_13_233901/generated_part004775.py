...
class CommutativeMatcher126216(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126216._instance is None:
            CommutativeMatcher126216._instance = CommutativeMatcher126216()
        return CommutativeMatcher126216._instance
