...
class CommutativeMatcher78007(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78007._instance is None:
            CommutativeMatcher78007._instance = CommutativeMatcher78007()
        return CommutativeMatcher78007._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher78011.get()
            tmp19 = subjects18
            subjects18 = []
            for s in tmp19:
