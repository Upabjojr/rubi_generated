...
class CommutativeMatcher58100(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58100._instance is None:
            CommutativeMatcher58100._instance = CommutativeMatcher58100()
        return CommutativeMatcher58100._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher58104.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part009803 import *