...
class CommutativeMatcher21167(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21167._instance is None:
            CommutativeMatcher21167._instance = CommutativeMatcher21167()
        return CommutativeMatcher21167._instance
