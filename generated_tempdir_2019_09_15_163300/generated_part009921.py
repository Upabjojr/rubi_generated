...
class CommutativeMatcher135182(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135182._instance is None:
            CommutativeMatcher135182._instance = CommutativeMatcher135182()
        return CommutativeMatcher135182._instance
