...
class CommutativeMatcher33313(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33313._instance is None:
            CommutativeMatcher33313._instance = CommutativeMatcher33313()
        return CommutativeMatcher33313._instance
