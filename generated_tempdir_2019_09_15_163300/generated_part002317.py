...
class CommutativeMatcher67430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67430._instance is None:
            CommutativeMatcher67430._instance = CommutativeMatcher67430()
        return CommutativeMatcher67430._instance
