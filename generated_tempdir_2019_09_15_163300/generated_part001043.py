...
class CommutativeMatcher129628(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129628._instance is None:
            CommutativeMatcher129628._instance = CommutativeMatcher129628()
        return CommutativeMatcher129628._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129635.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part001044 import *