...
class CommutativeMatcher31090(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31090._instance is None:
            CommutativeMatcher31090._instance = CommutativeMatcher31090()
        return CommutativeMatcher31090._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher31099.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part001881 import *
from multiset import Multiset