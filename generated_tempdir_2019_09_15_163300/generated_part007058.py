...
class CommutativeMatcher141585(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141585._instance is None:
            CommutativeMatcher141585._instance = CommutativeMatcher141585()
        return CommutativeMatcher141585._instance
