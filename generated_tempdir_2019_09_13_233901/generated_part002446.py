...
class CommutativeMatcher67315(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67315._instance is None:
            CommutativeMatcher67315._instance = CommutativeMatcher67315()
        return CommutativeMatcher67315._instance
