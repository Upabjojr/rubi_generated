...
class CommutativeMatcher93310(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93310._instance is None:
            CommutativeMatcher93310._instance = CommutativeMatcher93310()
        return CommutativeMatcher93310._instance
