...
class CommutativeMatcher125982(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125982._instance is None:
            CommutativeMatcher125982._instance = CommutativeMatcher125982()
        return CommutativeMatcher125982._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher125986.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
