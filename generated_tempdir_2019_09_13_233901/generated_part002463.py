...
class CommutativeMatcher121938(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121938._instance is None:
            CommutativeMatcher121938._instance = CommutativeMatcher121938()
        return CommutativeMatcher121938._instance
