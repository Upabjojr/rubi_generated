...
class CommutativeMatcher40721(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40721._instance is None:
            CommutativeMatcher40721._instance = CommutativeMatcher40721()
        return CommutativeMatcher40721._instance
