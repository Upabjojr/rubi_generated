...
class CommutativeMatcher129448(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129448._instance is None:
            CommutativeMatcher129448._instance = CommutativeMatcher129448()
        return CommutativeMatcher129448._instance
