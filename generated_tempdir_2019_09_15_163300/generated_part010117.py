                ...
                if len(subjects22) >= 1 and isinstance(subjects22[0], Add):
                    ...
                    for pattern_index, subst2 in matcher.match(tmp55, subst1):
                        ...
                        if pattern_index == 0:
                            pass
                            # State 53575
                            if len(subjects22) >= 1 and subjects22[0] == Rational(1, 2):
                        ...
                        if len(subjects22) >= 1 and isinstance(subjects22[0], Pow):
                            ...
                            if len(subjects61) >= 1:
                                ...
                                try:
                                    ...
                                    pass
                                    # State 53609
                                    if len(subjects61) >= 1 and subjects61[0] == Integer(2):
...
from .generated_part010125 import *
from .generated_part010126 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part010118 import *
from .generated_part010119 import *
from .generated_part010121 import *
from .generated_part010132 import *
from .generated_part010135 import *
from collections import deque
from .generated_part010128 import *
from .generated_part010134 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset