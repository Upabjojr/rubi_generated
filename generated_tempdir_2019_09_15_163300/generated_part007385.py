...
class CommutativeMatcher65618(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65618._instance is None:
            CommutativeMatcher65618._instance = CommutativeMatcher65618()
        return CommutativeMatcher65618._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher65622.get()
            tmp24 = subjects23
            subjects23 = []
            for s in tmp24:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part007386 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset