...
class CommutativeMatcher124362(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124362._instance is None:
            CommutativeMatcher124362._instance = CommutativeMatcher124362()
        return CommutativeMatcher124362._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher124369.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part006341 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset