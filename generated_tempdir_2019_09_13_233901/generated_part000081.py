...
class CommutativeMatcher41753(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41753._instance is None:
            CommutativeMatcher41753._instance = CommutativeMatcher41753()
        return CommutativeMatcher41753._instance
