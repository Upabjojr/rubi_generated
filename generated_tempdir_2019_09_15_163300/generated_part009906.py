...
class CommutativeMatcher129062(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129062._instance is None:
            CommutativeMatcher129062._instance = CommutativeMatcher129062()
        return CommutativeMatcher129062._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129069.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009907 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset