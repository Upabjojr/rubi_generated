...
class CommutativeMatcher89315(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89315._instance is None:
            CommutativeMatcher89315._instance = CommutativeMatcher89315()
        return CommutativeMatcher89315._instance
