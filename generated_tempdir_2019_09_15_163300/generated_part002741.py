...
class CommutativeMatcher22717(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22717._instance is None:
            CommutativeMatcher22717._instance = CommutativeMatcher22717()
        return CommutativeMatcher22717._instance
