...
class CommutativeMatcher106007(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106007._instance is None:
            CommutativeMatcher106007._instance = CommutativeMatcher106007()
        return CommutativeMatcher106007._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], log):
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                    ...
                    matcher = CommutativeMatcher106020.get()
                    tmp17 = subjects16
                    subjects16 = []
                    for s in tmp17:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher106030.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001672 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part001673 import *