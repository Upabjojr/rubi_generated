...
class CommutativeMatcher106681(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106681._instance is None:
            CommutativeMatcher106681._instance = CommutativeMatcher106681()
        return CommutativeMatcher106681._instance
