...
class CommutativeMatcher141287(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141287._instance is None:
            CommutativeMatcher141287._instance = CommutativeMatcher141287()
        return CommutativeMatcher141287._instance
