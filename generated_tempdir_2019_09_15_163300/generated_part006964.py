...
class CommutativeMatcher112002(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher112002._instance is None:
            CommutativeMatcher112002._instance = CommutativeMatcher112002()
        return CommutativeMatcher112002._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher112010.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006965 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset