...
class CommutativeMatcher140035(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140035._instance is None:
            CommutativeMatcher140035._instance = CommutativeMatcher140035()
        return CommutativeMatcher140035._instance
    ...
    def get_match_iter(subject):
                    ...
                    try:
                        ...
                        if len(subjects6) >= 1 and subjects6[0] == Integer(2):
                            ...
                            if len(subjects6) == 0:
                                ...
                                if len(subjects) == 0:
                                    pass
                                    # 1: d*x**2 /; (cons_f2) and (cons_f3) and (cons_f8) and (cons_f29)
                                    yield 1, subst2
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher140039.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009189 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset