...
class CommutativeMatcher124141(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124141._instance is None:
            CommutativeMatcher124141._instance = CommutativeMatcher124141()
        return CommutativeMatcher124141._instance
