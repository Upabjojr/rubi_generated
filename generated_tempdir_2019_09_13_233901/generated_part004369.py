...
class CommutativeMatcher136160(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136160._instance is None:
            CommutativeMatcher136160._instance = CommutativeMatcher136160()
        return CommutativeMatcher136160._instance
