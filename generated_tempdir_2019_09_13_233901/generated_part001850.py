...
class CommutativeMatcher22909(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22909._instance is None:
            CommutativeMatcher22909._instance = CommutativeMatcher22909()
        return CommutativeMatcher22909._instance
