...
class CommutativeMatcher26447(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26447._instance is None:
            CommutativeMatcher26447._instance = CommutativeMatcher26447()
        return CommutativeMatcher26447._instance
