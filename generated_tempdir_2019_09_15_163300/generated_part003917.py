...
class CommutativeMatcher108778(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108778._instance is None:
            CommutativeMatcher108778._instance = CommutativeMatcher108778()
        return CommutativeMatcher108778._instance
