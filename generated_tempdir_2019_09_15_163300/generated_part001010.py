...
class CommutativeMatcher150040(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150040._instance is None:
            CommutativeMatcher150040._instance = CommutativeMatcher150040()
        return CommutativeMatcher150040._instance
