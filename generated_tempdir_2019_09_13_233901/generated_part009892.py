...
class CommutativeMatcher105626(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105626._instance is None:
            CommutativeMatcher105626._instance = CommutativeMatcher105626()
        return CommutativeMatcher105626._instance
