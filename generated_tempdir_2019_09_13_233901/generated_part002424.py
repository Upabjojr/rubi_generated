...
class CommutativeMatcher23582(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23582._instance is None:
            CommutativeMatcher23582._instance = CommutativeMatcher23582()
        return CommutativeMatcher23582._instance
