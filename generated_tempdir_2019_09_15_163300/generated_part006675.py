...
class CommutativeMatcher136112(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136112._instance is None:
            CommutativeMatcher136112._instance = CommutativeMatcher136112()
        return CommutativeMatcher136112._instance
