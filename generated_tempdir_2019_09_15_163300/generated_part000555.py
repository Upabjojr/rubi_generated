...
class CommutativeMatcher42234(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42234._instance is None:
            CommutativeMatcher42234._instance = CommutativeMatcher42234()
        return CommutativeMatcher42234._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42241.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000556 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset