...
class CommutativeMatcher133568(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133568._instance is None:
            CommutativeMatcher133568._instance = CommutativeMatcher133568()
        return CommutativeMatcher133568._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher133580.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from .generated_part001644 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset