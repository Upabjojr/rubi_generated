...
class CommutativeMatcher104431(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104431._instance is None:
            CommutativeMatcher104431._instance = CommutativeMatcher104431()
        return CommutativeMatcher104431._instance
