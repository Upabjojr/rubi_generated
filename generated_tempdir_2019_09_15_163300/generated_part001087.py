...
class CommutativeMatcher87098(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher87098._instance is None:
            CommutativeMatcher87098._instance = CommutativeMatcher87098()
        return CommutativeMatcher87098._instance
