...
class CommutativeMatcher21509(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21509._instance is None:
            CommutativeMatcher21509._instance = CommutativeMatcher21509()
        return CommutativeMatcher21509._instance
