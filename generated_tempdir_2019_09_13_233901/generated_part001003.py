...
class CommutativeMatcher149598(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149598._instance is None:
            CommutativeMatcher149598._instance = CommutativeMatcher149598()
        return CommutativeMatcher149598._instance
