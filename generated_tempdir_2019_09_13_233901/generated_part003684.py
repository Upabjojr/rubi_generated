...
class CommutativeMatcher124331(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124331._instance is None:
            CommutativeMatcher124331._instance = CommutativeMatcher124331()
        return CommutativeMatcher124331._instance
