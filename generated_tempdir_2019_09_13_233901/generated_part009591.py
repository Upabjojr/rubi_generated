...
class CommutativeMatcher77465(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77465._instance is None:
            CommutativeMatcher77465._instance = CommutativeMatcher77465()
        return CommutativeMatcher77465._instance
