...
class CommutativeMatcher93282(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93282._instance is None:
            CommutativeMatcher93282._instance = CommutativeMatcher93282()
        return CommutativeMatcher93282._instance
