...
class CommutativeMatcher67261(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67261._instance is None:
            CommutativeMatcher67261._instance = CommutativeMatcher67261()
        return CommutativeMatcher67261._instance
