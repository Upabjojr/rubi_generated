...
class CommutativeMatcher135955(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135955._instance is None:
            CommutativeMatcher135955._instance = CommutativeMatcher135955()
        return CommutativeMatcher135955._instance
