...
class CommutativeMatcher22114(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22114._instance is None:
            CommutativeMatcher22114._instance = CommutativeMatcher22114()
        return CommutativeMatcher22114._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22118.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005386 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset