...
class CommutativeMatcher49423(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49423._instance is None:
            CommutativeMatcher49423._instance = CommutativeMatcher49423()
        return CommutativeMatcher49423._instance
