...
class CommutativeMatcher32601(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32601._instance is None:
            CommutativeMatcher32601._instance = CommutativeMatcher32601()
        return CommutativeMatcher32601._instance
