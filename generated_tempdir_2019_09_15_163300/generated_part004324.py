...
class CommutativeMatcher145894(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145894._instance is None:
            CommutativeMatcher145894._instance = CommutativeMatcher145894()
        return CommutativeMatcher145894._instance
