...
class CommutativeMatcher13230(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13230._instance is None:
            CommutativeMatcher13230._instance = CommutativeMatcher13230()
        return CommutativeMatcher13230._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13237.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part001232 import *