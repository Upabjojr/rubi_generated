...
class CommutativeMatcher46184(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46184._instance is None:
            CommutativeMatcher46184._instance = CommutativeMatcher46184()
        return CommutativeMatcher46184._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher46830.get()
                    tmp41 = subjects40
                    subjects40 = []
                    for s in tmp41:
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher47667.get()
                    tmp72 = subjects71
                    subjects71 = []
                    for s in tmp72:
                        matcher.add_subject(s)
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher48292.get()
                    tmp90 = subjects89
                    subjects89 = []
                    for s in tmp90:
                        matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher46198.get()
                tmp96 = subjects95
                subjects95 = []
                for s in tmp96:
                    matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher46835.get()
                tmp102 = subjects101
                subjects101 = []
                for s in tmp102:
                    matcher.add_subject(s)
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher46848.get()
                tmp134 = subjects133
                subjects133 = []
                for s in tmp134:
                    matcher.add_subject(s)
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher47638.get()
                    tmp147 = subjects146
                    subjects146 = []
                    for s in tmp147:
                        matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher47641.get()
                tmp150 = subjects149
                subjects149 = []
                for s in tmp150:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher46851.get()
            tmp153 = subjects152
            subjects152 = []
            for s in tmp153:
                matcher.add_subject(s)
...
from .generated_part004152 import *
from .generated_part004144 import *
from .generated_part004150 import *
from .generated_part004148 import *
from .generated_part004145 import *
from .generated_part004146 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from matchpy.utils import VariableWithCount
from .generated_part004149 import *
from collections import deque
from .generated_part004143 import *
from .generated_part004142 import *
from multiset import Multiset