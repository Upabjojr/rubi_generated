...
class CommutativeMatcher32993(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32993._instance is None:
            CommutativeMatcher32993._instance = CommutativeMatcher32993()
        return CommutativeMatcher32993._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher33002.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004661 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset