...
class CommutativeMatcher145922(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145922._instance is None:
            CommutativeMatcher145922._instance = CommutativeMatcher145922()
        return CommutativeMatcher145922._instance
