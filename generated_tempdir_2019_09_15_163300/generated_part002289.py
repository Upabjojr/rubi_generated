...
class CommutativeMatcher14890(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher14890._instance is None:
            CommutativeMatcher14890._instance = CommutativeMatcher14890()
        return CommutativeMatcher14890._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher14895.get()
                tmp7 = subjects6
                subjects6 = []
                for s in tmp7:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher14898.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part002291 import *
from .generated_part002290 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset