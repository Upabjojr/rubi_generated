...
class CommutativeMatcher93082(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93082._instance is None:
            CommutativeMatcher93082._instance = CommutativeMatcher93082()
        return CommutativeMatcher93082._instance
