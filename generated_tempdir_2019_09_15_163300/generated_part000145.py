...
class CommutativeMatcher40813(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40813._instance is None:
            CommutativeMatcher40813._instance = CommutativeMatcher40813()
        return CommutativeMatcher40813._instance
