...
class CommutativeMatcher134250(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134250._instance is None:
            CommutativeMatcher134250._instance = CommutativeMatcher134250()
        return CommutativeMatcher134250._instance
