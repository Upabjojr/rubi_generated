...
class CommutativeMatcher133397(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133397._instance is None:
            CommutativeMatcher133397._instance = CommutativeMatcher133397()
        return CommutativeMatcher133397._instance
