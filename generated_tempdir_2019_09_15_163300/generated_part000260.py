...
class CommutativeMatcher116843(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116843._instance is None:
            CommutativeMatcher116843._instance = CommutativeMatcher116843()
        return CommutativeMatcher116843._instance
