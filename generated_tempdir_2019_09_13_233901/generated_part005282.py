...
class CommutativeMatcher126127(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126127._instance is None:
            CommutativeMatcher126127._instance = CommutativeMatcher126127()
        return CommutativeMatcher126127._instance
