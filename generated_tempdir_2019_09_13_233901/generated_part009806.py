...
class CommutativeMatcher58146(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58146._instance is None:
            CommutativeMatcher58146._instance = CommutativeMatcher58146()
        return CommutativeMatcher58146._instance
