...
class CommutativeMatcher21535(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21535._instance is None:
            CommutativeMatcher21535._instance = CommutativeMatcher21535()
        return CommutativeMatcher21535._instance
