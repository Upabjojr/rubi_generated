...
class CommutativeMatcher146420(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146420._instance is None:
            CommutativeMatcher146420._instance = CommutativeMatcher146420()
        return CommutativeMatcher146420._instance
