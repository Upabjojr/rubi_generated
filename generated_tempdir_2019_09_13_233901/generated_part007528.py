...
class CommutativeMatcher113014(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113014._instance is None:
            CommutativeMatcher113014._instance = CommutativeMatcher113014()
        return CommutativeMatcher113014._instance
