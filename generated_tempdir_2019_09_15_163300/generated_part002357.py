...
class CommutativeMatcher23361(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23361._instance is None:
            CommutativeMatcher23361._instance = CommutativeMatcher23361()
        return CommutativeMatcher23361._instance
