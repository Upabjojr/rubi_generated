...
class CommutativeMatcher150139(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150139._instance is None:
            CommutativeMatcher150139._instance = CommutativeMatcher150139()
        return CommutativeMatcher150139._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher150148.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part004347 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset