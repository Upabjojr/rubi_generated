...
class CommutativeMatcher77807(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77807._instance is None:
            CommutativeMatcher77807._instance = CommutativeMatcher77807()
        return CommutativeMatcher77807._instance
