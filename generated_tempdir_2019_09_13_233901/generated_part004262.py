...
class CommutativeMatcher120951(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120951._instance is None:
            CommutativeMatcher120951._instance = CommutativeMatcher120951()
        return CommutativeMatcher120951._instance
