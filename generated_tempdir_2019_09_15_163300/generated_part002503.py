...
class CommutativeMatcher126442(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126442._instance is None:
            CommutativeMatcher126442._instance = CommutativeMatcher126442()
        return CommutativeMatcher126442._instance
