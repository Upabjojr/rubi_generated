...
class CommutativeMatcher51681(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher51681._instance is None:
            CommutativeMatcher51681._instance = CommutativeMatcher51681()
        return CommutativeMatcher51681._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher51689.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher51694.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001079 import *
from collections import deque
from .generated_part001078 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset