...
class CommutativeMatcher74355(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74355._instance is None:
            CommutativeMatcher74355._instance = CommutativeMatcher74355()
        return CommutativeMatcher74355._instance
