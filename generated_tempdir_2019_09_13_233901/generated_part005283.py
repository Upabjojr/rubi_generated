...
class CommutativeMatcher129393(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129393._instance is None:
            CommutativeMatcher129393._instance = CommutativeMatcher129393()
        return CommutativeMatcher129393._instance
