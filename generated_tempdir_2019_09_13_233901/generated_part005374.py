...
class CommutativeMatcher33596(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33596._instance is None:
            CommutativeMatcher33596._instance = CommutativeMatcher33596()
        return CommutativeMatcher33596._instance
