...
class CommutativeMatcher141483(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141483._instance is None:
            CommutativeMatcher141483._instance = CommutativeMatcher141483()
        return CommutativeMatcher141483._instance
