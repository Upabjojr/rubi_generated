...
class CommutativeMatcher41160(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41160._instance is None:
            CommutativeMatcher41160._instance = CommutativeMatcher41160()
        return CommutativeMatcher41160._instance
