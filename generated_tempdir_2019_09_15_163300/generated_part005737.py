...
class CommutativeMatcher32418(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32418._instance is None:
            CommutativeMatcher32418._instance = CommutativeMatcher32418()
        return CommutativeMatcher32418._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher32427.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part005738 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset