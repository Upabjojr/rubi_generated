...
class CommutativeMatcher22582(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22582._instance is None:
            CommutativeMatcher22582._instance = CommutativeMatcher22582()
        return CommutativeMatcher22582._instance
