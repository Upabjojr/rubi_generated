...
class CommutativeMatcher21713(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21713._instance is None:
            CommutativeMatcher21713._instance = CommutativeMatcher21713()
        return CommutativeMatcher21713._instance
