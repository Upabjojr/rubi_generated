...
class CommutativeMatcher68803(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher68803._instance is None:
            CommutativeMatcher68803._instance = CommutativeMatcher68803()
        return CommutativeMatcher68803._instance
