...
class CommutativeMatcher41728(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41728._instance is None:
            CommutativeMatcher41728._instance = CommutativeMatcher41728()
        return CommutativeMatcher41728._instance
