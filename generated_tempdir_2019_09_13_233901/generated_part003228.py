...
class CommutativeMatcher74064(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74064._instance is None:
            CommutativeMatcher74064._instance = CommutativeMatcher74064()
        return CommutativeMatcher74064._instance
