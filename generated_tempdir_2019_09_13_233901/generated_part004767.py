...
class CommutativeMatcher121950(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121950._instance is None:
            CommutativeMatcher121950._instance = CommutativeMatcher121950()
        return CommutativeMatcher121950._instance
