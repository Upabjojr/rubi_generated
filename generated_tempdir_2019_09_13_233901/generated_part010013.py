...
class CommutativeMatcher104324(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104324._instance is None:
            CommutativeMatcher104324._instance = CommutativeMatcher104324()
        return CommutativeMatcher104324._instance
