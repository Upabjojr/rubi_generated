...
class CommutativeMatcher140075(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140075._instance is None:
            CommutativeMatcher140075._instance = CommutativeMatcher140075()
        return CommutativeMatcher140075._instance
