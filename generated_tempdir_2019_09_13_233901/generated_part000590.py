...
class CommutativeMatcher42445(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42445._instance is None:
            CommutativeMatcher42445._instance = CommutativeMatcher42445()
        return CommutativeMatcher42445._instance
