...
class CommutativeMatcher141104(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141104._instance is None:
            CommutativeMatcher141104._instance = CommutativeMatcher141104()
        return CommutativeMatcher141104._instance
