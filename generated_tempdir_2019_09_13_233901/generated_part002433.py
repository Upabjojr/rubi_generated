...
class CommutativeMatcher31866(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31866._instance is None:
            CommutativeMatcher31866._instance = CommutativeMatcher31866()
        return CommutativeMatcher31866._instance
