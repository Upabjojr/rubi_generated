...
class CommutativeMatcher31014(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31014._instance is None:
            CommutativeMatcher31014._instance = CommutativeMatcher31014()
        return CommutativeMatcher31014._instance
