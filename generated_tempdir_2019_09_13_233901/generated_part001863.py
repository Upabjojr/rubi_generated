...
class CommutativeMatcher22952(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22952._instance is None:
            CommutativeMatcher22952._instance = CommutativeMatcher22952()
        return CommutativeMatcher22952._instance
