...
class CommutativeMatcher140066(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140066._instance is None:
            CommutativeMatcher140066._instance = CommutativeMatcher140066()
        return CommutativeMatcher140066._instance
