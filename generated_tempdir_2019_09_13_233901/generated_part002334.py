...
class CommutativeMatcher31443(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31443._instance is None:
            CommutativeMatcher31443._instance = CommutativeMatcher31443()
        return CommutativeMatcher31443._instance
