...
class CommutativeMatcher108786(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108786._instance is None:
            CommutativeMatcher108786._instance = CommutativeMatcher108786()
        return CommutativeMatcher108786._instance
