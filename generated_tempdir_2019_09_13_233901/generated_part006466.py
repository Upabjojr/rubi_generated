...
class CommutativeMatcher59293(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59293._instance is None:
            CommutativeMatcher59293._instance = CommutativeMatcher59293()
        return CommutativeMatcher59293._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher59297.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
