...
class CommutativeMatcher146000(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146000._instance is None:
            CommutativeMatcher146000._instance = CommutativeMatcher146000()
        return CommutativeMatcher146000._instance
