...
class CommutativeMatcher136092(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136092._instance is None:
            CommutativeMatcher136092._instance = CommutativeMatcher136092()
        return CommutativeMatcher136092._instance
