...
class CommutativeMatcher84685(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher84685._instance is None:
            CommutativeMatcher84685._instance = CommutativeMatcher84685()
        return CommutativeMatcher84685._instance
