...
class CommutativeMatcher21758(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21758._instance is None:
            CommutativeMatcher21758._instance = CommutativeMatcher21758()
        return CommutativeMatcher21758._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21762.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from .generated_part004710 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset