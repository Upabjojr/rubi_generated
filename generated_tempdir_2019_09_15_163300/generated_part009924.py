...
class CommutativeMatcher135200(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135200._instance is None:
            CommutativeMatcher135200._instance = CommutativeMatcher135200()
        return CommutativeMatcher135200._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], log):
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                    ...
                    matcher = CommutativeMatcher135213.get()
                    tmp17 = subjects16
                    subjects16 = []
                    for s in tmp17:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher135223.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
                matcher.add_subject(s)
...
from .generated_part009925 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009926 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset