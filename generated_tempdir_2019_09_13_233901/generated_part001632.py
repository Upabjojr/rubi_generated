...
class CommutativeMatcher133531(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133531._instance is None:
            CommutativeMatcher133531._instance = CommutativeMatcher133531()
        return CommutativeMatcher133531._instance
