...
class CommutativeMatcher64964(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64964._instance is None:
            CommutativeMatcher64964._instance = CommutativeMatcher64964()
        return CommutativeMatcher64964._instance
