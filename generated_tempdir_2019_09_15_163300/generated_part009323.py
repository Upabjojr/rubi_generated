...
class CommutativeMatcher110317(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110317._instance is None:
            CommutativeMatcher110317._instance = CommutativeMatcher110317()
        return CommutativeMatcher110317._instance
