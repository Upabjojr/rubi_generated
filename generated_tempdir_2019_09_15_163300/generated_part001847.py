...
class CommutativeMatcher129434(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129434._instance is None:
            CommutativeMatcher129434._instance = CommutativeMatcher129434()
        return CommutativeMatcher129434._instance
