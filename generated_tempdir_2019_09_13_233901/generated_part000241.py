...
class CommutativeMatcher111112(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111112._instance is None:
            CommutativeMatcher111112._instance = CommutativeMatcher111112()
        return CommutativeMatcher111112._instance
