...
class CommutativeMatcher129454(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129454._instance is None:
            CommutativeMatcher129454._instance = CommutativeMatcher129454()
        return CommutativeMatcher129454._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129458.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part002326 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset