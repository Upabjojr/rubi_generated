...
class CommutativeMatcher32543(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32543._instance is None:
            CommutativeMatcher32543._instance = CommutativeMatcher32543()
        return CommutativeMatcher32543._instance
