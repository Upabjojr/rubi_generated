...
class CommutativeMatcher134916(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134916._instance is None:
            CommutativeMatcher134916._instance = CommutativeMatcher134916()
        return CommutativeMatcher134916._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher134928.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009923 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset