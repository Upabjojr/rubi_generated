...
class CommutativeMatcher22342(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22342._instance is None:
            CommutativeMatcher22342._instance = CommutativeMatcher22342()
        return CommutativeMatcher22342._instance
