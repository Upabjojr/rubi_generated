...
class CommutativeMatcher31176(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31176._instance is None:
            CommutativeMatcher31176._instance = CommutativeMatcher31176()
        return CommutativeMatcher31176._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher31185.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001900 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset