...
class CommutativeMatcher79250(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79250._instance is None:
            CommutativeMatcher79250._instance = CommutativeMatcher79250()
        return CommutativeMatcher79250._instance
