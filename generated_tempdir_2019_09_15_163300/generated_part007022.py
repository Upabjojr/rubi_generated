...
class CommutativeMatcher134183(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134183._instance is None:
            CommutativeMatcher134183._instance = CommutativeMatcher134183()
        return CommutativeMatcher134183._instance
