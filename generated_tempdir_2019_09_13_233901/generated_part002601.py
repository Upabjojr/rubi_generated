...
class CommutativeMatcher30441(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30441._instance is None:
            CommutativeMatcher30441._instance = CommutativeMatcher30441()
        return CommutativeMatcher30441._instance
