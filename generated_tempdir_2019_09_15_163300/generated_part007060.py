...
class CommutativeMatcher141605(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141605._instance is None:
            CommutativeMatcher141605._instance = CommutativeMatcher141605()
        return CommutativeMatcher141605._instance
