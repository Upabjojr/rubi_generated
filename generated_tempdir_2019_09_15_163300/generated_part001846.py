...
class CommutativeMatcher129430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129430._instance is None:
            CommutativeMatcher129430._instance = CommutativeMatcher129430()
        return CommutativeMatcher129430._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129434.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part001847 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset