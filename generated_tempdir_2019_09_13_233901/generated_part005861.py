...
class CommutativeMatcher122261(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122261._instance is None:
            CommutativeMatcher122261._instance = CommutativeMatcher122261()
        return CommutativeMatcher122261._instance
