...
class CommutativeMatcher125589(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125589._instance is None:
            CommutativeMatcher125589._instance = CommutativeMatcher125589()
        return CommutativeMatcher125589._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects7) >= 1 and isinstance(subjects7[0], Mul):
                ...
                matcher = CommutativeMatcher133305.get()
                tmp21 = subjects20
                subjects20 = []
                for s in tmp21:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part010076 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset