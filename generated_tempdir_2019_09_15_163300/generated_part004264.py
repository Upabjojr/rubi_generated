...
class CommutativeMatcher120972(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120972._instance is None:
            CommutativeMatcher120972._instance = CommutativeMatcher120972()
        return CommutativeMatcher120972._instance
