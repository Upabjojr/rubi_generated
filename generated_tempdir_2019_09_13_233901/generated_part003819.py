...
class CommutativeMatcher65921(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65921._instance is None:
            CommutativeMatcher65921._instance = CommutativeMatcher65921()
        return CommutativeMatcher65921._instance
