...
class CommutativeMatcher133893(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133893._instance is None:
            CommutativeMatcher133893._instance = CommutativeMatcher133893()
        return CommutativeMatcher133893._instance
