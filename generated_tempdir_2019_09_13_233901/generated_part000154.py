...
class CommutativeMatcher40902(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40902._instance is None:
            CommutativeMatcher40902._instance = CommutativeMatcher40902()
        return CommutativeMatcher40902._instance
