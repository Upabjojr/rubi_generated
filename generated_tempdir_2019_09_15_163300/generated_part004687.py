...
class CommutativeMatcher21687(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21687._instance is None:
            CommutativeMatcher21687._instance = CommutativeMatcher21687()
        return CommutativeMatcher21687._instance
