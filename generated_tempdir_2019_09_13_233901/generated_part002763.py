...
class CommutativeMatcher22780(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22780._instance is None:
            CommutativeMatcher22780._instance = CommutativeMatcher22780()
        return CommutativeMatcher22780._instance
