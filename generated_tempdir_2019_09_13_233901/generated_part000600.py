...
class CommutativeMatcher42513(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42513._instance is None:
            CommutativeMatcher42513._instance = CommutativeMatcher42513()
        return CommutativeMatcher42513._instance
