...
class CommutativeMatcher23448(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23448._instance is None:
            CommutativeMatcher23448._instance = CommutativeMatcher23448()
        return CommutativeMatcher23448._instance
