...
class CommutativeMatcher110304(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110304._instance is None:
            CommutativeMatcher110304._instance = CommutativeMatcher110304()
        return CommutativeMatcher110304._instance
