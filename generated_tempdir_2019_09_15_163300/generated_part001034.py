...
class CommutativeMatcher97443(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher97443._instance is None:
            CommutativeMatcher97443._instance = CommutativeMatcher97443()
        return CommutativeMatcher97443._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher97450.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from .generated_part001035 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset