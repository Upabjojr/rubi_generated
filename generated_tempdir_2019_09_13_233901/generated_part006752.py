...
class CommutativeMatcher111433(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111433._instance is None:
            CommutativeMatcher111433._instance = CommutativeMatcher111433()
        return CommutativeMatcher111433._instance
