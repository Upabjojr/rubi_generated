...
class CommutativeMatcher21127(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21127._instance is None:
            CommutativeMatcher21127._instance = CommutativeMatcher21127()
        return CommutativeMatcher21127._instance
