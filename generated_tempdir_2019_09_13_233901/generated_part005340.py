...
class CommutativeMatcher21987(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21987._instance is None:
            CommutativeMatcher21987._instance = CommutativeMatcher21987()
        return CommutativeMatcher21987._instance
