...
class CommutativeMatcher42990(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42990._instance is None:
            CommutativeMatcher42990._instance = CommutativeMatcher42990()
        return CommutativeMatcher42990._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42997.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000377 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset