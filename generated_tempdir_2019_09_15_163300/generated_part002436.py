...
class CommutativeMatcher58327(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58327._instance is None:
            CommutativeMatcher58327._instance = CommutativeMatcher58327()
        return CommutativeMatcher58327._instance
