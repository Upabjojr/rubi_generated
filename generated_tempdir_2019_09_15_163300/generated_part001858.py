...
class CommutativeMatcher22939(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22939._instance is None:
            CommutativeMatcher22939._instance = CommutativeMatcher22939()
        return CommutativeMatcher22939._instance
