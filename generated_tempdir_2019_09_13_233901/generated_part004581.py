...
class CommutativeMatcher61873(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61873._instance is None:
            CommutativeMatcher61873._instance = CommutativeMatcher61873()
        return CommutativeMatcher61873._instance
