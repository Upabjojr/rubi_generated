...
class CommutativeMatcher20970(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20970._instance is None:
            CommutativeMatcher20970._instance = CommutativeMatcher20970()
        return CommutativeMatcher20970._instance
