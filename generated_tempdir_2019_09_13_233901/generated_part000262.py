...
class CommutativeMatcher116866(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116866._instance is None:
            CommutativeMatcher116866._instance = CommutativeMatcher116866()
        return CommutativeMatcher116866._instance
