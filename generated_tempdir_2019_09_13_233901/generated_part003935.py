...
class CommutativeMatcher65945(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65945._instance is None:
            CommutativeMatcher65945._instance = CommutativeMatcher65945()
        return CommutativeMatcher65945._instance
