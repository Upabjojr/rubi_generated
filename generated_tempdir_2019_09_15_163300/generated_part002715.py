...
class CommutativeMatcher22621(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22621._instance is None:
            CommutativeMatcher22621._instance = CommutativeMatcher22621()
        return CommutativeMatcher22621._instance
