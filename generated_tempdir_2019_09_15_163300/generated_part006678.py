...
class CommutativeMatcher128950(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128950._instance is None:
            CommutativeMatcher128950._instance = CommutativeMatcher128950()
        return CommutativeMatcher128950._instance
