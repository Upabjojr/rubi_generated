...
class CommutativeMatcher63991(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63991._instance is None:
            CommutativeMatcher63991._instance = CommutativeMatcher63991()
        return CommutativeMatcher63991._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher63995.get()
            tmp15 = subjects14
            subjects14 = []
            for s in tmp15:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004896 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset