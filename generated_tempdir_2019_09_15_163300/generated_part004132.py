...
class CommutativeMatcher46726(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46726._instance is None:
            CommutativeMatcher46726._instance = CommutativeMatcher46726()
        return CommutativeMatcher46726._instance
