...
class CommutativeMatcher23130(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23130._instance is None:
            CommutativeMatcher23130._instance = CommutativeMatcher23130()
        return CommutativeMatcher23130._instance
