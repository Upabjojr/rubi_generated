...
class CommutativeMatcher22506(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22506._instance is None:
            CommutativeMatcher22506._instance = CommutativeMatcher22506()
        return CommutativeMatcher22506._instance
