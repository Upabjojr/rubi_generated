...
class CommutativeMatcher93318(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93318._instance is None:
            CommutativeMatcher93318._instance = CommutativeMatcher93318()
        return CommutativeMatcher93318._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher93322.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part005504 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset