...
class CommutativeMatcher133259(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133259._instance is None:
            CommutativeMatcher133259._instance = CommutativeMatcher133259()
        return CommutativeMatcher133259._instance
