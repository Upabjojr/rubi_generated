...
class CommutativeMatcher21762(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21762._instance is None:
            CommutativeMatcher21762._instance = CommutativeMatcher21762()
        return CommutativeMatcher21762._instance
