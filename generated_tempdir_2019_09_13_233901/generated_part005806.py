...
class CommutativeMatcher21369(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21369._instance is None:
            CommutativeMatcher21369._instance = CommutativeMatcher21369()
        return CommutativeMatcher21369._instance
