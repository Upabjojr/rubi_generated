...
class CommutativeMatcher124388(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124388._instance is None:
            CommutativeMatcher124388._instance = CommutativeMatcher124388()
        return CommutativeMatcher124388._instance
