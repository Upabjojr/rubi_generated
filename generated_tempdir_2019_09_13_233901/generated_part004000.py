...
class CommutativeMatcher49495(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49495._instance is None:
            CommutativeMatcher49495._instance = CommutativeMatcher49495()
        return CommutativeMatcher49495._instance
