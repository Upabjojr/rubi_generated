...
class CommutativeMatcher126839(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126839._instance is None:
            CommutativeMatcher126839._instance = CommutativeMatcher126839()
        return CommutativeMatcher126839._instance
