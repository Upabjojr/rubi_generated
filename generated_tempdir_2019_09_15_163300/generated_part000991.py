...
class CommutativeMatcher145818(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145818._instance is None:
            CommutativeMatcher145818._instance = CommutativeMatcher145818()
        return CommutativeMatcher145818._instance
