...
class CommutativeMatcher127006(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher127006._instance is None:
            CommutativeMatcher127006._instance = CommutativeMatcher127006()
        return CommutativeMatcher127006._instance
