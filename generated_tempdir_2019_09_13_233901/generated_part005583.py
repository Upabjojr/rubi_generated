...
class CommutativeMatcher32169(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32169._instance is None:
            CommutativeMatcher32169._instance = CommutativeMatcher32169()
        return CommutativeMatcher32169._instance
