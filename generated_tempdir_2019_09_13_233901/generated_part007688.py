...
class CommutativeMatcher75597(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher75597._instance is None:
            CommutativeMatcher75597._instance = CommutativeMatcher75597()
        return CommutativeMatcher75597._instance
