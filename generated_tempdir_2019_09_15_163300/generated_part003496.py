...
class CommutativeMatcher78058(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78058._instance is None:
            CommutativeMatcher78058._instance = CommutativeMatcher78058()
        return CommutativeMatcher78058._instance
