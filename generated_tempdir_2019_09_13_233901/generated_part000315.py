...
class CommutativeMatcher149532(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149532._instance is None:
            CommutativeMatcher149532._instance = CommutativeMatcher149532()
        return CommutativeMatcher149532._instance
