...
class CommutativeMatcher110340(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110340._instance is None:
            CommutativeMatcher110340._instance = CommutativeMatcher110340()
        return CommutativeMatcher110340._instance
