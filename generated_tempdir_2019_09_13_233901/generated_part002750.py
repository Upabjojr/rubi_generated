...
class CommutativeMatcher22742(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22742._instance is None:
            CommutativeMatcher22742._instance = CommutativeMatcher22742()
        return CommutativeMatcher22742._instance
