...
class CommutativeMatcher133232(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133232._instance is None:
            CommutativeMatcher133232._instance = CommutativeMatcher133232()
        return CommutativeMatcher133232._instance
