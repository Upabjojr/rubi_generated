...
class CommutativeMatcher77633(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77633._instance is None:
            CommutativeMatcher77633._instance = CommutativeMatcher77633()
        return CommutativeMatcher77633._instance
