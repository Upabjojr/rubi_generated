...
class CommutativeMatcher46919(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46919._instance is None:
            CommutativeMatcher46919._instance = CommutativeMatcher46919()
        return CommutativeMatcher46919._instance
