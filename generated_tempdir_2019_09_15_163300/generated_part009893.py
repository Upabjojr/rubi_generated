...
class CommutativeMatcher89873(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89873._instance is None:
            CommutativeMatcher89873._instance = CommutativeMatcher89873()
        return CommutativeMatcher89873._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher105653.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from .generated_part009894 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset