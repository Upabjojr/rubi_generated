...
class CommutativeMatcher42997(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42997._instance is None:
            CommutativeMatcher42997._instance = CommutativeMatcher42997()
        return CommutativeMatcher42997._instance
