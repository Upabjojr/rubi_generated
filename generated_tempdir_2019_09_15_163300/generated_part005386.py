...
class CommutativeMatcher22118(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22118._instance is None:
            CommutativeMatcher22118._instance = CommutativeMatcher22118()
        return CommutativeMatcher22118._instance
