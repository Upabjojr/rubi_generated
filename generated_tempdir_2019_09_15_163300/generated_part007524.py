...
class CommutativeMatcher77602(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77602._instance is None:
            CommutativeMatcher77602._instance = CommutativeMatcher77602()
        return CommutativeMatcher77602._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1:
                ...
                subst2 = Substitution(subst1)
                try:
                    subst2.try_add_variable('i2.1.1.3.1.0', tmp20)
                except ValueError:
                    pass
                else:
                    pass
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher77606.get()
            tmp24 = subjects23
            subjects23 = []
            for s in tmp24:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007525 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset