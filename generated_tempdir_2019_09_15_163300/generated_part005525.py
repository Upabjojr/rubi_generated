...
class CommutativeMatcher31930(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31930._instance is None:
            CommutativeMatcher31930._instance = CommutativeMatcher31930()
        return CommutativeMatcher31930._instance
