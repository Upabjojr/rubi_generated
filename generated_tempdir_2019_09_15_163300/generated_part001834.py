...
class CommutativeMatcher61996(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61996._instance is None:
            CommutativeMatcher61996._instance = CommutativeMatcher61996()
        return CommutativeMatcher61996._instance
