...
class CommutativeMatcher41891(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41891._instance is None:
            CommutativeMatcher41891._instance = CommutativeMatcher41891()
        return CommutativeMatcher41891._instance
