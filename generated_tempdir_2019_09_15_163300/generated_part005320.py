...
class CommutativeMatcher21914(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21914._instance is None:
            CommutativeMatcher21914._instance = CommutativeMatcher21914()
        return CommutativeMatcher21914._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21918.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part005321 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset