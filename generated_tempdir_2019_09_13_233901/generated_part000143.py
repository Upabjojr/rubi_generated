...
class CommutativeMatcher40794(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40794._instance is None:
            CommutativeMatcher40794._instance = CommutativeMatcher40794()
        return CommutativeMatcher40794._instance
