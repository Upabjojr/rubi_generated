...
class CommutativeMatcher124029(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124029._instance is None:
            CommutativeMatcher124029._instance = CommutativeMatcher124029()
        return CommutativeMatcher124029._instance
