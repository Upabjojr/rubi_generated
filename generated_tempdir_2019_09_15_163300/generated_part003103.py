...
class CommutativeMatcher63767(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63767._instance is None:
            CommutativeMatcher63767._instance = CommutativeMatcher63767()
        return CommutativeMatcher63767._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher63771.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part003104 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset