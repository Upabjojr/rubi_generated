...
class CommutativeMatcher129480(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129480._instance is None:
            CommutativeMatcher129480._instance = CommutativeMatcher129480()
        return CommutativeMatcher129480._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129484.get()
            tmp17 = subjects16
            subjects16 = []
            for s in tmp17:
...
from .generated_part004612 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset