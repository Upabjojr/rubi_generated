...
class CommutativeMatcher42882(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42882._instance is None:
            CommutativeMatcher42882._instance = CommutativeMatcher42882()
        return CommutativeMatcher42882._instance
