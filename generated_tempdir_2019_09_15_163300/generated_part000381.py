...
class CommutativeMatcher43020(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43020._instance is None:
            CommutativeMatcher43020._instance = CommutativeMatcher43020()
        return CommutativeMatcher43020._instance
