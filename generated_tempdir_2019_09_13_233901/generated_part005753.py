...
class CommutativeMatcher32483(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32483._instance is None:
            CommutativeMatcher32483._instance = CommutativeMatcher32483()
        return CommutativeMatcher32483._instance
