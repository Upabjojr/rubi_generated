...
class CommutativeMatcher21586(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21586._instance is None:
            CommutativeMatcher21586._instance = CommutativeMatcher21586()
        return CommutativeMatcher21586._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21590.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part004651 import *