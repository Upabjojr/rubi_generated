...
class CommutativeMatcher60200(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60200._instance is None:
            CommutativeMatcher60200._instance = CommutativeMatcher60200()
        return CommutativeMatcher60200._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher60204.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004982 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset