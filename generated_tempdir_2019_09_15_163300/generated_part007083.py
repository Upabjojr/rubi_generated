...
class CommutativeMatcher149811(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149811._instance is None:
            CommutativeMatcher149811._instance = CommutativeMatcher149811()
        return CommutativeMatcher149811._instance
