...
class CommutativeMatcher21246(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21246._instance is None:
            CommutativeMatcher21246._instance = CommutativeMatcher21246()
        return CommutativeMatcher21246._instance
