...
class CommutativeMatcher31584(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31584._instance is None:
            CommutativeMatcher31584._instance = CommutativeMatcher31584()
        return CommutativeMatcher31584._instance
