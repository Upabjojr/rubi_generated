...
class CommutativeMatcher30186(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30186._instance is None:
            CommutativeMatcher30186._instance = CommutativeMatcher30186()
        return CommutativeMatcher30186._instance
