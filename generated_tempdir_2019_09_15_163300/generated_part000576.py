...
class CommutativeMatcher42372(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42372._instance is None:
            CommutativeMatcher42372._instance = CommutativeMatcher42372()
        return CommutativeMatcher42372._instance
