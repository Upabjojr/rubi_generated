...
class CommutativeMatcher14933(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher14933._instance is None:
            CommutativeMatcher14933._instance = CommutativeMatcher14933()
        return CommutativeMatcher14933._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher14938.get()
                tmp10 = subjects9
                subjects9 = []
                for s in tmp10:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher14941.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
                matcher.add_subject(s)
...
from .generated_part004471 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part004472 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset