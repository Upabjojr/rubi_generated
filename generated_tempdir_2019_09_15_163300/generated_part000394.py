...
class CommutativeMatcher43109(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43109._instance is None:
            CommutativeMatcher43109._instance = CommutativeMatcher43109()
        return CommutativeMatcher43109._instance
