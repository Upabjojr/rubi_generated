...
class CommutativeMatcher65555(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65555._instance is None:
            CommutativeMatcher65555._instance = CommutativeMatcher65555()
        return CommutativeMatcher65555._instance
