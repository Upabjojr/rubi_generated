...
class CommutativeMatcher111809(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111809._instance is None:
            CommutativeMatcher111809._instance = CommutativeMatcher111809()
        return CommutativeMatcher111809._instance
