...
class CommutativeMatcher23398(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23398._instance is None:
            CommutativeMatcher23398._instance = CommutativeMatcher23398()
        return CommutativeMatcher23398._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher23404.get()
                    tmp15 = subjects14
                    subjects14 = []
                    for s in tmp15:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher23407.get()
                tmp20 = subjects19
                subjects19 = []
                for s in tmp20:
                    matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher31600.get()
                tmp23 = subjects22
                subjects22 = []
                for s in tmp23:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects25) >= 1 and isinstance(subjects25[0], Mul):
                    ...
                    matcher = CommutativeMatcher23421.get()
                    tmp45 = subjects44
                    subjects44 = []
                    for s in tmp45:
                        matcher.add_subject(s)
            ...
            if len(subjects25) >= 1 and isinstance(subjects25[0], Add):
                ...
                matcher = CommutativeMatcher23426.get()
                tmp63 = subjects62
                subjects62 = []
                for s in tmp63:
                    matcher.add_subject(s)
            ...
            if len(subjects25) >= 1 and isinstance(subjects25[0], Mul):
                ...
                matcher = CommutativeMatcher31626.get()
                tmp82 = subjects81
                subjects81 = []
                for s in tmp82:
                    matcher.add_subject(s)
...
from .generated_part002369 import *
from .generated_part002374 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part002368 import *
from collections import deque
from .generated_part002371 import *
from .generated_part002375 import *
from .generated_part002377 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset