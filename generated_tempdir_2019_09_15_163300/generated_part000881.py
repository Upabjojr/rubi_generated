...
class CommutativeMatcher114666(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher114666._instance is None:
            CommutativeMatcher114666._instance = CommutativeMatcher114666()
        return CommutativeMatcher114666._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher114670.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000882 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset