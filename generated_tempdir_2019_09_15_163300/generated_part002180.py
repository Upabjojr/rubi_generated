...
class CommutativeMatcher70232(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher70232._instance is None:
            CommutativeMatcher70232._instance = CommutativeMatcher70232()
        return CommutativeMatcher70232._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher70236.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from .generated_part002181 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset