...
class CommutativeMatcher149924(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149924._instance is None:
            CommutativeMatcher149924._instance = CommutativeMatcher149924()
        return CommutativeMatcher149924._instance
