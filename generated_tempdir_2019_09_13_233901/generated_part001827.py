...
class CommutativeMatcher61823(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61823._instance is None:
            CommutativeMatcher61823._instance = CommutativeMatcher61823()
        return CommutativeMatcher61823._instance
