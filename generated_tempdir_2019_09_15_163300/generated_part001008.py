...
class CommutativeMatcher150015(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150015._instance is None:
            CommutativeMatcher150015._instance = CommutativeMatcher150015()
        return CommutativeMatcher150015._instance
