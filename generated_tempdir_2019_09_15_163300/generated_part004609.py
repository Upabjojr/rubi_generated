...
class CommutativeMatcher129379(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129379._instance is None:
            CommutativeMatcher129379._instance = CommutativeMatcher129379()
        return CommutativeMatcher129379._instance
