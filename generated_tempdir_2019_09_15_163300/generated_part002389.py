...
class CommutativeMatcher23465(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23465._instance is None:
            CommutativeMatcher23465._instance = CommutativeMatcher23465()
        return CommutativeMatcher23465._instance
