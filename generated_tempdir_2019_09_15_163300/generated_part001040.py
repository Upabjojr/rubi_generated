...
class CommutativeMatcher126851(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126851._instance is None:
            CommutativeMatcher126851._instance = CommutativeMatcher126851()
        return CommutativeMatcher126851._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher126858.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001041 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset