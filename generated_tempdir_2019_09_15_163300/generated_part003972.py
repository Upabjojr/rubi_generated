...
class CommutativeMatcher26425(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26425._instance is None:
            CommutativeMatcher26425._instance = CommutativeMatcher26425()
        return CommutativeMatcher26425._instance
