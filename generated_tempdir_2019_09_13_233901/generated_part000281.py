...
class CommutativeMatcher140783(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140783._instance is None:
            CommutativeMatcher140783._instance = CommutativeMatcher140783()
        return CommutativeMatcher140783._instance
