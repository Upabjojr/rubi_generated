...
class CommutativeMatcher60456(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60456._instance is None:
            CommutativeMatcher60456._instance = CommutativeMatcher60456()
        return CommutativeMatcher60456._instance
