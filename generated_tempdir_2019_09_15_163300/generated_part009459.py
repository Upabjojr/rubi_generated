...
class CommutativeMatcher77496(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77496._instance is None:
            CommutativeMatcher77496._instance = CommutativeMatcher77496()
        return CommutativeMatcher77496._instance
