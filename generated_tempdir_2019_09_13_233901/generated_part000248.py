...
class CommutativeMatcher111543(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111543._instance is None:
            CommutativeMatcher111543._instance = CommutativeMatcher111543()
        return CommutativeMatcher111543._instance
