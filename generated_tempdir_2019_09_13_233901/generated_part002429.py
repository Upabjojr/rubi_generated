...
class CommutativeMatcher23597(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23597._instance is None:
            CommutativeMatcher23597._instance = CommutativeMatcher23597()
        return CommutativeMatcher23597._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher23601.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
