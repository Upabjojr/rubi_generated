...
class CommutativeMatcher21316(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21316._instance is None:
            CommutativeMatcher21316._instance = CommutativeMatcher21316()
        return CommutativeMatcher21316._instance
