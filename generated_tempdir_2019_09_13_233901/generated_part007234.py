...
class CommutativeMatcher25918(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25918._instance is None:
            CommutativeMatcher25918._instance = CommutativeMatcher25918()
        return CommutativeMatcher25918._instance
