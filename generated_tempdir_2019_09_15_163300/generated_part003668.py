...
class CommutativeMatcher78678(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78678._instance is None:
            CommutativeMatcher78678._instance = CommutativeMatcher78678()
        return CommutativeMatcher78678._instance
