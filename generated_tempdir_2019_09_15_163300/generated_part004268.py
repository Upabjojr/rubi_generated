...
class CommutativeMatcher121020(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121020._instance is None:
            CommutativeMatcher121020._instance = CommutativeMatcher121020()
        return CommutativeMatcher121020._instance
