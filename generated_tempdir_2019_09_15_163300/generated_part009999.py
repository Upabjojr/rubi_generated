...
class CommutativeMatcher106916(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106916._instance is None:
            CommutativeMatcher106916._instance = CommutativeMatcher106916()
        return CommutativeMatcher106916._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher106924.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher106929.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher107090.get()
                tmp22 = subjects21
                subjects21 = []
                for s in tmp22:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher107093.get()
            tmp25 = subjects24
            subjects24 = []
            for s in tmp25:
                matcher.add_subject(s)
...
from .generated_part010000 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part010004 import *
from .generated_part010003 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part010001 import *