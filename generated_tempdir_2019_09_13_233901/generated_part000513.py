...
class CommutativeMatcher43473(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43473._instance is None:
            CommutativeMatcher43473._instance = CommutativeMatcher43473()
        return CommutativeMatcher43473._instance
