...
class CommutativeMatcher104344(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104344._instance is None:
            CommutativeMatcher104344._instance = CommutativeMatcher104344()
        return CommutativeMatcher104344._instance
