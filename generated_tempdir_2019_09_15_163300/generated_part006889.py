...
class CommutativeMatcher105056(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105056._instance is None:
            CommutativeMatcher105056._instance = CommutativeMatcher105056()
        return CommutativeMatcher105056._instance
