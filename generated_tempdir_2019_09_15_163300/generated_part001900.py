...
class CommutativeMatcher31185(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31185._instance is None:
            CommutativeMatcher31185._instance = CommutativeMatcher31185()
        return CommutativeMatcher31185._instance
