...
class CommutativeMatcher138469(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138469._instance is None:
            CommutativeMatcher138469._instance = CommutativeMatcher138469()
        return CommutativeMatcher138469._instance
