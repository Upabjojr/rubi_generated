...
class CommutativeMatcher68813(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher68813._instance is None:
            CommutativeMatcher68813._instance = CommutativeMatcher68813()
        return CommutativeMatcher68813._instance
