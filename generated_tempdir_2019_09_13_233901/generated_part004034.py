...
class CommutativeMatcher113056(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113056._instance is None:
            CommutativeMatcher113056._instance = CommutativeMatcher113056()
        return CommutativeMatcher113056._instance
