...
class CommutativeMatcher41820(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41820._instance is None:
            CommutativeMatcher41820._instance = CommutativeMatcher41820()
        return CommutativeMatcher41820._instance
