...
class CommutativeMatcher113006(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113006._instance is None:
            CommutativeMatcher113006._instance = CommutativeMatcher113006()
        return CommutativeMatcher113006._instance
