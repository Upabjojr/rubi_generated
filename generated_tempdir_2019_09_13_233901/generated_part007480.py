...
class CommutativeMatcher49724(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49724._instance is None:
            CommutativeMatcher49724._instance = CommutativeMatcher49724()
        return CommutativeMatcher49724._instance
