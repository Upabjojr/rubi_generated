...
class CommutativeMatcher146493(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146493._instance is None:
            CommutativeMatcher146493._instance = CommutativeMatcher146493()
        return CommutativeMatcher146493._instance
