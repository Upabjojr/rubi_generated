...
class CommutativeMatcher22405(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22405._instance is None:
            CommutativeMatcher22405._instance = CommutativeMatcher22405()
        return CommutativeMatcher22405._instance
