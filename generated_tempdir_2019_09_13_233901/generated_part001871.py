...
class CommutativeMatcher22978(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22978._instance is None:
            CommutativeMatcher22978._instance = CommutativeMatcher22978()
        return CommutativeMatcher22978._instance
