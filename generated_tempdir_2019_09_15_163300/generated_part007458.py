...
class CommutativeMatcher25959(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25959._instance is None:
            CommutativeMatcher25959._instance = CommutativeMatcher25959()
        return CommutativeMatcher25959._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25963.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part007459 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset