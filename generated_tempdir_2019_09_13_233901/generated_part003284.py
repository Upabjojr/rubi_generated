...
class CommutativeMatcher124251(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124251._instance is None:
            CommutativeMatcher124251._instance = CommutativeMatcher124251()
        return CommutativeMatcher124251._instance
