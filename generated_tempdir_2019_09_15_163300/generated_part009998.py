...
class CommutativeMatcher104235(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104235._instance is None:
            CommutativeMatcher104235._instance = CommutativeMatcher104235()
        return CommutativeMatcher104235._instance
