...
class CommutativeMatcher77461(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77461._instance is None:
            CommutativeMatcher77461._instance = CommutativeMatcher77461()
        return CommutativeMatcher77461._instance
    ...
    def get_match_iter(subject):
                ...
                if len(subjects6) >= 1:
                    ...
                    try:
                        ...
                        if len(subjects6) >= 1:
                            ...
                            try:
                                subst3.try_add_variable('i3.1.2.1.2', tmp9)
                            except ValueError:
                                pass
                            else:
                                pass
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher77465.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part009591 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset