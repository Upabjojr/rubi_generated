...
class CommutativeMatcher58612(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58612._instance is None:
            CommutativeMatcher58612._instance = CommutativeMatcher58612()
        return CommutativeMatcher58612._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher58616.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from .generated_part007516 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset