...
class CommutativeMatcher22837(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22837._instance is None:
            CommutativeMatcher22837._instance = CommutativeMatcher22837()
        return CommutativeMatcher22837._instance
