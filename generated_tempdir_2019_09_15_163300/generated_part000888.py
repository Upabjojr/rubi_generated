...
class CommutativeMatcher115257(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher115257._instance is None:
            CommutativeMatcher115257._instance = CommutativeMatcher115257()
        return CommutativeMatcher115257._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher115261.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000889 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset