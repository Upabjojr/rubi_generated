...
class CommutativeMatcher32655(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32655._instance is None:
            CommutativeMatcher32655._instance = CommutativeMatcher32655()
        return CommutativeMatcher32655._instance
