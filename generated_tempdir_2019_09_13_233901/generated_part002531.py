...
class CommutativeMatcher22265(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22265._instance is None:
            CommutativeMatcher22265._instance = CommutativeMatcher22265()
        return CommutativeMatcher22265._instance
