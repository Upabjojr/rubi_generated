...
class CommutativeMatcher121958(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121958._instance is None:
            CommutativeMatcher121958._instance = CommutativeMatcher121958()
        return CommutativeMatcher121958._instance
