...
class CommutativeMatcher21297(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21297._instance is None:
            CommutativeMatcher21297._instance = CommutativeMatcher21297()
        return CommutativeMatcher21297._instance
