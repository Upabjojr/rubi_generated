...
class CommutativeMatcher31699(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31699._instance is None:
            CommutativeMatcher31699._instance = CommutativeMatcher31699()
        return CommutativeMatcher31699._instance
