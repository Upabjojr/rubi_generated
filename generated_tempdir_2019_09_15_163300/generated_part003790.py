...
class CommutativeMatcher64248(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64248._instance is None:
            CommutativeMatcher64248._instance = CommutativeMatcher64248()
        return CommutativeMatcher64248._instance
