...
class CommutativeMatcher64125(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64125._instance is None:
            CommutativeMatcher64125._instance = CommutativeMatcher64125()
        return CommutativeMatcher64125._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher64129.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006163 import *