...
class CommutativeMatcher79159(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79159._instance is None:
            CommutativeMatcher79159._instance = CommutativeMatcher79159()
        return CommutativeMatcher79159._instance
