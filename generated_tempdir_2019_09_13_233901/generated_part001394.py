                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Pow):
                    ...
                    if len(subjects12) >= 1:
                        ...
                        try:
                            ...
                            if len(subjects12) >= 1 and subjects12[0] == -1:
                            ...
                            if len(subjects187) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects187) == 0:
                                        pass
                                        # State 83686
                                        if len(subjects185) >= 1 and subjects185[0] == -1:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                    ...
                    if len(subjects356) >= 1:
                        ...
                        try:
                            ...
                            pass
                            # State 10917
                            if len(subjects356) >= 1 and subjects356[0] == -1:
                            ...
                            if len(subjects443) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects443) == 0:
                                        pass
                                        # State 83661
                                        if len(subjects441) >= 1 and subjects441[0] == -1:
                            ...
                            if len(subjects491) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects491) == 0:
                                        pass
                                        # State 83776
                                        if len(subjects489) >= 1 and subjects489[0] == -1:
