...
class CommutativeMatcher42391(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42391._instance is None:
            CommutativeMatcher42391._instance = CommutativeMatcher42391()
        return CommutativeMatcher42391._instance
