...
class CommutativeMatcher136318(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136318._instance is None:
            CommutativeMatcher136318._instance = CommutativeMatcher136318()
        return CommutativeMatcher136318._instance
