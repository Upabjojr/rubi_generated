...
class CommutativeMatcher69681(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69681._instance is None:
            CommutativeMatcher69681._instance = CommutativeMatcher69681()
        return CommutativeMatcher69681._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher69685.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002010 import *
from multiset import Multiset