...
class CommutativeMatcher23550(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23550._instance is None:
            CommutativeMatcher23550._instance = CommutativeMatcher23550()
        return CommutativeMatcher23550._instance
