...
class CommutativeMatcher33114(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33114._instance is None:
            CommutativeMatcher33114._instance = CommutativeMatcher33114()
        return CommutativeMatcher33114._instance
