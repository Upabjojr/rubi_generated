...
class CommutativeMatcher106289(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106289._instance is None:
            CommutativeMatcher106289._instance = CommutativeMatcher106289()
        return CommutativeMatcher106289._instance
