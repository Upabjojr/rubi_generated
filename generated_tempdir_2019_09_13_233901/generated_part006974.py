...
class CommutativeMatcher117173(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117173._instance is None:
            CommutativeMatcher117173._instance = CommutativeMatcher117173()
        return CommutativeMatcher117173._instance
