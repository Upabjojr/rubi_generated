...
class CommutativeMatcher42923(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42923._instance is None:
            CommutativeMatcher42923._instance = CommutativeMatcher42923()
        return CommutativeMatcher42923._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42930.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000367 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset