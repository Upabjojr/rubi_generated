...
class CommutativeMatcher43151(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43151._instance is None:
            CommutativeMatcher43151._instance = CommutativeMatcher43151()
        return CommutativeMatcher43151._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43158.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000466 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset