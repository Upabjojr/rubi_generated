...
class CommutativeMatcher13203(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13203._instance is None:
            CommutativeMatcher13203._instance = CommutativeMatcher13203()
        return CommutativeMatcher13203._instance
