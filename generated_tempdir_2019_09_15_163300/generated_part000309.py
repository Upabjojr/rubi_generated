...
class CommutativeMatcher149459(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149459._instance is None:
            CommutativeMatcher149459._instance = CommutativeMatcher149459()
        return CommutativeMatcher149459._instance
