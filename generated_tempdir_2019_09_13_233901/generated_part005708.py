...
class CommutativeMatcher93338(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93338._instance is None:
            CommutativeMatcher93338._instance = CommutativeMatcher93338()
        return CommutativeMatcher93338._instance
