...
class CommutativeMatcher41389(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41389._instance is None:
            CommutativeMatcher41389._instance = CommutativeMatcher41389()
        return CommutativeMatcher41389._instance
