...
class CommutativeMatcher41153(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41153._instance is None:
            CommutativeMatcher41153._instance = CommutativeMatcher41153()
        return CommutativeMatcher41153._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41160.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part000185 import *
from multiset import Multiset