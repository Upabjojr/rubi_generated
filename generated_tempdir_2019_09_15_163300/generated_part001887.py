...
class CommutativeMatcher31128(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31128._instance is None:
            CommutativeMatcher31128._instance = CommutativeMatcher31128()
        return CommutativeMatcher31128._instance
