...
class CommutativeMatcher134857(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134857._instance is None:
            CommutativeMatcher134857._instance = CommutativeMatcher134857()
        return CommutativeMatcher134857._instance
