...
class CommutativeMatcher23295(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23295._instance is None:
            CommutativeMatcher23295._instance = CommutativeMatcher23295()
        return CommutativeMatcher23295._instance
