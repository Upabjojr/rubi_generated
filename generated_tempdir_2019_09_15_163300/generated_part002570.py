...
class CommutativeMatcher22396(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22396._instance is None:
            CommutativeMatcher22396._instance = CommutativeMatcher22396()
        return CommutativeMatcher22396._instance
