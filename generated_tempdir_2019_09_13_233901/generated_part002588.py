...
class CommutativeMatcher30384(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30384._instance is None:
            CommutativeMatcher30384._instance = CommutativeMatcher30384()
        return CommutativeMatcher30384._instance
