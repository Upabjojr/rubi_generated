...
class CommutativeMatcher93292(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93292._instance is None:
            CommutativeMatcher93292._instance = CommutativeMatcher93292()
        return CommutativeMatcher93292._instance
