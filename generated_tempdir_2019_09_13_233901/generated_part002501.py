...
class CommutativeMatcher126432(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126432._instance is None:
            CommutativeMatcher126432._instance = CommutativeMatcher126432()
        return CommutativeMatcher126432._instance
