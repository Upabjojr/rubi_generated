...
class CommutativeMatcher31271(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31271._instance is None:
            CommutativeMatcher31271._instance = CommutativeMatcher31271()
        return CommutativeMatcher31271._instance
