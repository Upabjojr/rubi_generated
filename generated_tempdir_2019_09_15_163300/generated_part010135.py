            ...
            if len(subjects21) >= 1 and isinstance(subjects21[0], Add):
                ...
                for pattern_index, subst1 in matcher.match(tmp54, subst0):
                    ...
                    if pattern_index == 0:
                        pass
                        # State 53595
                        if len(subjects21) >= 1 and subjects21[0] == Rational(1, 2):
                    ...
                    if len(subjects21) >= 1 and isinstance(subjects21[0], Pow):
                        ...
                        if len(subjects60) >= 1:
                            ...
                            try:
                                ...
                                pass
                                # State 53629
                                if len(subjects60) >= 1 and subjects60[0] == Integer(2):
...
from .generated_part010143 import *
from .generated_part010139 import *
from .generated_part010137 import *
from .generated_part010152 import *
from .generated_part010146 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part010136 import *
from .generated_part010150 import *
from collections import deque
from .generated_part010144 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset