...
class CommutativeMatcher23156(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23156._instance is None:
            CommutativeMatcher23156._instance = CommutativeMatcher23156()
        return CommutativeMatcher23156._instance
