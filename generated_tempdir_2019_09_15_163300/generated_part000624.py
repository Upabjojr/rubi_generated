...
class CommutativeMatcher42670(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42670._instance is None:
            CommutativeMatcher42670._instance = CommutativeMatcher42670()
        return CommutativeMatcher42670._instance
