...
class CommutativeMatcher111358(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111358._instance is None:
            CommutativeMatcher111358._instance = CommutativeMatcher111358()
        return CommutativeMatcher111358._instance
