...
class CommutativeMatcher111480(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111480._instance is None:
            CommutativeMatcher111480._instance = CommutativeMatcher111480()
        return CommutativeMatcher111480._instance
