...
class CommutativeMatcher32083(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32083._instance is None:
            CommutativeMatcher32083._instance = CommutativeMatcher32083()
        return CommutativeMatcher32083._instance
