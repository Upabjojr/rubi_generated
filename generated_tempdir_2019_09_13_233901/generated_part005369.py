...
class CommutativeMatcher22060(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22060._instance is None:
            CommutativeMatcher22060._instance = CommutativeMatcher22060()
        return CommutativeMatcher22060._instance
