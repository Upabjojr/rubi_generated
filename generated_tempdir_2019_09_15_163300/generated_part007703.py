...
class CommutativeMatcher71998(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher71998._instance is None:
            CommutativeMatcher71998._instance = CommutativeMatcher71998()
        return CommutativeMatcher71998._instance
