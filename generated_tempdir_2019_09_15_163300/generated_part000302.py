...
class CommutativeMatcher146090(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146090._instance is None:
            CommutativeMatcher146090._instance = CommutativeMatcher146090()
        return CommutativeMatcher146090._instance
