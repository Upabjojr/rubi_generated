...
class CommutativeMatcher93106(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93106._instance is None:
            CommutativeMatcher93106._instance = CommutativeMatcher93106()
        return CommutativeMatcher93106._instance
