...
class CommutativeMatcher46881(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46881._instance is None:
            CommutativeMatcher46881._instance = CommutativeMatcher46881()
        return CommutativeMatcher46881._instance
