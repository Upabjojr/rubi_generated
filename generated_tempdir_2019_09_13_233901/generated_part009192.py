...
class CommutativeMatcher140135(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140135._instance is None:
            CommutativeMatcher140135._instance = CommutativeMatcher140135()
        return CommutativeMatcher140135._instance
