...
class CommutativeMatcher92749(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher92749._instance is None:
            CommutativeMatcher92749._instance = CommutativeMatcher92749()
        return CommutativeMatcher92749._instance
