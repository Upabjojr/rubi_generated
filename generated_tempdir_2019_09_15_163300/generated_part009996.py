...
class CommutativeMatcher104215(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104215._instance is None:
            CommutativeMatcher104215._instance = CommutativeMatcher104215()
        return CommutativeMatcher104215._instance
