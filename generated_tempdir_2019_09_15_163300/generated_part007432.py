...
class CommutativeMatcher49652(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49652._instance is None:
            CommutativeMatcher49652._instance = CommutativeMatcher49652()
        return CommutativeMatcher49652._instance
