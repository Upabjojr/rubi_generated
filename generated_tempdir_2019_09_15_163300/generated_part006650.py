...
class CommutativeMatcher106475(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106475._instance is None:
            CommutativeMatcher106475._instance = CommutativeMatcher106475()
        return CommutativeMatcher106475._instance
