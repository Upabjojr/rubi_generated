...
class CommutativeMatcher21516(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21516._instance is None:
            CommutativeMatcher21516._instance = CommutativeMatcher21516()
        return CommutativeMatcher21516._instance
