...
class CommutativeMatcher138414(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138414._instance is None:
            CommutativeMatcher138414._instance = CommutativeMatcher138414()
        return CommutativeMatcher138414._instance
