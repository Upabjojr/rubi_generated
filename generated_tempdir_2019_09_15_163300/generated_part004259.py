...
class CommutativeMatcher120558(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120558._instance is None:
            CommutativeMatcher120558._instance = CommutativeMatcher120558()
        return CommutativeMatcher120558._instance
