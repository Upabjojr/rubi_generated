...
class CommutativeMatcher59943(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59943._instance is None:
            CommutativeMatcher59943._instance = CommutativeMatcher59943()
        return CommutativeMatcher59943._instance
