...
class CommutativeMatcher57052(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher57052._instance is None:
            CommutativeMatcher57052._instance = CommutativeMatcher57052()
        return CommutativeMatcher57052._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher57056.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from .generated_part003698 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset