...
class CommutativeMatcher13237(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13237._instance is None:
            CommutativeMatcher13237._instance = CommutativeMatcher13237()
        return CommutativeMatcher13237._instance
