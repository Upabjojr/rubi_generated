...
class CommutativeMatcher42752(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42752._instance is None:
            CommutativeMatcher42752._instance = CommutativeMatcher42752()
        return CommutativeMatcher42752._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42759.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000637 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset