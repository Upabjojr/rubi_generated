...
class CommutativeMatcher40997(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40997._instance is None:
            CommutativeMatcher40997._instance = CommutativeMatcher40997()
        return CommutativeMatcher40997._instance
