...
class CommutativeMatcher46962(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46962._instance is None:
            CommutativeMatcher46962._instance = CommutativeMatcher46962()
        return CommutativeMatcher46962._instance
