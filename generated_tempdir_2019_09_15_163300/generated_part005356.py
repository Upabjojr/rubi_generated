...
class CommutativeMatcher22022(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22022._instance is None:
            CommutativeMatcher22022._instance = CommutativeMatcher22022()
        return CommutativeMatcher22022._instance
