...
class CommutativeMatcher104978(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104978._instance is None:
            CommutativeMatcher104978._instance = CommutativeMatcher104978()
        return CommutativeMatcher104978._instance
