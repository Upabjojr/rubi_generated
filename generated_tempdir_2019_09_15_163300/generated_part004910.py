...
class CommutativeMatcher67456(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67456._instance is None:
            CommutativeMatcher67456._instance = CommutativeMatcher67456()
        return CommutativeMatcher67456._instance
