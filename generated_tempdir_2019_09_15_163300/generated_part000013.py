...
class CommutativeMatcher41338(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41338._instance is None:
            CommutativeMatcher41338._instance = CommutativeMatcher41338()
        return CommutativeMatcher41338._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41345.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
