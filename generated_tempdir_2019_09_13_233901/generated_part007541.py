...
class CommutativeMatcher142665(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142665._instance is None:
            CommutativeMatcher142665._instance = CommutativeMatcher142665()
        return CommutativeMatcher142665._instance
