...
class CommutativeMatcher41456(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41456._instance is None:
            CommutativeMatcher41456._instance = CommutativeMatcher41456()
        return CommutativeMatcher41456._instance
