...
class CommutativeMatcher71982(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher71982._instance is None:
            CommutativeMatcher71982._instance = CommutativeMatcher71982()
        return CommutativeMatcher71982._instance
