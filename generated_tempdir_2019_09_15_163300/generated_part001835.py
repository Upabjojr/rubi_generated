...
class CommutativeMatcher78399(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78399._instance is None:
            CommutativeMatcher78399._instance = CommutativeMatcher78399()
        return CommutativeMatcher78399._instance
