...
class CommutativeMatcher142707(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142707._instance is None:
            CommutativeMatcher142707._instance = CommutativeMatcher142707()
        return CommutativeMatcher142707._instance
