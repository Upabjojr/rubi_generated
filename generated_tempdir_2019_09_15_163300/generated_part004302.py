...
class CommutativeMatcher134444(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134444._instance is None:
            CommutativeMatcher134444._instance = CommutativeMatcher134444()
        return CommutativeMatcher134444._instance
