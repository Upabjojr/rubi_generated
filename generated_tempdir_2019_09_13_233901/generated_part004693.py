...
class CommutativeMatcher21704(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21704._instance is None:
            CommutativeMatcher21704._instance = CommutativeMatcher21704()
        return CommutativeMatcher21704._instance
