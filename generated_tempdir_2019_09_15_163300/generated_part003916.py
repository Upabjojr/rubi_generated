...
class CommutativeMatcher108740(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108740._instance is None:
            CommutativeMatcher108740._instance = CommutativeMatcher108740()
        return CommutativeMatcher108740._instance
