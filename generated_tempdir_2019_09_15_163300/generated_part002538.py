...
class CommutativeMatcher22292(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22292._instance is None:
            CommutativeMatcher22292._instance = CommutativeMatcher22292()
        return CommutativeMatcher22292._instance
