...
class CommutativeMatcher104692(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104692._instance is None:
            CommutativeMatcher104692._instance = CommutativeMatcher104692()
        return CommutativeMatcher104692._instance
