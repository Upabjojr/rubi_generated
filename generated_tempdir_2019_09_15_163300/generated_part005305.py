...
class CommutativeMatcher21868(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21868._instance is None:
            CommutativeMatcher21868._instance = CommutativeMatcher21868()
        return CommutativeMatcher21868._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21872.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from .generated_part005306 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset