...
class CommutativeMatcher145700(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145700._instance is None:
            CommutativeMatcher145700._instance = CommutativeMatcher145700()
        return CommutativeMatcher145700._instance
