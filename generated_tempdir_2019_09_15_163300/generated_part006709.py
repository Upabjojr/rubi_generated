...
class CommutativeMatcher47736(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher47736._instance is None:
            CommutativeMatcher47736._instance = CommutativeMatcher47736()
        return CommutativeMatcher47736._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher47740.get()
            tmp11 = subjects10
            subjects10 = []
            for s in tmp11:
...
from .generated_part006710 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset