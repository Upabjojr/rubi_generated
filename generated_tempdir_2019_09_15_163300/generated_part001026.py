...
class CommutativeMatcher13124(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13124._instance is None:
            CommutativeMatcher13124._instance = CommutativeMatcher13124()
        return CommutativeMatcher13124._instance
