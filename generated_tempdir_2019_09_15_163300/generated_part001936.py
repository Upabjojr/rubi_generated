...
class CommutativeMatcher23194(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23194._instance is None:
            CommutativeMatcher23194._instance = CommutativeMatcher23194()
        return CommutativeMatcher23194._instance
