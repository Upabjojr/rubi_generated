...
class CommutativeMatcher20776(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20776._instance is None:
            CommutativeMatcher20776._instance = CommutativeMatcher20776()
        return CommutativeMatcher20776._instance
