...
class CommutativeMatcher13349(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13349._instance is None:
            CommutativeMatcher13349._instance = CommutativeMatcher13349()
        return CommutativeMatcher13349._instance
