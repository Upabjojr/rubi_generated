...
class CommutativeMatcher21328(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21328._instance is None:
            CommutativeMatcher21328._instance = CommutativeMatcher21328()
        return CommutativeMatcher21328._instance
