...
class CommutativeMatcher21354(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21354._instance is None:
            CommutativeMatcher21354._instance = CommutativeMatcher21354()
        return CommutativeMatcher21354._instance
