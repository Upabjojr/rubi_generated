...
class CommutativeMatcher25408(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25408._instance is None:
            CommutativeMatcher25408._instance = CommutativeMatcher25408()
        return CommutativeMatcher25408._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25412.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part007488 import *
from multiset import Multiset