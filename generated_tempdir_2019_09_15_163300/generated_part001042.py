...
class CommutativeMatcher129616(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129616._instance is None:
            CommutativeMatcher129616._instance = CommutativeMatcher129616()
        return CommutativeMatcher129616._instance
