...
class CommutativeMatcher25077(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25077._instance is None:
            CommutativeMatcher25077._instance = CommutativeMatcher25077()
        return CommutativeMatcher25077._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25081.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part007266 import *