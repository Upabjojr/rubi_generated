...
class CommutativeMatcher32710(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32710._instance is None:
            CommutativeMatcher32710._instance = CommutativeMatcher32710()
        return CommutativeMatcher32710._instance
