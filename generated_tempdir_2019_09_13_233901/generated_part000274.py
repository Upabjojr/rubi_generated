...
class CommutativeMatcher120725(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120725._instance is None:
            CommutativeMatcher120725._instance = CommutativeMatcher120725()
        return CommutativeMatcher120725._instance
