...
class CommutativeMatcher43313(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43313._instance is None:
            CommutativeMatcher43313._instance = CommutativeMatcher43313()
        return CommutativeMatcher43313._instance
