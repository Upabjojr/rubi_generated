...
class CommutativeMatcher41775(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41775._instance is None:
            CommutativeMatcher41775._instance = CommutativeMatcher41775()
        return CommutativeMatcher41775._instance
