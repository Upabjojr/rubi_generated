...
class CommutativeMatcher140048(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140048._instance is None:
            CommutativeMatcher140048._instance = CommutativeMatcher140048()
        return CommutativeMatcher140048._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher140052.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part009346 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset