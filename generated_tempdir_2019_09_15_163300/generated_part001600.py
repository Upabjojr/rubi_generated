...
class CommutativeMatcher106852(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106852._instance is None:
            CommutativeMatcher106852._instance = CommutativeMatcher106852()
        return CommutativeMatcher106852._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher106860.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher106865.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher107072.get()
                tmp22 = subjects21
                subjects21 = []
                for s in tmp22:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher107075.get()
            tmp25 = subjects24
            subjects24 = []
            for s in tmp25:
                matcher.add_subject(s)
...
from .generated_part001601 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001602 import *
from .generated_part001605 import *
from collections import deque
from .generated_part001604 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset