...
class CommutativeMatcher141405(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141405._instance is None:
            CommutativeMatcher141405._instance = CommutativeMatcher141405()
        return CommutativeMatcher141405._instance
