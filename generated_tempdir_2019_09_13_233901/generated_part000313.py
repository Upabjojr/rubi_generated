...
class CommutativeMatcher149512(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149512._instance is None:
            CommutativeMatcher149512._instance = CommutativeMatcher149512()
        return CommutativeMatcher149512._instance
