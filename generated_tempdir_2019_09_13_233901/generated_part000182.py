...
class CommutativeMatcher41137(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41137._instance is None:
            CommutativeMatcher41137._instance = CommutativeMatcher41137()
        return CommutativeMatcher41137._instance
