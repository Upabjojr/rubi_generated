...
class CommutativeMatcher40954(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40954._instance is None:
            CommutativeMatcher40954._instance = CommutativeMatcher40954()
        return CommutativeMatcher40954._instance
