...
class CommutativeMatcher13400(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13400._instance is None:
            CommutativeMatcher13400._instance = CommutativeMatcher13400()
        return CommutativeMatcher13400._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13407.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part009205 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset