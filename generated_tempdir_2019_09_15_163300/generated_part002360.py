...
class CommutativeMatcher31555(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31555._instance is None:
            CommutativeMatcher31555._instance = CommutativeMatcher31555()
        return CommutativeMatcher31555._instance
