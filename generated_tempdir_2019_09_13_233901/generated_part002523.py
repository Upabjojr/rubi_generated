...
class CommutativeMatcher22239(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22239._instance is None:
            CommutativeMatcher22239._instance = CommutativeMatcher22239()
        return CommutativeMatcher22239._instance
