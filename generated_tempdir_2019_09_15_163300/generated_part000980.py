...
class CommutativeMatcher141328(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141328._instance is None:
            CommutativeMatcher141328._instance = CommutativeMatcher141328()
        return CommutativeMatcher141328._instance
