...
class CommutativeMatcher21978(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21978._instance is None:
            CommutativeMatcher21978._instance = CommutativeMatcher21978()
        return CommutativeMatcher21978._instance
