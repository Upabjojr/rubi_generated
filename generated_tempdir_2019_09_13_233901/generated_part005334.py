...
class CommutativeMatcher21968(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21968._instance is None:
            CommutativeMatcher21968._instance = CommutativeMatcher21968()
        return CommutativeMatcher21968._instance
