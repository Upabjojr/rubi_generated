...
class CommutativeMatcher41801(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41801._instance is None:
            CommutativeMatcher41801._instance = CommutativeMatcher41801()
        return CommutativeMatcher41801._instance
