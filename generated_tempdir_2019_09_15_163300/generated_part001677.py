...
class CommutativeMatcher106142(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106142._instance is None:
            CommutativeMatcher106142._instance = CommutativeMatcher106142()
        return CommutativeMatcher106142._instance
