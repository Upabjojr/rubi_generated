...
class CommutativeMatcher58440(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58440._instance is None:
            CommutativeMatcher58440._instance = CommutativeMatcher58440()
        return CommutativeMatcher58440._instance
