...
class CommutativeMatcher122479(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122479._instance is None:
            CommutativeMatcher122479._instance = CommutativeMatcher122479()
        return CommutativeMatcher122479._instance
