...
class CommutativeMatcher30760(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30760._instance is None:
            CommutativeMatcher30760._instance = CommutativeMatcher30760()
        return CommutativeMatcher30760._instance
