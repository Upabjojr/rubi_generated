...
class CommutativeMatcher33398(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33398._instance is None:
            CommutativeMatcher33398._instance = CommutativeMatcher33398()
        return CommutativeMatcher33398._instance
