...
class CommutativeMatcher120306(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120306._instance is None:
            CommutativeMatcher120306._instance = CommutativeMatcher120306()
        return CommutativeMatcher120306._instance
