...
class CommutativeMatcher32627(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32627._instance is None:
            CommutativeMatcher32627._instance = CommutativeMatcher32627()
        return CommutativeMatcher32627._instance
