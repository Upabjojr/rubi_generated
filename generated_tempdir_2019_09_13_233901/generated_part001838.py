...
class CommutativeMatcher78409(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78409._instance is None:
            CommutativeMatcher78409._instance = CommutativeMatcher78409()
        return CommutativeMatcher78409._instance
