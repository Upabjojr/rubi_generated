...
class CommutativeMatcher30497(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30497._instance is None:
            CommutativeMatcher30497._instance = CommutativeMatcher30497()
        return CommutativeMatcher30497._instance
