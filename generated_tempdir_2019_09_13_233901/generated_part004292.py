...
class CommutativeMatcher134402(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134402._instance is None:
            CommutativeMatcher134402._instance = CommutativeMatcher134402()
        return CommutativeMatcher134402._instance
