...
class CommutativeMatcher61986(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61986._instance is None:
            CommutativeMatcher61986._instance = CommutativeMatcher61986()
        return CommutativeMatcher61986._instance
