...
class CommutativeMatcher23065(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23065._instance is None:
            CommutativeMatcher23065._instance = CommutativeMatcher23065()
        return CommutativeMatcher23065._instance
