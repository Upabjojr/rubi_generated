...
class CommutativeMatcher53586(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53586._instance is None:
            CommutativeMatcher53586._instance = CommutativeMatcher53586()
        return CommutativeMatcher53586._instance
