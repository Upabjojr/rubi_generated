...
class CommutativeMatcher23147(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23147._instance is None:
            CommutativeMatcher23147._instance = CommutativeMatcher23147()
        return CommutativeMatcher23147._instance
