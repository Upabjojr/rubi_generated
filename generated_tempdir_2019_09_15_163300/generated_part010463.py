...
class CommutativeMatcher133772(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133772._instance is None:
            CommutativeMatcher133772._instance = CommutativeMatcher133772()
        return CommutativeMatcher133772._instance
