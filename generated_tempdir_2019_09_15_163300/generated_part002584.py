...
class CommutativeMatcher22439(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22439._instance is None:
            CommutativeMatcher22439._instance = CommutativeMatcher22439()
        return CommutativeMatcher22439._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22443.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part002585 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset