        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects2) >= 1:
                ...
                try:
                    ...
                    if len(subjects2) >= 1 and subjects2[0] == 8:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Pow):
                    ...
                    if len(subjects35) >= 1:
                        ...
                        try:
                            ...
                            if len(subjects35) >= 1 and subjects35[0] == -1:
                            ...
                            if len(subjects295) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects295) == 0:
                                        pass
                                        # State 83894
                                        if len(subjects293) >= 1 and subjects293[0] == -1:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                    ...
                    if len(subjects464) >= 1:
                        ...
                        try:
                            ...
                            pass
                            # State 10965
                            if len(subjects464) >= 1 and subjects464[0] == -1:
                            ...
                            if len(subjects557) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects557) == 0:
                                        pass
                                        # State 83869
                                        if len(subjects555) >= 1 and subjects555[0] == -1:
                            ...
                            if len(subjects605) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects605) == 0:
                                        pass
                                        # State 83984
                                        if len(subjects603) >= 1 and subjects603[0] == -1:
