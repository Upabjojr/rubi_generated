...
class CommutativeMatcher126688(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126688._instance is None:
            CommutativeMatcher126688._instance = CommutativeMatcher126688()
        return CommutativeMatcher126688._instance
