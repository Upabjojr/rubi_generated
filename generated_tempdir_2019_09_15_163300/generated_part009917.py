...
class CommutativeMatcher135108(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135108._instance is None:
            CommutativeMatcher135108._instance = CommutativeMatcher135108()
        return CommutativeMatcher135108._instance
