...
class CommutativeMatcher32243(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32243._instance is None:
            CommutativeMatcher32243._instance = CommutativeMatcher32243()
        return CommutativeMatcher32243._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher32252.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part005605 import *
from multiset import Multiset