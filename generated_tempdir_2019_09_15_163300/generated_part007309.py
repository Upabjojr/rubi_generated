...
class CommutativeMatcher142636(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142636._instance is None:
            CommutativeMatcher142636._instance = CommutativeMatcher142636()
        return CommutativeMatcher142636._instance
