...
class CommutativeMatcher23118(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23118._instance is None:
            CommutativeMatcher23118._instance = CommutativeMatcher23118()
        return CommutativeMatcher23118._instance
