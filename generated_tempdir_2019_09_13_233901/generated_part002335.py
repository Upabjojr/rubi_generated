...
class CommutativeMatcher23285(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23285._instance is None:
            CommutativeMatcher23285._instance = CommutativeMatcher23285()
        return CommutativeMatcher23285._instance
