...
class CommutativeMatcher61857(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61857._instance is None:
            CommutativeMatcher61857._instance = CommutativeMatcher61857()
        return CommutativeMatcher61857._instance
