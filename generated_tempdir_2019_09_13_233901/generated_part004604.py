...
class CommutativeMatcher126093(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126093._instance is None:
            CommutativeMatcher126093._instance = CommutativeMatcher126093()
        return CommutativeMatcher126093._instance
