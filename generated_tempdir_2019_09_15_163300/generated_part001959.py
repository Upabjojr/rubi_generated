...
class CommutativeMatcher58317(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58317._instance is None:
            CommutativeMatcher58317._instance = CommutativeMatcher58317()
        return CommutativeMatcher58317._instance
