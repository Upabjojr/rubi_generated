...
class CommutativeMatcher22552(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22552._instance is None:
            CommutativeMatcher22552._instance = CommutativeMatcher22552()
        return CommutativeMatcher22552._instance
