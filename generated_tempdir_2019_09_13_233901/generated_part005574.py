...
class CommutativeMatcher20939(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20939._instance is None:
            CommutativeMatcher20939._instance = CommutativeMatcher20939()
        return CommutativeMatcher20939._instance
