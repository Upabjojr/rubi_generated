...
class CommutativeMatcher146113(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146113._instance is None:
            CommutativeMatcher146113._instance = CommutativeMatcher146113()
        return CommutativeMatcher146113._instance
