...
class CommutativeMatcher145977(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145977._instance is None:
            CommutativeMatcher145977._instance = CommutativeMatcher145977()
        return CommutativeMatcher145977._instance
