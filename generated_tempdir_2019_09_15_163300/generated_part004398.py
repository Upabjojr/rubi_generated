...
class CommutativeMatcher141676(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141676._instance is None:
            CommutativeMatcher141676._instance = CommutativeMatcher141676()
        return CommutativeMatcher141676._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher141684.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from .generated_part004399 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset