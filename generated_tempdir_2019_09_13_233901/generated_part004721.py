...
class CommutativeMatcher21793(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21793._instance is None:
            CommutativeMatcher21793._instance = CommutativeMatcher21793()
        return CommutativeMatcher21793._instance
