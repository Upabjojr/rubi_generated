...
class CommutativeMatcher106429(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106429._instance is None:
            CommutativeMatcher106429._instance = CommutativeMatcher106429()
        return CommutativeMatcher106429._instance
