...
class CommutativeMatcher23048(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23048._instance is None:
            CommutativeMatcher23048._instance = CommutativeMatcher23048()
        return CommutativeMatcher23048._instance
