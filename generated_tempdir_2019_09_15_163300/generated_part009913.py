...
class CommutativeMatcher134790(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134790._instance is None:
            CommutativeMatcher134790._instance = CommutativeMatcher134790()
        return CommutativeMatcher134790._instance
