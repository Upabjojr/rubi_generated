...
class CommutativeMatcher133839(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133839._instance is None:
            CommutativeMatcher133839._instance = CommutativeMatcher133839()
        return CommutativeMatcher133839._instance
