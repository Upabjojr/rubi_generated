...
class CommutativeMatcher104526(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104526._instance is None:
            CommutativeMatcher104526._instance = CommutativeMatcher104526()
        return CommutativeMatcher104526._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
                    ...
                    if len(subjects2) >= 1:
                        ...
                        try:
                            ...
                            if len(subjects2) == 0:
                                ...
                                if len(subjects) == 0:
                                    pass
                                    # 0: log(c*x**n) /; (cons_f2) and (cons_f3) and (cons_f8) and (cons_f4) and (cons_f1711)
                                    yield 0, subst3
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher104538.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001609 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset