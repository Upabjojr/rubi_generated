...
class CommutativeMatcher40752(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40752._instance is None:
            CommutativeMatcher40752._instance = CommutativeMatcher40752()
        return CommutativeMatcher40752._instance
