...
class CommutativeMatcher31410(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31410._instance is None:
            CommutativeMatcher31410._instance = CommutativeMatcher31410()
        return CommutativeMatcher31410._instance
