...
class CommutativeMatcher21020(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21020._instance is None:
            CommutativeMatcher21020._instance = CommutativeMatcher21020()
        return CommutativeMatcher21020._instance
