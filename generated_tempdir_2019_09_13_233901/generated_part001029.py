...
class CommutativeMatcher13147(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13147._instance is None:
            CommutativeMatcher13147._instance = CommutativeMatcher13147()
        return CommutativeMatcher13147._instance
