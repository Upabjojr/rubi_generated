...
class CommutativeMatcher22929(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22929._instance is None:
            CommutativeMatcher22929._instance = CommutativeMatcher22929()
        return CommutativeMatcher22929._instance
