...
class CommutativeMatcher30869(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30869._instance is None:
            CommutativeMatcher30869._instance = CommutativeMatcher30869()
        return CommutativeMatcher30869._instance
