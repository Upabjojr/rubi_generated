...
class CommutativeMatcher43342(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43342._instance is None:
            CommutativeMatcher43342._instance = CommutativeMatcher43342()
        return CommutativeMatcher43342._instance
