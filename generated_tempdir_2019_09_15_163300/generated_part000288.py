...
class CommutativeMatcher141214(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141214._instance is None:
            CommutativeMatcher141214._instance = CommutativeMatcher141214()
        return CommutativeMatcher141214._instance
