...
class CommutativeMatcher33140(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33140._instance is None:
            CommutativeMatcher33140._instance = CommutativeMatcher33140()
        return CommutativeMatcher33140._instance
