...
class CommutativeMatcher121857(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121857._instance is None:
            CommutativeMatcher121857._instance = CommutativeMatcher121857()
        return CommutativeMatcher121857._instance
