...
class CommutativeMatcher39984(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher39984._instance is None:
            CommutativeMatcher39984._instance = CommutativeMatcher39984()
        return CommutativeMatcher39984._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher39993.get()
                    tmp12 = subjects11
                    subjects11 = []
                    for s in tmp12:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher40000.get()
                tmp15 = subjects14
                subjects14 = []
                for s in tmp15:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects17) >= 1 and isinstance(subjects17[0], Mul):
                    ...
                    matcher = CommutativeMatcher40024.get()
                    tmp31 = subjects30
                    subjects30 = []
                    for s in tmp31:
                        matcher.add_subject(s)
            ...
            if len(subjects17) >= 1 and isinstance(subjects17[0], Add):
                ...
                matcher = CommutativeMatcher40033.get()
                tmp38 = subjects37
                subjects37 = []
                for s in tmp38:
                    matcher.add_subject(s)
...
from .generated_part004974 import *
from .generated_part004973 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004970 import *
from .generated_part004971 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset