...
class CommutativeMatcher33086(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33086._instance is None:
            CommutativeMatcher33086._instance = CommutativeMatcher33086()
        return CommutativeMatcher33086._instance
