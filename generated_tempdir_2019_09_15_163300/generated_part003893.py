...
class CommutativeMatcher26402(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26402._instance is None:
            CommutativeMatcher26402._instance = CommutativeMatcher26402()
        return CommutativeMatcher26402._instance
