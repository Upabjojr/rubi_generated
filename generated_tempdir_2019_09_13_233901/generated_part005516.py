...
class CommutativeMatcher20733(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20733._instance is None:
            CommutativeMatcher20733._instance = CommutativeMatcher20733()
        return CommutativeMatcher20733._instance
