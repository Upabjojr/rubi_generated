...
class CommutativeMatcher22488(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22488._instance is None:
            CommutativeMatcher22488._instance = CommutativeMatcher22488()
        return CommutativeMatcher22488._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22492.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002598 import *
from multiset import Multiset