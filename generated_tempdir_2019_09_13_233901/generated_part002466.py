...
class CommutativeMatcher123621(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123621._instance is None:
            CommutativeMatcher123621._instance = CommutativeMatcher123621()
        return CommutativeMatcher123621._instance
