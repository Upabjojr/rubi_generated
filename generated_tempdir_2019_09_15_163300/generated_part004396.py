...
class CommutativeMatcher141630(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141630._instance is None:
            CommutativeMatcher141630._instance = CommutativeMatcher141630()
        return CommutativeMatcher141630._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher141638.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part004397 import *