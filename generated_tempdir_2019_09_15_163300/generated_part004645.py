...
class CommutativeMatcher21562(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21562._instance is None:
            CommutativeMatcher21562._instance = CommutativeMatcher21562()
        return CommutativeMatcher21562._instance
