...
class CommutativeMatcher22027(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22027._instance is None:
            CommutativeMatcher22027._instance = CommutativeMatcher22027()
        return CommutativeMatcher22027._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22031.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part005358 import *