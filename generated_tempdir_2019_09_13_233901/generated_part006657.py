...
class CommutativeMatcher106360(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106360._instance is None:
            CommutativeMatcher106360._instance = CommutativeMatcher106360()
        return CommutativeMatcher106360._instance
