...
class CommutativeMatcher120739(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120739._instance is None:
            CommutativeMatcher120739._instance = CommutativeMatcher120739()
        return CommutativeMatcher120739._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher120748.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part000276 import *