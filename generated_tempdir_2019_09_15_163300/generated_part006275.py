...
class CommutativeMatcher60391(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60391._instance is None:
            CommutativeMatcher60391._instance = CommutativeMatcher60391()
        return CommutativeMatcher60391._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher60395.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from .generated_part006276 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset