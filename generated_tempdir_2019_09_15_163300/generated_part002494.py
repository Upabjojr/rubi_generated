...
class CommutativeMatcher81299(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81299._instance is None:
            CommutativeMatcher81299._instance = CommutativeMatcher81299()
        return CommutativeMatcher81299._instance
