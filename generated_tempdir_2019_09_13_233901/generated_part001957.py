...
class CommutativeMatcher58309(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58309._instance is None:
            CommutativeMatcher58309._instance = CommutativeMatcher58309()
        return CommutativeMatcher58309._instance
