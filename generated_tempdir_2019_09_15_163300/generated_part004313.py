...
class CommutativeMatcher141063(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141063._instance is None:
            CommutativeMatcher141063._instance = CommutativeMatcher141063()
        return CommutativeMatcher141063._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher141072.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part004314 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset