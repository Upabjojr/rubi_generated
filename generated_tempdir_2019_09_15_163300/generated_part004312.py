...
class CommutativeMatcher141052(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141052._instance is None:
            CommutativeMatcher141052._instance = CommutativeMatcher141052()
        return CommutativeMatcher141052._instance
