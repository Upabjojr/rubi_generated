...
class CommutativeMatcher108765(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108765._instance is None:
            CommutativeMatcher108765._instance = CommutativeMatcher108765()
        return CommutativeMatcher108765._instance
