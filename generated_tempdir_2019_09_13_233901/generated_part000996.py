...
class CommutativeMatcher146229(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146229._instance is None:
            CommutativeMatcher146229._instance = CommutativeMatcher146229()
        return CommutativeMatcher146229._instance
