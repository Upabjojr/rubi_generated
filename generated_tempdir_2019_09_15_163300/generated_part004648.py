...
class CommutativeMatcher32942(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32942._instance is None:
            CommutativeMatcher32942._instance = CommutativeMatcher32942()
        return CommutativeMatcher32942._instance
