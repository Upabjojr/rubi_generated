...
class CommutativeMatcher116744(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116744._instance is None:
            CommutativeMatcher116744._instance = CommutativeMatcher116744()
        return CommutativeMatcher116744._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher116753.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006968 import *