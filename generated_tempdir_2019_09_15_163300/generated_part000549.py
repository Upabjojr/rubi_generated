...
class CommutativeMatcher42189(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42189._instance is None:
            CommutativeMatcher42189._instance = CommutativeMatcher42189()
        return CommutativeMatcher42189._instance
