...
class CommutativeMatcher145647(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145647._instance is None:
            CommutativeMatcher145647._instance = CommutativeMatcher145647()
        return CommutativeMatcher145647._instance
