...
class CommutativeMatcher142686(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142686._instance is None:
            CommutativeMatcher142686._instance = CommutativeMatcher142686()
        return CommutativeMatcher142686._instance
