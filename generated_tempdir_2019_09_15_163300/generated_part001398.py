...
class CommutativeMatcher13291(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13291._instance is None:
            CommutativeMatcher13291._instance = CommutativeMatcher13291()
        return CommutativeMatcher13291._instance
