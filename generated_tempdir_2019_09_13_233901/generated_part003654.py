...
class CommutativeMatcher60180(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60180._instance is None:
            CommutativeMatcher60180._instance = CommutativeMatcher60180()
        return CommutativeMatcher60180._instance
