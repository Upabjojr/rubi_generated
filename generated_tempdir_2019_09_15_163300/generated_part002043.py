...
class CommutativeMatcher84607(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher84607._instance is None:
            CommutativeMatcher84607._instance = CommutativeMatcher84607()
        return CommutativeMatcher84607._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher84611.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002044 import *
from multiset import Multiset