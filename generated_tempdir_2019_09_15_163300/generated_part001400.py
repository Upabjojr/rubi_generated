...
class CommutativeMatcher13307(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13307._instance is None:
            CommutativeMatcher13307._instance = CommutativeMatcher13307()
        return CommutativeMatcher13307._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13314.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part001401 import *