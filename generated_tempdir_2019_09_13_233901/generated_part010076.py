...
class CommutativeMatcher133305(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133305._instance is None:
            CommutativeMatcher133305._instance = CommutativeMatcher133305()
        return CommutativeMatcher133305._instance
