...
class CommutativeMatcher111936(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111936._instance is None:
            CommutativeMatcher111936._instance = CommutativeMatcher111936()
        return CommutativeMatcher111936._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher111944.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004393 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset