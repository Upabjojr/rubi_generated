...
class CommutativeMatcher22969(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22969._instance is None:
            CommutativeMatcher22969._instance = CommutativeMatcher22969()
        return CommutativeMatcher22969._instance
