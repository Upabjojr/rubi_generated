...
class CommutativeMatcher30814(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30814._instance is None:
            CommutativeMatcher30814._instance = CommutativeMatcher30814()
        return CommutativeMatcher30814._instance
