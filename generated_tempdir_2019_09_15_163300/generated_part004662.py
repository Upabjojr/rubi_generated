...
class CommutativeMatcher21622(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21622._instance is None:
            CommutativeMatcher21622._instance = CommutativeMatcher21622()
        return CommutativeMatcher21622._instance
