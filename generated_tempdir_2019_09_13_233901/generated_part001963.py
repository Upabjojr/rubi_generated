...
class CommutativeMatcher58430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58430._instance is None:
            CommutativeMatcher58430._instance = CommutativeMatcher58430()
        return CommutativeMatcher58430._instance
