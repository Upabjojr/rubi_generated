...
class CommutativeMatcher74111(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74111._instance is None:
            CommutativeMatcher74111._instance = CommutativeMatcher74111()
        return CommutativeMatcher74111._instance
