...
class CommutativeMatcher21085(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21085._instance is None:
            CommutativeMatcher21085._instance = CommutativeMatcher21085()
        return CommutativeMatcher21085._instance
