...
class CommutativeMatcher22691(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22691._instance is None:
            CommutativeMatcher22691._instance = CommutativeMatcher22691()
        return CommutativeMatcher22691._instance
