...
class CommutativeMatcher120916(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120916._instance is None:
            CommutativeMatcher120916._instance = CommutativeMatcher120916()
        return CommutativeMatcher120916._instance
