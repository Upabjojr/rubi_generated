...
class CommutativeMatcher22602(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22602._instance is None:
            CommutativeMatcher22602._instance = CommutativeMatcher22602()
        return CommutativeMatcher22602._instance
