...
class CommutativeMatcher111333(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111333._instance is None:
            CommutativeMatcher111333._instance = CommutativeMatcher111333()
        return CommutativeMatcher111333._instance
