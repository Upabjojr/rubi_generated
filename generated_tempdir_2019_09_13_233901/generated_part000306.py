...
class CommutativeMatcher146143(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146143._instance is None:
            CommutativeMatcher146143._instance = CommutativeMatcher146143()
        return CommutativeMatcher146143._instance
