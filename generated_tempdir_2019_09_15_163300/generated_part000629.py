...
class CommutativeMatcher42708(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42708._instance is None:
            CommutativeMatcher42708._instance = CommutativeMatcher42708()
        return CommutativeMatcher42708._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42715.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000630 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset