...
class CommutativeMatcher21115(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21115._instance is None:
            CommutativeMatcher21115._instance = CommutativeMatcher21115()
        return CommutativeMatcher21115._instance
