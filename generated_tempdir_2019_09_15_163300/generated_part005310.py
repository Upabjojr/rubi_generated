...
class CommutativeMatcher21882(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21882._instance is None:
            CommutativeMatcher21882._instance = CommutativeMatcher21882()
        return CommutativeMatcher21882._instance
