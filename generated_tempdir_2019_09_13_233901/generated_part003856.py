...
class CommutativeMatcher26380(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26380._instance is None:
            CommutativeMatcher26380._instance = CommutativeMatcher26380()
        return CommutativeMatcher26380._instance
