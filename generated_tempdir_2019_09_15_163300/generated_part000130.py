...
class CommutativeMatcher40674(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40674._instance is None:
            CommutativeMatcher40674._instance = CommutativeMatcher40674()
        return CommutativeMatcher40674._instance
