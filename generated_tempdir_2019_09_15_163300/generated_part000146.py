...
class CommutativeMatcher40830(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40830._instance is None:
            CommutativeMatcher40830._instance = CommutativeMatcher40830()
        return CommutativeMatcher40830._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher40837.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part000147 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset