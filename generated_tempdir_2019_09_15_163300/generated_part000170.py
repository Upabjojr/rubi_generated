...
class CommutativeMatcher41022(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41022._instance is None:
            CommutativeMatcher41022._instance = CommutativeMatcher41022()
        return CommutativeMatcher41022._instance
