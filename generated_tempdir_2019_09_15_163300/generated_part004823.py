...
class CommutativeMatcher69374(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69374._instance is None:
            CommutativeMatcher69374._instance = CommutativeMatcher69374()
        return CommutativeMatcher69374._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher69378.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from .generated_part004824 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset