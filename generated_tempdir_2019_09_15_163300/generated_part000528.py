...
class CommutativeMatcher42026(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42026._instance is None:
            CommutativeMatcher42026._instance = CommutativeMatcher42026()
        return CommutativeMatcher42026._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42033.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000529 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset