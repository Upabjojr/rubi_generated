...
class CommutativeMatcher21496(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21496._instance is None:
            CommutativeMatcher21496._instance = CommutativeMatcher21496()
        return CommutativeMatcher21496._instance
