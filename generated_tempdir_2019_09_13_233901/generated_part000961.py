...
class CommutativeMatcher120422(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120422._instance is None:
            CommutativeMatcher120422._instance = CommutativeMatcher120422()
        return CommutativeMatcher120422._instance
