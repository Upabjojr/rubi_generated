...
class CommutativeMatcher33002(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33002._instance is None:
            CommutativeMatcher33002._instance = CommutativeMatcher33002()
        return CommutativeMatcher33002._instance
