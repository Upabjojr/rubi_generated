...
class CommutativeMatcher41268(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41268._instance is None:
            CommutativeMatcher41268._instance = CommutativeMatcher41268()
        return CommutativeMatcher41268._instance
