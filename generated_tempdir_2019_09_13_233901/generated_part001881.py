...
class CommutativeMatcher31099(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31099._instance is None:
            CommutativeMatcher31099._instance = CommutativeMatcher31099()
        return CommutativeMatcher31099._instance
