...
class CommutativeMatcher25340(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25340._instance is None:
            CommutativeMatcher25340._instance = CommutativeMatcher25340()
        return CommutativeMatcher25340._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25344.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007475 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset