...
class CommutativeMatcher49381(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49381._instance is None:
            CommutativeMatcher49381._instance = CommutativeMatcher49381()
        return CommutativeMatcher49381._instance
