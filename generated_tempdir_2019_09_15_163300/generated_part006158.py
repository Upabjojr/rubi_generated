...
class CommutativeMatcher63850(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63850._instance is None:
            CommutativeMatcher63850._instance = CommutativeMatcher63850()
        return CommutativeMatcher63850._instance
