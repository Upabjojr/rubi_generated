...
class CommutativeMatcher60452(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60452._instance is None:
            CommutativeMatcher60452._instance = CommutativeMatcher60452()
        return CommutativeMatcher60452._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher60456.get()
            tmp15 = subjects14
            subjects14 = []
            for s in tmp15:
