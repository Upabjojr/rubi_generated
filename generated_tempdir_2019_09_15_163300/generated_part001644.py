...
class CommutativeMatcher133580(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133580._instance is None:
            CommutativeMatcher133580._instance = CommutativeMatcher133580()
        return CommutativeMatcher133580._instance
