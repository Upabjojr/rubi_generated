...
class CommutativeMatcher30702(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30702._instance is None:
            CommutativeMatcher30702._instance = CommutativeMatcher30702()
        return CommutativeMatcher30702._instance
