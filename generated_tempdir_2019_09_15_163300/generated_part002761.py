...
class CommutativeMatcher22773(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22773._instance is None:
            CommutativeMatcher22773._instance = CommutativeMatcher22773()
        return CommutativeMatcher22773._instance
