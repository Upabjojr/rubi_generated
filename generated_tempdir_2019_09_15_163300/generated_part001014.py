...
class CommutativeMatcher150092(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150092._instance is None:
            CommutativeMatcher150092._instance = CommutativeMatcher150092()
        return CommutativeMatcher150092._instance
