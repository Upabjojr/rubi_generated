...
class CommutativeMatcher106657(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106657._instance is None:
            CommutativeMatcher106657._instance = CommutativeMatcher106657()
        return CommutativeMatcher106657._instance
