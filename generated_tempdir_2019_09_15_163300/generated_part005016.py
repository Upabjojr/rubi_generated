...
class CommutativeMatcher93419(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93419._instance is None:
            CommutativeMatcher93419._instance = CommutativeMatcher93419()
        return CommutativeMatcher93419._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher93423.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part005017 import *