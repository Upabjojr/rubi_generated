...
class CommutativeMatcher21466(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21466._instance is None:
            CommutativeMatcher21466._instance = CommutativeMatcher21466()
        return CommutativeMatcher21466._instance
