...
class CommutativeMatcher64151(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64151._instance is None:
            CommutativeMatcher64151._instance = CommutativeMatcher64151()
        return CommutativeMatcher64151._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1:
                ...
                subst2 = Substitution(subst1)
                try:
                    subst2.try_add_variable('i2.2.2.3.1.0', tmp5)
                except ValueError:
                    pass
                else:
                    pass
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher64155.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part006201 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset