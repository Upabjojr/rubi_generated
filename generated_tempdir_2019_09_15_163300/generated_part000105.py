...
class CommutativeMatcher41980(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41980._instance is None:
            CommutativeMatcher41980._instance = CommutativeMatcher41980()
        return CommutativeMatcher41980._instance
