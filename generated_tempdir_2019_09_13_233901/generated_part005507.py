...
class CommutativeMatcher126494(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126494._instance is None:
            CommutativeMatcher126494._instance = CommutativeMatcher126494()
        return CommutativeMatcher126494._instance
