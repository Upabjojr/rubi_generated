...
class CommutativeMatcher140897(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140897._instance is None:
            CommutativeMatcher140897._instance = CommutativeMatcher140897()
        return CommutativeMatcher140897._instance
