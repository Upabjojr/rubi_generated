...
class CommutativeMatcher43013(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43013._instance is None:
            CommutativeMatcher43013._instance = CommutativeMatcher43013()
        return CommutativeMatcher43013._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43020.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000381 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset