...
class CommutativeMatcher41591(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41591._instance is None:
            CommutativeMatcher41591._instance = CommutativeMatcher41591()
        return CommutativeMatcher41591._instance
