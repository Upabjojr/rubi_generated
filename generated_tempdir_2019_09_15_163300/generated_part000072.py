...
class CommutativeMatcher41665(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41665._instance is None:
            CommutativeMatcher41665._instance = CommutativeMatcher41665()
        return CommutativeMatcher41665._instance
