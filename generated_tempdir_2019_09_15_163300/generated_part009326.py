...
class CommutativeMatcher110413(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110413._instance is None:
            CommutativeMatcher110413._instance = CommutativeMatcher110413()
        return CommutativeMatcher110413._instance
