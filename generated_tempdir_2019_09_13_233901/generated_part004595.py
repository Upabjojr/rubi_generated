...
class CommutativeMatcher62046(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62046._instance is None:
            CommutativeMatcher62046._instance = CommutativeMatcher62046()
        return CommutativeMatcher62046._instance
