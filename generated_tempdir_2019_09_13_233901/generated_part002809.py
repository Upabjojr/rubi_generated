...
class CommutativeMatcher81262(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81262._instance is None:
            CommutativeMatcher81262._instance = CommutativeMatcher81262()
        return CommutativeMatcher81262._instance
