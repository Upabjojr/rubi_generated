...
class CommutativeMatcher69095(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69095._instance is None:
            CommutativeMatcher69095._instance = CommutativeMatcher69095()
        return CommutativeMatcher69095._instance
