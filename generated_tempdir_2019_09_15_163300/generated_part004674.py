...
class CommutativeMatcher21649(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21649._instance is None:
            CommutativeMatcher21649._instance = CommutativeMatcher21649()
        return CommutativeMatcher21649._instance
