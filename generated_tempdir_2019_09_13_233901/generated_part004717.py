...
class CommutativeMatcher21783(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21783._instance is None:
            CommutativeMatcher21783._instance = CommutativeMatcher21783()
        return CommutativeMatcher21783._instance
