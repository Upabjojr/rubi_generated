...
class CommutativeMatcher42295(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42295._instance is None:
            CommutativeMatcher42295._instance = CommutativeMatcher42295()
        return CommutativeMatcher42295._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42302.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000566 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset