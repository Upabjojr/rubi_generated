...
class CommutativeMatcher43294(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43294._instance is None:
            CommutativeMatcher43294._instance = CommutativeMatcher43294()
        return CommutativeMatcher43294._instance
