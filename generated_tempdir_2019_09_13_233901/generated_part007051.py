...
class CommutativeMatcher141174(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141174._instance is None:
            CommutativeMatcher141174._instance = CommutativeMatcher141174()
        return CommutativeMatcher141174._instance
