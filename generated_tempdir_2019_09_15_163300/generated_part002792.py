...
class CommutativeMatcher30927(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30927._instance is None:
            CommutativeMatcher30927._instance = CommutativeMatcher30927()
        return CommutativeMatcher30927._instance
