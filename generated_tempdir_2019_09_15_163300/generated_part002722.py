...
class CommutativeMatcher22648(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22648._instance is None:
            CommutativeMatcher22648._instance = CommutativeMatcher22648()
        return CommutativeMatcher22648._instance
