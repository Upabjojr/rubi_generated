...
class CommutativeMatcher108795(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108795._instance is None:
            CommutativeMatcher108795._instance = CommutativeMatcher108795()
        return CommutativeMatcher108795._instance
