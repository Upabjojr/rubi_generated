...
class CommutativeMatcher120665(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120665._instance is None:
            CommutativeMatcher120665._instance = CommutativeMatcher120665()
        return CommutativeMatcher120665._instance
