...
class CommutativeMatcher106020(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106020._instance is None:
            CommutativeMatcher106020._instance = CommutativeMatcher106020()
        return CommutativeMatcher106020._instance
