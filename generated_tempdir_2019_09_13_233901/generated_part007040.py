...
class CommutativeMatcher128744(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128744._instance is None:
            CommutativeMatcher128744._instance = CommutativeMatcher128744()
        return CommutativeMatcher128744._instance
