...
class CommutativeMatcher21934(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21934._instance is None:
            CommutativeMatcher21934._instance = CommutativeMatcher21934()
        return CommutativeMatcher21934._instance
