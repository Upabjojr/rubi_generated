...
class CommutativeMatcher41849(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41849._instance is None:
            CommutativeMatcher41849._instance = CommutativeMatcher41849()
        return CommutativeMatcher41849._instance
