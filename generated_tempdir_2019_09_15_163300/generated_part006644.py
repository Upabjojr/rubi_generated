...
class CommutativeMatcher106404(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106404._instance is None:
            CommutativeMatcher106404._instance = CommutativeMatcher106404()
        return CommutativeMatcher106404._instance
