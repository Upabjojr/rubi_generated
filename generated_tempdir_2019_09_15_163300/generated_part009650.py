...
class CommutativeMatcher13536(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13536._instance is None:
            CommutativeMatcher13536._instance = CommutativeMatcher13536()
        return CommutativeMatcher13536._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13543.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part009651 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset