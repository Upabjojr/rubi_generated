...
class CommutativeMatcher122240(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122240._instance is None:
            CommutativeMatcher122240._instance = CommutativeMatcher122240()
        return CommutativeMatcher122240._instance
