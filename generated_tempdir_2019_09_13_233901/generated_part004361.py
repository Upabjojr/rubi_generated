...
class CommutativeMatcher106701(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106701._instance is None:
            CommutativeMatcher106701._instance = CommutativeMatcher106701()
        return CommutativeMatcher106701._instance
