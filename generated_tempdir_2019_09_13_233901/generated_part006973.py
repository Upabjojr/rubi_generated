...
class CommutativeMatcher116803(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116803._instance is None:
            CommutativeMatcher116803._instance = CommutativeMatcher116803()
        return CommutativeMatcher116803._instance
