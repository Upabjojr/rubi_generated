...
class CommutativeMatcher46800(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46800._instance is None:
            CommutativeMatcher46800._instance = CommutativeMatcher46800()
        return CommutativeMatcher46800._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher46804.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part004159 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset