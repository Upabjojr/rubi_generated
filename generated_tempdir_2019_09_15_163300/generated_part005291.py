...
class CommutativeMatcher21822(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21822._instance is None:
            CommutativeMatcher21822._instance = CommutativeMatcher21822()
        return CommutativeMatcher21822._instance
