...
class CommutativeMatcher21374(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21374._instance is None:
            CommutativeMatcher21374._instance = CommutativeMatcher21374()
        return CommutativeMatcher21374._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21378.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from .generated_part005808 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset