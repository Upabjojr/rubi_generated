...
class CommutativeMatcher32336(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32336._instance is None:
            CommutativeMatcher32336._instance = CommutativeMatcher32336()
        return CommutativeMatcher32336._instance
