...
class CommutativeMatcher105653(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105653._instance is None:
            CommutativeMatcher105653._instance = CommutativeMatcher105653()
        return CommutativeMatcher105653._instance
