...
class CommutativeMatcher120474(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120474._instance is None:
            CommutativeMatcher120474._instance = CommutativeMatcher120474()
        return CommutativeMatcher120474._instance
