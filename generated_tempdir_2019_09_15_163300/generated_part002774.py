...
class CommutativeMatcher22814(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22814._instance is None:
            CommutativeMatcher22814._instance = CommutativeMatcher22814()
        return CommutativeMatcher22814._instance
