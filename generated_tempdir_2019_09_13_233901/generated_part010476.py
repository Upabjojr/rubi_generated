...
class CommutativeMatcher133937(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133937._instance is None:
            CommutativeMatcher133937._instance = CommutativeMatcher133937()
        return CommutativeMatcher133937._instance
