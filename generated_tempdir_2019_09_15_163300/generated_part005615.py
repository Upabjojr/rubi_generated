...
class CommutativeMatcher21066(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21066._instance is None:
            CommutativeMatcher21066._instance = CommutativeMatcher21066()
        return CommutativeMatcher21066._instance
