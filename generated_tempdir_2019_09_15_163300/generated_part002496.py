...
class CommutativeMatcher93078(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93078._instance is None:
            CommutativeMatcher93078._instance = CommutativeMatcher93078()
        return CommutativeMatcher93078._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher93082.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part002497 import *