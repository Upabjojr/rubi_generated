...
class CommutativeMatcher46804(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46804._instance is None:
            CommutativeMatcher46804._instance = CommutativeMatcher46804()
        return CommutativeMatcher46804._instance
