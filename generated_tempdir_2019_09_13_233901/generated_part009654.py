...
class CommutativeMatcher67131(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67131._instance is None:
            CommutativeMatcher67131._instance = CommutativeMatcher67131()
        return CommutativeMatcher67131._instance
