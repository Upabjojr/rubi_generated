...
class CommutativeMatcher20987(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20987._instance is None:
            CommutativeMatcher20987._instance = CommutativeMatcher20987()
        return CommutativeMatcher20987._instance
