...
class CommutativeMatcher30092(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30092._instance is None:
            CommutativeMatcher30092._instance = CommutativeMatcher30092()
        return CommutativeMatcher30092._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher30101.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part002521 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset