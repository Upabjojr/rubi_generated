...
class CommutativeMatcher59963(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59963._instance is None:
            CommutativeMatcher59963._instance = CommutativeMatcher59963()
        return CommutativeMatcher59963._instance
