...
class CommutativeMatcher21552(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21552._instance is None:
            CommutativeMatcher21552._instance = CommutativeMatcher21552()
        return CommutativeMatcher21552._instance
