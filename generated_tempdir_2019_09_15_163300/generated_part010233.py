...
class CommutativeMatcher49238(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49238._instance is None:
            CommutativeMatcher49238._instance = CommutativeMatcher49238()
        return CommutativeMatcher49238._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher51239.get()
                    tmp18 = subjects17
                    subjects17 = []
                    for s in tmp18:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher51244.get()
                tmp28 = subjects27
                subjects27 = []
                for s in tmp28:
                    matcher.add_subject(s)
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher51425.get()
                    tmp43 = subjects42
                    subjects42 = []
                    for s in tmp43:
                        matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher51428.get()
                tmp46 = subjects45
                subjects45 = []
                for s in tmp46:
                    matcher.add_subject(s)
...
from .generated_part010234 import *
from .generated_part010237 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part010238 import *
from .generated_part010235 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset