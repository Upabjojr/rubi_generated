...
class CommutativeMatcher105079(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105079._instance is None:
            CommutativeMatcher105079._instance = CommutativeMatcher105079()
        return CommutativeMatcher105079._instance
