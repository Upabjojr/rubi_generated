...
class CommutativeMatcher57075(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher57075._instance is None:
            CommutativeMatcher57075._instance = CommutativeMatcher57075()
        return CommutativeMatcher57075._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher57079.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
