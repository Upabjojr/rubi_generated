...
class CommutativeMatcher21605(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21605._instance is None:
            CommutativeMatcher21605._instance = CommutativeMatcher21605()
        return CommutativeMatcher21605._instance
