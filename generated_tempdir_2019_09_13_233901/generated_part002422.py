...
class CommutativeMatcher23575(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23575._instance is None:
            CommutativeMatcher23575._instance = CommutativeMatcher23575()
        return CommutativeMatcher23575._instance
