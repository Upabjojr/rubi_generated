...
class CommutativeMatcher62070(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62070._instance is None:
            CommutativeMatcher62070._instance = CommutativeMatcher62070()
        return CommutativeMatcher62070._instance
