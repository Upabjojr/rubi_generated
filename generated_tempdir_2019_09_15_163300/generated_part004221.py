...
class CommutativeMatcher105220(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105220._instance is None:
            CommutativeMatcher105220._instance = CommutativeMatcher105220()
        return CommutativeMatcher105220._instance
