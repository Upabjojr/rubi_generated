...
class CommutativeMatcher23389(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23389._instance is None:
            CommutativeMatcher23389._instance = CommutativeMatcher23389()
        return CommutativeMatcher23389._instance
