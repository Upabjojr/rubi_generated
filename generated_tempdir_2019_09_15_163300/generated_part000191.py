...
class CommutativeMatcher41224(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41224._instance is None:
            CommutativeMatcher41224._instance = CommutativeMatcher41224()
        return CommutativeMatcher41224._instance
