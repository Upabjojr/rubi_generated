...
class CommutativeMatcher21293(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21293._instance is None:
            CommutativeMatcher21293._instance = CommutativeMatcher21293()
        return CommutativeMatcher21293._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21297.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part005780 import *