...
class CommutativeMatcher134105(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134105._instance is None:
            CommutativeMatcher134105._instance = CommutativeMatcher134105()
        return CommutativeMatcher134105._instance
