...
class CommutativeMatcher41203(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41203._instance is None:
            CommutativeMatcher41203._instance = CommutativeMatcher41203()
        return CommutativeMatcher41203._instance
