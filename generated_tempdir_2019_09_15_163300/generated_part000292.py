...
class CommutativeMatcher141267(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141267._instance is None:
            CommutativeMatcher141267._instance = CommutativeMatcher141267()
        return CommutativeMatcher141267._instance
