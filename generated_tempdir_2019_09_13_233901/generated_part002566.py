...
class CommutativeMatcher22386(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22386._instance is None:
            CommutativeMatcher22386._instance = CommutativeMatcher22386()
        return CommutativeMatcher22386._instance
