...
class CommutativeMatcher120336(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120336._instance is None:
            CommutativeMatcher120336._instance = CommutativeMatcher120336()
        return CommutativeMatcher120336._instance
