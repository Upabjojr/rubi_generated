...
class CommutativeMatcher138444(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138444._instance is None:
            CommutativeMatcher138444._instance = CommutativeMatcher138444()
        return CommutativeMatcher138444._instance
