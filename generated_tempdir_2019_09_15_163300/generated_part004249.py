...
class CommutativeMatcher117090(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117090._instance is None:
            CommutativeMatcher117090._instance = CommutativeMatcher117090()
        return CommutativeMatcher117090._instance
