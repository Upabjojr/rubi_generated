...
class CommutativeMatcher46575(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46575._instance is None:
            CommutativeMatcher46575._instance = CommutativeMatcher46575()
        return CommutativeMatcher46575._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher46583.get()
                    tmp10 = subjects9
                    subjects9 = []
                    for s in tmp10:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher46588.get()
                tmp14 = subjects13
                subjects13 = []
                for s in tmp14:
                    matcher.add_subject(s)
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher46601.get()
                tmp22 = subjects21
                subjects21 = []
                for s in tmp22:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher46604.get()
            tmp25 = subjects24
            subjects24 = []
            for s in tmp25:
                matcher.add_subject(s)
...
from .generated_part000846 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000848 import *
from .generated_part000845 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part000849 import *