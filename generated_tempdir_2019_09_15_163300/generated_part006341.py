...
class CommutativeMatcher124369(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124369._instance is None:
            CommutativeMatcher124369._instance = CommutativeMatcher124369()
        return CommutativeMatcher124369._instance
