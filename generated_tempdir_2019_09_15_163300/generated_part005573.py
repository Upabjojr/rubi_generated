...
class CommutativeMatcher20935(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20935._instance is None:
            CommutativeMatcher20935._instance = CommutativeMatcher20935()
        return CommutativeMatcher20935._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher20939.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005574 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset