...
class CommutativeMatcher106042(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106042._instance is None:
            CommutativeMatcher106042._instance = CommutativeMatcher106042()
        return CommutativeMatcher106042._instance
