...
class CommutativeMatcher41314(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41314._instance is None:
            CommutativeMatcher41314._instance = CommutativeMatcher41314()
        return CommutativeMatcher41314._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41321.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
