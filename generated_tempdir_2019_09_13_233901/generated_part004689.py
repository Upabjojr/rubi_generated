...
class CommutativeMatcher21694(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21694._instance is None:
            CommutativeMatcher21694._instance = CommutativeMatcher21694()
        return CommutativeMatcher21694._instance
