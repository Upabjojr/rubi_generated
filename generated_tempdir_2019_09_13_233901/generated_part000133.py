...
class CommutativeMatcher40702(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40702._instance is None:
            CommutativeMatcher40702._instance = CommutativeMatcher40702()
        return CommutativeMatcher40702._instance
