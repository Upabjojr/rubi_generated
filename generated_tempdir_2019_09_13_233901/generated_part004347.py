...
class CommutativeMatcher150148(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150148._instance is None:
            CommutativeMatcher150148._instance = CommutativeMatcher150148()
        return CommutativeMatcher150148._instance
