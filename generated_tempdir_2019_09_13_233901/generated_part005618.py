...
class CommutativeMatcher32310(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32310._instance is None:
            CommutativeMatcher32310._instance = CommutativeMatcher32310()
        return CommutativeMatcher32310._instance
