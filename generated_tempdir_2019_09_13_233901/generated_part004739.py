...
class CommutativeMatcher58460(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58460._instance is None:
            CommutativeMatcher58460._instance = CommutativeMatcher58460()
        return CommutativeMatcher58460._instance
