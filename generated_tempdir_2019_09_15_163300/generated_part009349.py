...
class CommutativeMatcher140148(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140148._instance is None:
            CommutativeMatcher140148._instance = CommutativeMatcher140148()
        return CommutativeMatcher140148._instance
