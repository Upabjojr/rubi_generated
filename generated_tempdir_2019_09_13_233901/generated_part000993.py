...
class CommutativeMatcher145838(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145838._instance is None:
            CommutativeMatcher145838._instance = CommutativeMatcher145838()
        return CommutativeMatcher145838._instance
