...
class CommutativeMatcher85840(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher85840._instance is None:
            CommutativeMatcher85840._instance = CommutativeMatcher85840()
        return CommutativeMatcher85840._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher85844.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part004914 import *