...
class CommutativeMatcher104404(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104404._instance is None:
            CommutativeMatcher104404._instance = CommutativeMatcher104404()
        return CommutativeMatcher104404._instance
