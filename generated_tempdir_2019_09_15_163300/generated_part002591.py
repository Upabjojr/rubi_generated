...
class CommutativeMatcher22463(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22463._instance is None:
            CommutativeMatcher22463._instance = CommutativeMatcher22463()
        return CommutativeMatcher22463._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22467.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from .generated_part002592 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset