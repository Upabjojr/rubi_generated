...
class CommutativeMatcher116539(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116539._instance is None:
            CommutativeMatcher116539._instance = CommutativeMatcher116539()
        return CommutativeMatcher116539._instance
