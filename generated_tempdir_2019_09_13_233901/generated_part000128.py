...
class CommutativeMatcher40650(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40650._instance is None:
            CommutativeMatcher40650._instance = CommutativeMatcher40650()
        return CommutativeMatcher40650._instance
