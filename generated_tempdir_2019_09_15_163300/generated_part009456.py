...
class CommutativeMatcher67188(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67188._instance is None:
            CommutativeMatcher67188._instance = CommutativeMatcher67188()
        return CommutativeMatcher67188._instance
