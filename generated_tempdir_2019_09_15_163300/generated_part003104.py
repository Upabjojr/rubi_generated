...
class CommutativeMatcher63771(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63771._instance is None:
            CommutativeMatcher63771._instance = CommutativeMatcher63771()
        return CommutativeMatcher63771._instance
