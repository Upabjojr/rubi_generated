...
class CommutativeMatcher135442(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135442._instance is None:
            CommutativeMatcher135442._instance = CommutativeMatcher135442()
        return CommutativeMatcher135442._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher135454.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part001693 import *