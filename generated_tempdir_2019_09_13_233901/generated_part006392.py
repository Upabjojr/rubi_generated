...
class CommutativeMatcher63176(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63176._instance is None:
            CommutativeMatcher63176._instance = CommutativeMatcher63176()
        return CommutativeMatcher63176._instance
