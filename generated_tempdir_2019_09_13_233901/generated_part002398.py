...
class CommutativeMatcher23493(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23493._instance is None:
            CommutativeMatcher23493._instance = CommutativeMatcher23493()
        return CommutativeMatcher23493._instance
