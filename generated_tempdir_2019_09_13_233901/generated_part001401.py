...
class CommutativeMatcher13314(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13314._instance is None:
            CommutativeMatcher13314._instance = CommutativeMatcher13314()
        return CommutativeMatcher13314._instance
