...
class CommutativeMatcher14761(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher14761._instance is None:
            CommutativeMatcher14761._instance = CommutativeMatcher14761()
        return CommutativeMatcher14761._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher14766.get()
                tmp7 = subjects6
                subjects6 = []
                for s in tmp7:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher14769.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
                matcher.add_subject(s)
...
from .generated_part001737 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001736 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset