...
class CommutativeMatcher21526(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21526._instance is None:
            CommutativeMatcher21526._instance = CommutativeMatcher21526()
        return CommutativeMatcher21526._instance
