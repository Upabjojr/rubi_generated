...
class CommutativeMatcher132007(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher132007._instance is None:
            CommutativeMatcher132007._instance = CommutativeMatcher132007()
        return CommutativeMatcher132007._instance
