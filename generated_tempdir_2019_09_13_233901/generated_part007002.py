...
class CommutativeMatcher134082(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134082._instance is None:
            CommutativeMatcher134082._instance = CommutativeMatcher134082()
        return CommutativeMatcher134082._instance
