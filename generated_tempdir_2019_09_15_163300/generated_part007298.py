...
class CommutativeMatcher113027(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113027._instance is None:
            CommutativeMatcher113027._instance = CommutativeMatcher113027()
        return CommutativeMatcher113027._instance
