...
class CommutativeMatcher22139(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22139._instance is None:
            CommutativeMatcher22139._instance = CommutativeMatcher22139()
        return CommutativeMatcher22139._instance
