...
class CommutativeMatcher22974(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22974._instance is None:
            CommutativeMatcher22974._instance = CommutativeMatcher22974()
        return CommutativeMatcher22974._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22978.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
