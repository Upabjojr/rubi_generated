...
class CommutativeMatcher58347(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58347._instance is None:
            CommutativeMatcher58347._instance = CommutativeMatcher58347()
        return CommutativeMatcher58347._instance
