...
class CommutativeMatcher20802(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20802._instance is None:
            CommutativeMatcher20802._instance = CommutativeMatcher20802()
        return CommutativeMatcher20802._instance
