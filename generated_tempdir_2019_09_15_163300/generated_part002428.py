...
class CommutativeMatcher23592(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23592._instance is None:
            CommutativeMatcher23592._instance = CommutativeMatcher23592()
        return CommutativeMatcher23592._instance
