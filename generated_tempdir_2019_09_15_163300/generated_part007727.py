...
class CommutativeMatcher131870(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher131870._instance is None:
            CommutativeMatcher131870._instance = CommutativeMatcher131870()
        return CommutativeMatcher131870._instance
