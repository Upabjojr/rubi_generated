...
class CommutativeMatcher61301(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61301._instance is None:
            CommutativeMatcher61301._instance = CommutativeMatcher61301()
        return CommutativeMatcher61301._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher61305.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part006179 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset