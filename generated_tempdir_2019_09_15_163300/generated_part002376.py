...
class CommutativeMatcher23430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23430._instance is None:
            CommutativeMatcher23430._instance = CommutativeMatcher23430()
        return CommutativeMatcher23430._instance
