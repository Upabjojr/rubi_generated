...
class CommutativeMatcher47888(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher47888._instance is None:
            CommutativeMatcher47888._instance = CommutativeMatcher47888()
        return CommutativeMatcher47888._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher47892.get()
            tmp8 = subjects7
            subjects7 = []
            for s in tmp8:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007549 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset