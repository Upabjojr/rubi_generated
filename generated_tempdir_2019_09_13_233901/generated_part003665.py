...
class CommutativeMatcher58912(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58912._instance is None:
            CommutativeMatcher58912._instance = CommutativeMatcher58912()
        return CommutativeMatcher58912._instance
