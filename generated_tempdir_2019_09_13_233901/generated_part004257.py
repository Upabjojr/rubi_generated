...
class CommutativeMatcher120530(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120530._instance is None:
            CommutativeMatcher120530._instance = CommutativeMatcher120530()
        return CommutativeMatcher120530._instance
