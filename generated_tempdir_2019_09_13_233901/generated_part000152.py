...
class CommutativeMatcher40883(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40883._instance is None:
            CommutativeMatcher40883._instance = CommutativeMatcher40883()
        return CommutativeMatcher40883._instance
