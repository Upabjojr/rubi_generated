...
class CommutativeMatcher53963(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53963._instance is None:
            CommutativeMatcher53963._instance = CommutativeMatcher53963()
        return CommutativeMatcher53963._instance
