...
class CommutativeMatcher40604(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40604._instance is None:
            CommutativeMatcher40604._instance = CommutativeMatcher40604()
        return CommutativeMatcher40604._instance
