...
class CommutativeMatcher13140(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13140._instance is None:
            CommutativeMatcher13140._instance = CommutativeMatcher13140()
        return CommutativeMatcher13140._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13147.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part001029 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset