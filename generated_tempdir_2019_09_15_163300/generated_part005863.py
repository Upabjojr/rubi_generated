...
class CommutativeMatcher122269(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122269._instance is None:
            CommutativeMatcher122269._instance = CommutativeMatcher122269()
        return CommutativeMatcher122269._instance
