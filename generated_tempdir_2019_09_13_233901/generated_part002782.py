...
class CommutativeMatcher22848(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22848._instance is None:
            CommutativeMatcher22848._instance = CommutativeMatcher22848()
        return CommutativeMatcher22848._instance
