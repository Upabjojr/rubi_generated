...
class CommutativeMatcher111764(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111764._instance is None:
            CommutativeMatcher111764._instance = CommutativeMatcher111764()
        return CommutativeMatcher111764._instance
