...
class CommutativeMatcher143962(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher143962._instance is None:
            CommutativeMatcher143962._instance = CommutativeMatcher143962()
        return CommutativeMatcher143962._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher143966.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000896 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset