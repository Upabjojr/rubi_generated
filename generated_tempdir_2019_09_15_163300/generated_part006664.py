...
class CommutativeMatcher128674(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128674._instance is None:
            CommutativeMatcher128674._instance = CommutativeMatcher128674()
        return CommutativeMatcher128674._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects12) >= 1 and isinstance(subjects12[0], Mul):
                ...
                matcher = CommutativeMatcher136001.get()
                tmp26 = subjects25
                subjects25 = []
                for s in tmp26:
...
from .generated_part006665 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset