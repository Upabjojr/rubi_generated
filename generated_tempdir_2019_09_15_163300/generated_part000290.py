...
class CommutativeMatcher141237(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141237._instance is None:
            CommutativeMatcher141237._instance = CommutativeMatcher141237()
        return CommutativeMatcher141237._instance
