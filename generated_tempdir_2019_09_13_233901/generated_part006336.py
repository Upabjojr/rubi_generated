...
class CommutativeMatcher124105(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124105._instance is None:
            CommutativeMatcher124105._instance = CommutativeMatcher124105()
        return CommutativeMatcher124105._instance
