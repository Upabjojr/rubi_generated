...
class CommutativeMatcher77419(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77419._instance is None:
            CommutativeMatcher77419._instance = CommutativeMatcher77419()
        return CommutativeMatcher77419._instance
