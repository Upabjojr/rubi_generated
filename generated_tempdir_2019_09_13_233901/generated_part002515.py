...
class CommutativeMatcher30074(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30074._instance is None:
            CommutativeMatcher30074._instance = CommutativeMatcher30074()
        return CommutativeMatcher30074._instance
