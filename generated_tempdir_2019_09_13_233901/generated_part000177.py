...
class CommutativeMatcher41089(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41089._instance is None:
            CommutativeMatcher41089._instance = CommutativeMatcher41089()
        return CommutativeMatcher41089._instance
