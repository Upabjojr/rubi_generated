...
class CommutativeMatcher13835(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13835._instance is None:
            CommutativeMatcher13835._instance = CommutativeMatcher13835()
        return CommutativeMatcher13835._instance
