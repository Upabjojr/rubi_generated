...
class CommutativeMatcher31243(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31243._instance is None:
            CommutativeMatcher31243._instance = CommutativeMatcher31243()
        return CommutativeMatcher31243._instance
