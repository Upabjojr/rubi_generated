...
class CommutativeMatcher41345(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41345._instance is None:
            CommutativeMatcher41345._instance = CommutativeMatcher41345()
        return CommutativeMatcher41345._instance
