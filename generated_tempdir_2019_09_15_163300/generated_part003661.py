...
class CommutativeMatcher60238(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60238._instance is None:
            CommutativeMatcher60238._instance = CommutativeMatcher60238()
        return CommutativeMatcher60238._instance
