...
class CommutativeMatcher22790(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22790._instance is None:
            CommutativeMatcher22790._instance = CommutativeMatcher22790()
        return CommutativeMatcher22790._instance
