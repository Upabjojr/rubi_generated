...
class CommutativeMatcher64274(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64274._instance is None:
            CommutativeMatcher64274._instance = CommutativeMatcher64274()
        return CommutativeMatcher64274._instance
