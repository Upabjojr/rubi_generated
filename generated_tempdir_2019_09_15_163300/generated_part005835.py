...
class CommutativeMatcher59955(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59955._instance is None:
            CommutativeMatcher59955._instance = CommutativeMatcher59955()
        return CommutativeMatcher59955._instance
