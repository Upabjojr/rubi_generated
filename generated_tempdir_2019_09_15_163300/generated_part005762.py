...
class CommutativeMatcher21249(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21249._instance is None:
            CommutativeMatcher21249._instance = CommutativeMatcher21249()
        return CommutativeMatcher21249._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21253.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005763 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset