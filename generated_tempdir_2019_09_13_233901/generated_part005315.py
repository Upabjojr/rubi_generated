...
class CommutativeMatcher33368(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33368._instance is None:
            CommutativeMatcher33368._instance = CommutativeMatcher33368()
        return CommutativeMatcher33368._instance
