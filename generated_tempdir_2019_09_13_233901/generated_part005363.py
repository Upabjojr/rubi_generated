...
class CommutativeMatcher22043(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22043._instance is None:
            CommutativeMatcher22043._instance = CommutativeMatcher22043()
        return CommutativeMatcher22043._instance
