...
class CommutativeMatcher150244(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150244._instance is None:
            CommutativeMatcher150244._instance = CommutativeMatcher150244()
        return CommutativeMatcher150244._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher150253.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part007092 import *