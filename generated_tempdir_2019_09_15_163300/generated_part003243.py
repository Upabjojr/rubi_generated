...
class CommutativeMatcher124227(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124227._instance is None:
            CommutativeMatcher124227._instance = CommutativeMatcher124227()
        return CommutativeMatcher124227._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher124234.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part003244 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset