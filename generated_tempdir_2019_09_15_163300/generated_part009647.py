...
class CommutativeMatcher13513(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13513._instance is None:
            CommutativeMatcher13513._instance = CommutativeMatcher13513()
        return CommutativeMatcher13513._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13520.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part009648 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset