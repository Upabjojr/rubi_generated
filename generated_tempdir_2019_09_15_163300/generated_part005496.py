...
class CommutativeMatcher79212(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79212._instance is None:
            CommutativeMatcher79212._instance = CommutativeMatcher79212()
        return CommutativeMatcher79212._instance
