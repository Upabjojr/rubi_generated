...
class CommutativeMatcher62349(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62349._instance is None:
            CommutativeMatcher62349._instance = CommutativeMatcher62349()
        return CommutativeMatcher62349._instance
