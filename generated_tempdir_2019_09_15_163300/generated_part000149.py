...
class CommutativeMatcher40858(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40858._instance is None:
            CommutativeMatcher40858._instance = CommutativeMatcher40858()
        return CommutativeMatcher40858._instance
