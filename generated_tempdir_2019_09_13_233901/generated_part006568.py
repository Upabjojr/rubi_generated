...
class CommutativeMatcher59323(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59323._instance is None:
            CommutativeMatcher59323._instance = CommutativeMatcher59323()
        return CommutativeMatcher59323._instance
