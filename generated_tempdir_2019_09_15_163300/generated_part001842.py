...
class CommutativeMatcher129319(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129319._instance is None:
            CommutativeMatcher129319._instance = CommutativeMatcher129319()
        return CommutativeMatcher129319._instance
