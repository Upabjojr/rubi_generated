...
class CommutativeMatcher122250(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122250._instance is None:
            CommutativeMatcher122250._instance = CommutativeMatcher122250()
        return CommutativeMatcher122250._instance
