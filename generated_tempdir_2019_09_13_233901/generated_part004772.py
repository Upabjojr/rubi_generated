...
class CommutativeMatcher123725(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123725._instance is None:
            CommutativeMatcher123725._instance = CommutativeMatcher123725()
        return CommutativeMatcher123725._instance
