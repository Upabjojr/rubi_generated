...
class CommutativeMatcher23455(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23455._instance is None:
            CommutativeMatcher23455._instance = CommutativeMatcher23455()
        return CommutativeMatcher23455._instance
