...
class CommutativeMatcher110436(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110436._instance is None:
            CommutativeMatcher110436._instance = CommutativeMatcher110436()
        return CommutativeMatcher110436._instance
