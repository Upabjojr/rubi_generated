...
class CommutativeMatcher22612(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22612._instance is None:
            CommutativeMatcher22612._instance = CommutativeMatcher22612()
        return CommutativeMatcher22612._instance
