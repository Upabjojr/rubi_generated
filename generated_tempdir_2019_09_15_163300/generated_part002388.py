...
class CommutativeMatcher31673(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31673._instance is None:
            CommutativeMatcher31673._instance = CommutativeMatcher31673()
        return CommutativeMatcher31673._instance
