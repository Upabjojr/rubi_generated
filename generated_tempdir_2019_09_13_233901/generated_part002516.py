...
class CommutativeMatcher22216(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22216._instance is None:
            CommutativeMatcher22216._instance = CommutativeMatcher22216()
        return CommutativeMatcher22216._instance
