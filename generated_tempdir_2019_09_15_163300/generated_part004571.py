...
class CommutativeMatcher82723(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher82723._instance is None:
            CommutativeMatcher82723._instance = CommutativeMatcher82723()
        return CommutativeMatcher82723._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher82727.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part004572 import *
from multiset import Multiset