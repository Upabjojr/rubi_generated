...
class CommutativeMatcher31753(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31753._instance is None:
            CommutativeMatcher31753._instance = CommutativeMatcher31753()
        return CommutativeMatcher31753._instance
