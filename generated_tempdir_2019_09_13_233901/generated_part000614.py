...
class CommutativeMatcher42609(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42609._instance is None:
            CommutativeMatcher42609._instance = CommutativeMatcher42609()
        return CommutativeMatcher42609._instance
