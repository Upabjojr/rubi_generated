...
class CommutativeMatcher24264(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher24264._instance is None:
            CommutativeMatcher24264._instance = CommutativeMatcher24264()
        return CommutativeMatcher24264._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher24268.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from .generated_part003874 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset