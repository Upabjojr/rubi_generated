...
class CommutativeMatcher121887(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121887._instance is None:
            CommutativeMatcher121887._instance = CommutativeMatcher121887()
        return CommutativeMatcher121887._instance
