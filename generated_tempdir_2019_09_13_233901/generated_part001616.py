...
class CommutativeMatcher104587(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104587._instance is None:
            CommutativeMatcher104587._instance = CommutativeMatcher104587()
        return CommutativeMatcher104587._instance
