...
class CommutativeMatcher22256(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22256._instance is None:
            CommutativeMatcher22256._instance = CommutativeMatcher22256()
        return CommutativeMatcher22256._instance
