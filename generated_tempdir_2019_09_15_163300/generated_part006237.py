...
class CommutativeMatcher39118(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher39118._instance is None:
            CommutativeMatcher39118._instance = CommutativeMatcher39118()
        return CommutativeMatcher39118._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher39127.get()
                    tmp12 = subjects11
                    subjects11 = []
                    for s in tmp12:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher39134.get()
                tmp15 = subjects14
                subjects14 = []
                for s in tmp15:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects17) >= 1 and isinstance(subjects17[0], Mul):
                    ...
                    matcher = CommutativeMatcher39158.get()
                    tmp31 = subjects30
                    subjects30 = []
                    for s in tmp31:
                        matcher.add_subject(s)
            ...
            if len(subjects17) >= 1 and isinstance(subjects17[0], Add):
                ...
                matcher = CommutativeMatcher39167.get()
                tmp38 = subjects37
                subjects37 = []
                for s in tmp38:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006242 import *
from .generated_part006238 import *
from collections import deque
from .generated_part006239 import *
from .generated_part006241 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset