...
class CommutativeMatcher13407(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13407._instance is None:
            CommutativeMatcher13407._instance = CommutativeMatcher13407()
        return CommutativeMatcher13407._instance
