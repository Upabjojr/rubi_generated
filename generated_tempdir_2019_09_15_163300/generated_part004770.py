...
class CommutativeMatcher123710(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123710._instance is None:
            CommutativeMatcher123710._instance = CommutativeMatcher123710()
        return CommutativeMatcher123710._instance
