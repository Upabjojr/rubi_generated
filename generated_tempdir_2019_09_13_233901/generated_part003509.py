...
class CommutativeMatcher74128(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74128._instance is None:
            CommutativeMatcher74128._instance = CommutativeMatcher74128()
        return CommutativeMatcher74128._instance
