...
class CommutativeMatcher42651(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42651._instance is None:
            CommutativeMatcher42651._instance = CommutativeMatcher42651()
        return CommutativeMatcher42651._instance
