...
class CommutativeMatcher21424(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21424._instance is None:
            CommutativeMatcher21424._instance = CommutativeMatcher21424()
        return CommutativeMatcher21424._instance
