...
class CommutativeMatcher58078(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58078._instance is None:
            CommutativeMatcher58078._instance = CommutativeMatcher58078()
        return CommutativeMatcher58078._instance
