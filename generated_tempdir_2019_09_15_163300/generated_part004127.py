...
class CommutativeMatcher46709(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46709._instance is None:
            CommutativeMatcher46709._instance = CommutativeMatcher46709()
        return CommutativeMatcher46709._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher46717.get()
                    tmp24 = subjects23
                    subjects23 = []
                    for s in tmp24:
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher47531.get()
                    tmp55 = subjects54
                    subjects54 = []
                    for s in tmp55:
                        matcher.add_subject(s)
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher48237.get()
                    tmp73 = subjects72
                    subjects72 = []
                    for s in tmp73:
                        matcher.add_subject(s)
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher46722.get()
                tmp79 = subjects78
                subjects78 = []
                for s in tmp79:
                    matcher.add_subject(s)
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher46735.get()
                tmp111 = subjects110
                subjects110 = []
                for s in tmp111:
                    matcher.add_subject(s)
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher47502.get()
                    tmp124 = subjects123
                    subjects123 = []
                    for s in tmp124:
                        matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher47505.get()
                tmp127 = subjects126
                subjects126 = []
                for s in tmp127:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher46738.get()
            tmp130 = subjects129
            subjects129 = []
            for s in tmp130:
                matcher.add_subject(s)
...
from .generated_part004130 import *
from .generated_part004137 import *
from .generated_part004134 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004135 import *
from .generated_part004128 import *
from .generated_part004129 import *
from collections import deque
from .generated_part004133 import *
from .generated_part004131 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset