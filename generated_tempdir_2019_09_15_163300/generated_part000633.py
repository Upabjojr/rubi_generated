...
class CommutativeMatcher42733(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42733._instance is None:
            CommutativeMatcher42733._instance = CommutativeMatcher42733()
        return CommutativeMatcher42733._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42740.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000634 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset