...
class CommutativeMatcher74446(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74446._instance is None:
            CommutativeMatcher74446._instance = CommutativeMatcher74446()
        return CommutativeMatcher74446._instance
