...
class CommutativeMatcher111864(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111864._instance is None:
            CommutativeMatcher111864._instance = CommutativeMatcher111864()
        return CommutativeMatcher111864._instance
