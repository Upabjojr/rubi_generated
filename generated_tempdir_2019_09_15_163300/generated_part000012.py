...
class CommutativeMatcher41335(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41335._instance is None:
            CommutativeMatcher41335._instance = CommutativeMatcher41335()
        return CommutativeMatcher41335._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher41338.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects8) >= 1 and isinstance(subjects8[0], Add):
                ...
                matcher = CommutativeMatcher41357.get()
                tmp11 = subjects10
                subjects10 = []
                for s in tmp11:
                    matcher.add_subject(s)
