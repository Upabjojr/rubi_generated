...
class CommutativeMatcher22352(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22352._instance is None:
            CommutativeMatcher22352._instance = CommutativeMatcher22352()
        return CommutativeMatcher22352._instance
