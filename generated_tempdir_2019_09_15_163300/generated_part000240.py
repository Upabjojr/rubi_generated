...
class CommutativeMatcher111103(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111103._instance is None:
            CommutativeMatcher111103._instance = CommutativeMatcher111103()
        return CommutativeMatcher111103._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher111112.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000241 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset