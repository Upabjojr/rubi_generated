...
class CommutativeMatcher77820(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77820._instance is None:
            CommutativeMatcher77820._instance = CommutativeMatcher77820()
        return CommutativeMatcher77820._instance
