...
class CommutativeMatcher66888(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher66888._instance is None:
            CommutativeMatcher66888._instance = CommutativeMatcher66888()
        return CommutativeMatcher66888._instance
