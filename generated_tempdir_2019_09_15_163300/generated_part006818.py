...
class CommutativeMatcher114305(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher114305._instance is None:
            CommutativeMatcher114305._instance = CommutativeMatcher114305()
        return CommutativeMatcher114305._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher114566.get()
            tmp3 = subjects2
            subjects2 = []
            for s in tmp3:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects5) >= 1 and isinstance(subjects5[0], Mul):
                    ...
                    matcher = CommutativeMatcher114846.get()
                    tmp13 = subjects12
                    subjects12 = []
                    for s in tmp13:
                        matcher.add_subject(s)
            ...
            if len(subjects5) >= 1 and isinstance(subjects5[0], Add):
                ...
                matcher = CommutativeMatcher114851.get()
                tmp17 = subjects16
                subjects16 = []
                for s in tmp17:
                    matcher.add_subject(s)
...
from .generated_part006822 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part006821 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006819 import *