...
class CommutativeMatcher43178(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43178._instance is None:
            CommutativeMatcher43178._instance = CommutativeMatcher43178()
        return CommutativeMatcher43178._instance
