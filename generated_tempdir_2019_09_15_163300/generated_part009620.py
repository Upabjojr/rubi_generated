...
class CommutativeMatcher140162(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140162._instance is None:
            CommutativeMatcher140162._instance = CommutativeMatcher140162()
        return CommutativeMatcher140162._instance
