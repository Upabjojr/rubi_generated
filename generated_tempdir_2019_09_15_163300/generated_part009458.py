...
class CommutativeMatcher67198(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67198._instance is None:
            CommutativeMatcher67198._instance = CommutativeMatcher67198()
        return CommutativeMatcher67198._instance
