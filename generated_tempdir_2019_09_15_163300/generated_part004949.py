...
class CommutativeMatcher39771(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher39771._instance is None:
            CommutativeMatcher39771._instance = CommutativeMatcher39771()
        return CommutativeMatcher39771._instance
    ...
    def get_match_iter(subject):
        ...
        try:
                ...
                try:
                    ...
                    try:
                        ...
                        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                            ...
                            matcher = CommutativeMatcher39782.get()
                            tmp14 = subjects13
                            subjects13 = []
                            for s in tmp14:
                    ...
                    if len(subjects) >= 1 and isinstance(subjects[0], Add):
                        ...
                        matcher = CommutativeMatcher39789.get()
                        tmp17 = subjects16
                        subjects16 = []
                        for s in tmp17:
                            matcher.add_subject(s)
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                    ...
                    try:
                        ...
                        if len(subjects19) >= 1 and isinstance(subjects19[0], Mul):
                            ...
                            matcher = CommutativeMatcher39813.get()
                            tmp33 = subjects32
                            subjects32 = []
                            for s in tmp33:
                                matcher.add_subject(s)
                    ...
                    if len(subjects19) >= 1 and isinstance(subjects19[0], Add):
                        ...
                        matcher = CommutativeMatcher39822.get()
                        tmp40 = subjects39
                        subjects39 = []
                        for s in tmp40:
                            matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher39839.get()
                tmp47 = subjects46
                subjects46 = []
                for s in tmp47:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    try:
                        ...
                        if len(subjects49) >= 1 and isinstance(subjects49[0], Mul):
                            ...
                            matcher = CommutativeMatcher39917.get()
                            tmp65 = subjects64
                            subjects64 = []
                            for s in tmp65:
                                matcher.add_subject(s)
                    ...
                    if len(subjects49) >= 1 and isinstance(subjects49[0], Add):
                        ...
                        matcher = CommutativeMatcher39926.get()
                        tmp72 = subjects71
                        subjects71 = []
                        for s in tmp72:
                            matcher.add_subject(s)
                ...
                if len(subjects49) >= 1 and isinstance(subjects49[0], Pow):
                    ...
                    try:
                        ...
                        if len(subjects78) >= 1 and isinstance(subjects78[0], Mul):
                            ...
                            matcher = CommutativeMatcher39954.get()
                            tmp98 = subjects97
                            subjects97 = []
                            for s in tmp98:
                                matcher.add_subject(s)
                    ...
                    if len(subjects78) >= 1 and isinstance(subjects78[0], Add):
                        ...
                        matcher = CommutativeMatcher39965.get()
                        tmp111 = subjects110
                        subjects110 = []
                        for s in tmp111:
                            matcher.add_subject(s)
            ...
            if len(subjects49) >= 1 and isinstance(subjects49[0], Mul):
                ...
                matcher = CommutativeMatcher39984.get()
                tmp124 = subjects123
                subjects123 = []
                for s in tmp124:
                    matcher.add_subject(s)
...
from .generated_part004963 import *
from .generated_part004950 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004953 import *
from .generated_part004964 import *
from .generated_part004951 import *
from .generated_part004954 import *
from .generated_part004967 import *
from collections import deque
from .generated_part004956 import *
from .generated_part004969 import *
from .generated_part004966 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset