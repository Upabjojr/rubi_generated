...
class CommutativeMatcher23124(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23124._instance is None:
            CommutativeMatcher23124._instance = CommutativeMatcher23124()
        return CommutativeMatcher23124._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher23130.get()
                    tmp15 = subjects14
                    subjects14 = []
                    for s in tmp15:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher23133.get()
                tmp20 = subjects19
                subjects19 = []
                for s in tmp20:
                    matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher31256.get()
                tmp23 = subjects22
                subjects22 = []
                for s in tmp23:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects25) >= 1 and isinstance(subjects25[0], Mul):
                    ...
                    matcher = CommutativeMatcher23147.get()
                    tmp45 = subjects44
                    subjects44 = []
                    for s in tmp45:
                        matcher.add_subject(s)
            ...
            if len(subjects25) >= 1 and isinstance(subjects25[0], Add):
                ...
                matcher = CommutativeMatcher23152.get()
                tmp63 = subjects62
                subjects62 = []
                for s in tmp63:
                    matcher.add_subject(s)
            ...
            if len(subjects25) >= 1 and isinstance(subjects25[0], Mul):
                ...
                matcher = CommutativeMatcher31282.get()
                tmp82 = subjects81
                subjects81 = []
                for s in tmp82:
                    matcher.add_subject(s)
...
from .generated_part001926 import *
from .generated_part001917 import *
from .generated_part001920 import *
from .generated_part001924 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part001918 import *
from .generated_part001923 import *