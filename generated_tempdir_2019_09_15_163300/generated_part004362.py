...
class CommutativeMatcher106523(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106523._instance is None:
            CommutativeMatcher106523._instance = CommutativeMatcher106523()
        return CommutativeMatcher106523._instance
