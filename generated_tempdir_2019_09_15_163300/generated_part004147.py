...
class CommutativeMatcher46839(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher46839._instance is None:
            CommutativeMatcher46839._instance = CommutativeMatcher46839()
        return CommutativeMatcher46839._instance
