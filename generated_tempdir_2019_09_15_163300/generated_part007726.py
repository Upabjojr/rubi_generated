...
class CommutativeMatcher125523(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125523._instance is None:
            CommutativeMatcher125523._instance = CommutativeMatcher125523()
        return CommutativeMatcher125523._instance
