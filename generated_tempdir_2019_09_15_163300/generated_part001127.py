...
class CommutativeMatcher13180(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13180._instance is None:
            CommutativeMatcher13180._instance = CommutativeMatcher13180()
        return CommutativeMatcher13180._instance
