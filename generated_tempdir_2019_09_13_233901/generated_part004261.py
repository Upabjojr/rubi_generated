...
class CommutativeMatcher120578(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120578._instance is None:
            CommutativeMatcher120578._instance = CommutativeMatcher120578()
        return CommutativeMatcher120578._instance
