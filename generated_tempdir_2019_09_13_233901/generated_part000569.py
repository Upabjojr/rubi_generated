...
class CommutativeMatcher42326(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42326._instance is None:
            CommutativeMatcher42326._instance = CommutativeMatcher42326()
        return CommutativeMatcher42326._instance
