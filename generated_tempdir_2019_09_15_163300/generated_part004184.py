...
class CommutativeMatcher105258(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105258._instance is None:
            CommutativeMatcher105258._instance = CommutativeMatcher105258()
        return CommutativeMatcher105258._instance
