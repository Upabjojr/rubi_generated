...
class CommutativeMatcher42283(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42283._instance is None:
            CommutativeMatcher42283._instance = CommutativeMatcher42283()
        return CommutativeMatcher42283._instance
