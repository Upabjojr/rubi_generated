...
class CommutativeMatcher22799(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22799._instance is None:
            CommutativeMatcher22799._instance = CommutativeMatcher22799()
        return CommutativeMatcher22799._instance
