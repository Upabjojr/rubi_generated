...
class CommutativeMatcher21193(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21193._instance is None:
            CommutativeMatcher21193._instance = CommutativeMatcher21193()
        return CommutativeMatcher21193._instance
