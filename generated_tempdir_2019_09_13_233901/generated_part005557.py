...
class CommutativeMatcher20893(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20893._instance is None:
            CommutativeMatcher20893._instance = CommutativeMatcher20893()
        return CommutativeMatcher20893._instance
