...
class CommutativeMatcher23236(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23236._instance is None:
            CommutativeMatcher23236._instance = CommutativeMatcher23236()
        return CommutativeMatcher23236._instance
