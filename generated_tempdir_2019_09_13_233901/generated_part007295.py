...
class CommutativeMatcher108757(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108757._instance is None:
            CommutativeMatcher108757._instance = CommutativeMatcher108757()
        return CommutativeMatcher108757._instance
