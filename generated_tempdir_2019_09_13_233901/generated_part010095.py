...
class CommutativeMatcher133417(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133417._instance is None:
            CommutativeMatcher133417._instance = CommutativeMatcher133417()
        return CommutativeMatcher133417._instance
