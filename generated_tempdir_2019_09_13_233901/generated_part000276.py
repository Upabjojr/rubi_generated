...
class CommutativeMatcher120748(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120748._instance is None:
            CommutativeMatcher120748._instance = CommutativeMatcher120748()
        return CommutativeMatcher120748._instance
