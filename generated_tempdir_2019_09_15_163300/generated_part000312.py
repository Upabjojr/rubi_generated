...
class CommutativeMatcher149497(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149497._instance is None:
            CommutativeMatcher149497._instance = CommutativeMatcher149497()
        return CommutativeMatcher149497._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher149512.get()
                    tmp20 = subjects19
                    subjects19 = []
                    for s in tmp20:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher149523.get()
                tmp24 = subjects23
                subjects23 = []
                for s in tmp24:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000313 import *
from .generated_part000314 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset