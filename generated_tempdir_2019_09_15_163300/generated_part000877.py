...
class CommutativeMatcher111691(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111691._instance is None:
            CommutativeMatcher111691._instance = CommutativeMatcher111691()
        return CommutativeMatcher111691._instance
