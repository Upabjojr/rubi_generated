...
class CommutativeMatcher20886(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20886._instance is None:
            CommutativeMatcher20886._instance = CommutativeMatcher20886()
        return CommutativeMatcher20886._instance
