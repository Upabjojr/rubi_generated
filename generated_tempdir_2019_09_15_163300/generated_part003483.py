...
class CommutativeMatcher63796(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63796._instance is None:
            CommutativeMatcher63796._instance = CommutativeMatcher63796()
        return CommutativeMatcher63796._instance
