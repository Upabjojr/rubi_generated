...
class CommutativeMatcher111378(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111378._instance is None:
            CommutativeMatcher111378._instance = CommutativeMatcher111378()
        return CommutativeMatcher111378._instance
