...
class CommutativeMatcher122219(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122219._instance is None:
            CommutativeMatcher122219._instance = CommutativeMatcher122219()
        return CommutativeMatcher122219._instance
