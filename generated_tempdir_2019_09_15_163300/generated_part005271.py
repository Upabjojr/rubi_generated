...
class CommutativeMatcher67470(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67470._instance is None:
            CommutativeMatcher67470._instance = CommutativeMatcher67470()
        return CommutativeMatcher67470._instance
