...
class CommutativeMatcher111460(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111460._instance is None:
            CommutativeMatcher111460._instance = CommutativeMatcher111460()
        return CommutativeMatcher111460._instance
