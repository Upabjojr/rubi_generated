...
class CommutativeMatcher60841(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60841._instance is None:
            CommutativeMatcher60841._instance = CommutativeMatcher60841()
        return CommutativeMatcher60841._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher60845.get()
            tmp15 = subjects14
            subjects14 = []
            for s in tmp15:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part003180 import *