...
class CommutativeMatcher126117(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126117._instance is None:
            CommutativeMatcher126117._instance = CommutativeMatcher126117()
        return CommutativeMatcher126117._instance
