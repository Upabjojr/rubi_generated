...
class CommutativeMatcher99503(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher99503._instance is None:
            CommutativeMatcher99503._instance = CommutativeMatcher99503()
        return CommutativeMatcher99503._instance
