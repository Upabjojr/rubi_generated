...
class CommutativeMatcher141437(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141437._instance is None:
            CommutativeMatcher141437._instance = CommutativeMatcher141437()
        return CommutativeMatcher141437._instance
