...
class CommutativeMatcher43158(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43158._instance is None:
            CommutativeMatcher43158._instance = CommutativeMatcher43158()
        return CommutativeMatcher43158._instance
