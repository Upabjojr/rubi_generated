...
class CommutativeMatcher22752(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22752._instance is None:
            CommutativeMatcher22752._instance = CommutativeMatcher22752()
        return CommutativeMatcher22752._instance
