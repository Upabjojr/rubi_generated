...
class CommutativeMatcher41504(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41504._instance is None:
            CommutativeMatcher41504._instance = CommutativeMatcher41504()
        return CommutativeMatcher41504._instance
