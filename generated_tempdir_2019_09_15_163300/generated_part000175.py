...
class CommutativeMatcher41070(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41070._instance is None:
            CommutativeMatcher41070._instance = CommutativeMatcher41070()
        return CommutativeMatcher41070._instance
