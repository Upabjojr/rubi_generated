...
class CommutativeMatcher149650(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149650._instance is None:
            CommutativeMatcher149650._instance = CommutativeMatcher149650()
        return CommutativeMatcher149650._instance
