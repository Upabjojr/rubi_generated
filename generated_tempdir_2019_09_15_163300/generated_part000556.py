...
class CommutativeMatcher42241(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42241._instance is None:
            CommutativeMatcher42241._instance = CommutativeMatcher42241()
        return CommutativeMatcher42241._instance
