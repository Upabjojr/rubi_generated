...
class CommutativeMatcher105178(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105178._instance is None:
            CommutativeMatcher105178._instance = CommutativeMatcher105178()
        return CommutativeMatcher105178._instance
