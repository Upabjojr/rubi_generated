...
class CommutativeMatcher32886(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32886._instance is None:
            CommutativeMatcher32886._instance = CommutativeMatcher32886()
        return CommutativeMatcher32886._instance
