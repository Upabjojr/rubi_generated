...
class CommutativeMatcher62036(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62036._instance is None:
            CommutativeMatcher62036._instance = CommutativeMatcher62036()
        return CommutativeMatcher62036._instance
