...
class CommutativeMatcher141072(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141072._instance is None:
            CommutativeMatcher141072._instance = CommutativeMatcher141072()
        return CommutativeMatcher141072._instance
