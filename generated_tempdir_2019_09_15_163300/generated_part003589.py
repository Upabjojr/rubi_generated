...
class CommutativeMatcher78082(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78082._instance is None:
            CommutativeMatcher78082._instance = CommutativeMatcher78082()
        return CommutativeMatcher78082._instance
