...
class CommutativeMatcher13253(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13253._instance is None:
            CommutativeMatcher13253._instance = CommutativeMatcher13253()
        return CommutativeMatcher13253._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13260.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001235 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset