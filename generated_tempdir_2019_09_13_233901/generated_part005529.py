...
class CommutativeMatcher20783(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20783._instance is None:
            CommutativeMatcher20783._instance = CommutativeMatcher20783()
        return CommutativeMatcher20783._instance
