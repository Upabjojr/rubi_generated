...
class CommutativeMatcher67406(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67406._instance is None:
            CommutativeMatcher67406._instance = CommutativeMatcher67406()
        return CommutativeMatcher67406._instance
