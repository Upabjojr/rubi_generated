...
class CommutativeMatcher146163(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146163._instance is None:
            CommutativeMatcher146163._instance = CommutativeMatcher146163()
        return CommutativeMatcher146163._instance
