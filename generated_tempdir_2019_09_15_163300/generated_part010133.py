...
class CommutativeMatcher53566(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53566._instance is None:
            CommutativeMatcher53566._instance = CommutativeMatcher53566()
        return CommutativeMatcher53566._instance
