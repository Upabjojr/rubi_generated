...
class CommutativeMatcher42340(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42340._instance is None:
            CommutativeMatcher42340._instance = CommutativeMatcher42340()
        return CommutativeMatcher42340._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42347.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000572 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset