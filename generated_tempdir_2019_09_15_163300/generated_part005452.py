...
class CommutativeMatcher121976(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121976._instance is None:
            CommutativeMatcher121976._instance = CommutativeMatcher121976()
        return CommutativeMatcher121976._instance
