...
class CommutativeMatcher30130(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30130._instance is None:
            CommutativeMatcher30130._instance = CommutativeMatcher30130()
        return CommutativeMatcher30130._instance
