...
class CommutativeMatcher21107(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21107._instance is None:
            CommutativeMatcher21107._instance = CommutativeMatcher21107()
        return CommutativeMatcher21107._instance
