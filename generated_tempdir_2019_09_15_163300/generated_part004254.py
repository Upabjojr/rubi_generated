...
class CommutativeMatcher117138(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117138._instance is None:
            CommutativeMatcher117138._instance = CommutativeMatcher117138()
        return CommutativeMatcher117138._instance
