...
class CommutativeMatcher20723(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20723._instance is None:
            CommutativeMatcher20723._instance = CommutativeMatcher20723()
        return CommutativeMatcher20723._instance
