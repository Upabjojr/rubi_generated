...
class CommutativeMatcher49596(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49596._instance is None:
            CommutativeMatcher49596._instance = CommutativeMatcher49596()
        return CommutativeMatcher49596._instance
