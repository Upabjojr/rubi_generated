...
class CommutativeMatcher105802(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105802._instance is None:
            CommutativeMatcher105802._instance = CommutativeMatcher105802()
        return CommutativeMatcher105802._instance
