...
class CommutativeMatcher32857(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32857._instance is None:
            CommutativeMatcher32857._instance = CommutativeMatcher32857()
        return CommutativeMatcher32857._instance
