...
class CommutativeMatcher31615(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31615._instance is None:
            CommutativeMatcher31615._instance = CommutativeMatcher31615()
        return CommutativeMatcher31615._instance
