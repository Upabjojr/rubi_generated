...
class CommutativeMatcher150303(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150303._instance is None:
            CommutativeMatcher150303._instance = CommutativeMatcher150303()
        return CommutativeMatcher150303._instance
