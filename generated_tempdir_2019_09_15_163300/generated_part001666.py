...
class CommutativeMatcher89444(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89444._instance is None:
            CommutativeMatcher89444._instance = CommutativeMatcher89444()
        return CommutativeMatcher89444._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher89451.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001667 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset