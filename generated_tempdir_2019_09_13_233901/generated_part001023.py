...
class CommutativeMatcher9968(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher9968._instance is None:
            CommutativeMatcher9968._instance = CommutativeMatcher9968()
        return CommutativeMatcher9968._instance
