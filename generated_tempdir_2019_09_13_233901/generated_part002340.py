...
class CommutativeMatcher31470(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31470._instance is None:
            CommutativeMatcher31470._instance = CommutativeMatcher31470()
        return CommutativeMatcher31470._instance
