...
class CommutativeMatcher43361(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43361._instance is None:
            CommutativeMatcher43361._instance = CommutativeMatcher43361()
        return CommutativeMatcher43361._instance
