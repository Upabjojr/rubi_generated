...
class CommutativeMatcher145761(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145761._instance is None:
            CommutativeMatcher145761._instance = CommutativeMatcher145761()
        return CommutativeMatcher145761._instance
