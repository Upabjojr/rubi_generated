...
class CommutativeMatcher140171(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140171._instance is None:
            CommutativeMatcher140171._instance = CommutativeMatcher140171()
        return CommutativeMatcher140171._instance
