...
class CommutativeMatcher33709(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33709._instance is None:
            CommutativeMatcher33709._instance = CommutativeMatcher33709()
        return CommutativeMatcher33709._instance
