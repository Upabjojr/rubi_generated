...
class CommutativeMatcher40764(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40764._instance is None:
            CommutativeMatcher40764._instance = CommutativeMatcher40764()
        return CommutativeMatcher40764._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher40771.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part000140 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset