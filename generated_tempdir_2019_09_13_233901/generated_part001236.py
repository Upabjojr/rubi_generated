...
class CommutativeMatcher68760(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher68760._instance is None:
            CommutativeMatcher68760._instance = CommutativeMatcher68760()
        return CommutativeMatcher68760._instance
