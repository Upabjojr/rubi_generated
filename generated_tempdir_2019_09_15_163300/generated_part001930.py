...
class CommutativeMatcher23171(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23171._instance is None:
            CommutativeMatcher23171._instance = CommutativeMatcher23171()
        return CommutativeMatcher23171._instance
