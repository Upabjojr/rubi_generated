...
class CommutativeMatcher49553(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49553._instance is None:
            CommutativeMatcher49553._instance = CommutativeMatcher49553()
        return CommutativeMatcher49553._instance
