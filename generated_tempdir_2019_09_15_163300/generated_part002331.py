...
class CommutativeMatcher23273(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23273._instance is None:
            CommutativeMatcher23273._instance = CommutativeMatcher23273()
        return CommutativeMatcher23273._instance
