...
class CommutativeMatcher65622(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65622._instance is None:
            CommutativeMatcher65622._instance = CommutativeMatcher65622()
        return CommutativeMatcher65622._instance
