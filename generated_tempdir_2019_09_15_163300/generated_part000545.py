...
class CommutativeMatcher42159(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42159._instance is None:
            CommutativeMatcher42159._instance = CommutativeMatcher42159()
        return CommutativeMatcher42159._instance
