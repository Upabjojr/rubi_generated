...
class CommutativeMatcher60258(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60258._instance is None:
            CommutativeMatcher60258._instance = CommutativeMatcher60258()
        return CommutativeMatcher60258._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1:
                ...
                subst2 = Substitution(subst1)
                try:
                    subst2.try_add_variable('i2.4.1.0', tmp14)
                except ValueError:
                    pass
                else:
                    pass
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher60262.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from .generated_part004989 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset