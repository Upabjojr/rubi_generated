...
class CommutativeMatcher40623(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40623._instance is None:
            CommutativeMatcher40623._instance = CommutativeMatcher40623()
        return CommutativeMatcher40623._instance
