...
class CommutativeMatcher120896(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120896._instance is None:
            CommutativeMatcher120896._instance = CommutativeMatcher120896()
        return CommutativeMatcher120896._instance
