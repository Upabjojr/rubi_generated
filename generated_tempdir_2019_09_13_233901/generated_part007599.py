...
class CommutativeMatcher53987(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53987._instance is None:
            CommutativeMatcher53987._instance = CommutativeMatcher53987()
        return CommutativeMatcher53987._instance
