...
class CommutativeMatcher25963(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25963._instance is None:
            CommutativeMatcher25963._instance = CommutativeMatcher25963()
        return CommutativeMatcher25963._instance
