...
class CommutativeMatcher50668(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher50668._instance is None:
            CommutativeMatcher50668._instance = CommutativeMatcher50668()
        return CommutativeMatcher50668._instance
    ...
    def get_match_iter(subject):
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                        ...
                        matcher = CommutativeMatcher52729.get()
                        tmp14 = subjects13
                        subjects13 = []
                        for s in tmp14:
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Add):
                    ...
                    matcher = CommutativeMatcher52734.get()
                    tmp18 = subjects17
                    subjects17 = []
                    for s in tmp18:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher50675.get()
            tmp22 = subjects21
            subjects21 = []
            for s in tmp22:
                matcher.add_subject(s)
...
from .generated_part009513 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009515 import *
from .generated_part009512 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset