...
class CommutativeMatcher52193(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher52193._instance is None:
            CommutativeMatcher52193._instance = CommutativeMatcher52193()
        return CommutativeMatcher52193._instance
    ...
    def get_match_iter(subject):
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                        ...
                        matcher = CommutativeMatcher52202.get()
                        tmp11 = subjects10
                        subjects10 = []
                        for s in tmp11:
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Add):
                    ...
                    matcher = CommutativeMatcher52207.get()
                    tmp15 = subjects14
                    subjects14 = []
                    for s in tmp15:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher52217.get()
            tmp19 = subjects18
            subjects18 = []
            for s in tmp19:
                matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001476 import *
from .generated_part001475 import *
from .generated_part001478 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset