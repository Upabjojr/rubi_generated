...
class CommutativeMatcher42602(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42602._instance is None:
            CommutativeMatcher42602._instance = CommutativeMatcher42602()
        return CommutativeMatcher42602._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42609.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000614 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset