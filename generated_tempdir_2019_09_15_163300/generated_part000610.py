...
class CommutativeMatcher42580(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42580._instance is None:
            CommutativeMatcher42580._instance = CommutativeMatcher42580()
        return CommutativeMatcher42580._instance
