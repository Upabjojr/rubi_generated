...
class CommutativeMatcher62010(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62010._instance is None:
            CommutativeMatcher62010._instance = CommutativeMatcher62010()
        return CommutativeMatcher62010._instance
