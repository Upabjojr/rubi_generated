...
class CommutativeMatcher23033(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23033._instance is None:
            CommutativeMatcher23033._instance = CommutativeMatcher23033()
        return CommutativeMatcher23033._instance
