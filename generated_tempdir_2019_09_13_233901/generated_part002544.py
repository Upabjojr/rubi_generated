...
class CommutativeMatcher22320(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22320._instance is None:
            CommutativeMatcher22320._instance = CommutativeMatcher22320()
        return CommutativeMatcher22320._instance
