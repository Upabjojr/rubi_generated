...
class CommutativeMatcher21830(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21830._instance is None:
            CommutativeMatcher21830._instance = CommutativeMatcher21830()
        return CommutativeMatcher21830._instance
