...
class CommutativeMatcher13801(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13801._instance is None:
            CommutativeMatcher13801._instance = CommutativeMatcher13801()
        return CommutativeMatcher13801._instance
