...
class CommutativeMatcher141154(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141154._instance is None:
            CommutativeMatcher141154._instance = CommutativeMatcher141154()
        return CommutativeMatcher141154._instance
