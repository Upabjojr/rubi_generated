...
class CommutativeMatcher125452(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher125452._instance is None:
            CommutativeMatcher125452._instance = CommutativeMatcher125452()
        return CommutativeMatcher125452._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects5) >= 1 and isinstance(subjects5[0], Add):
                ...
                matcher = CommutativeMatcher137036.get()
                tmp13 = subjects12
                subjects12 = []
                for s in tmp13:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects18) >= 1 and isinstance(subjects18[0], Mul):
                ...
                matcher = CommutativeMatcher134402.get()
                tmp32 = subjects31
                subjects31 = []
                for s in tmp32:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004292 import *
from collections import deque
from .generated_part004290 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset