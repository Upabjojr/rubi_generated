...
class CommutativeMatcher33653(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33653._instance is None:
            CommutativeMatcher33653._instance = CommutativeMatcher33653()
        return CommutativeMatcher33653._instance
