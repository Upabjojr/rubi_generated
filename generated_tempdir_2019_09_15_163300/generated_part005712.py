...
class CommutativeMatcher126515(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126515._instance is None:
            CommutativeMatcher126515._instance = CommutativeMatcher126515()
        return CommutativeMatcher126515._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher126519.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005713 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset