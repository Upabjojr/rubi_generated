...
class CommutativeMatcher33028(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33028._instance is None:
            CommutativeMatcher33028._instance = CommutativeMatcher33028()
        return CommutativeMatcher33028._instance
