...
class CommutativeMatcher140856(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140856._instance is None:
            CommutativeMatcher140856._instance = CommutativeMatcher140856()
        return CommutativeMatcher140856._instance
