...
class CommutativeMatcher30987(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30987._instance is None:
            CommutativeMatcher30987._instance = CommutativeMatcher30987()
        return CommutativeMatcher30987._instance
