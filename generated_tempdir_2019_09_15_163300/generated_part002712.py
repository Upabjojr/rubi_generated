...
class CommutativeMatcher30586(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30586._instance is None:
            CommutativeMatcher30586._instance = CommutativeMatcher30586()
        return CommutativeMatcher30586._instance
