...
class CommutativeMatcher30471(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30471._instance is None:
            CommutativeMatcher30471._instance = CommutativeMatcher30471()
        return CommutativeMatcher30471._instance
