...
class CommutativeMatcher126053(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126053._instance is None:
            CommutativeMatcher126053._instance = CommutativeMatcher126053()
        return CommutativeMatcher126053._instance
