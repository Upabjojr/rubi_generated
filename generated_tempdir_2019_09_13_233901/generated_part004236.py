...
class CommutativeMatcher111789(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111789._instance is None:
            CommutativeMatcher111789._instance = CommutativeMatcher111789()
        return CommutativeMatcher111789._instance
