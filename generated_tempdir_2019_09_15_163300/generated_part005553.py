...
class CommutativeMatcher32050(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32050._instance is None:
            CommutativeMatcher32050._instance = CommutativeMatcher32050()
        return CommutativeMatcher32050._instance
