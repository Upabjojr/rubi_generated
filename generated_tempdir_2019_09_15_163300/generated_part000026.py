...
class CommutativeMatcher41473(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41473._instance is None:
            CommutativeMatcher41473._instance = CommutativeMatcher41473()
        return CommutativeMatcher41473._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    if len(subjects) >= 1 and isinstance(subjects[0], Add):
                        ...
                        matcher = CommutativeMatcher41478.get()
                        tmp6 = subjects5
                        subjects5 = []
                        for s in tmp6:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                    ...
                    if len(subjects10) >= 1 and isinstance(subjects10[0], Add):
                        ...
                        matcher = CommutativeMatcher41497.get()
                        tmp13 = subjects12
                        subjects12 = []
                        for s in tmp13:
                            matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher41517.get()
                tmp25 = subjects24
                subjects24 = []
                for s in tmp25:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                try:
                    ...
                    if len(subjects27) >= 1 and isinstance(subjects27[0], Add):
                        ...
                        matcher = CommutativeMatcher41563.get()
                        tmp32 = subjects31
                        subjects31 = []
                        for s in tmp32:
                            matcher.add_subject(s)
                ...
                if len(subjects27) >= 1 and isinstance(subjects27[0], Pow):
                    ...
                    if len(subjects43) >= 1 and isinstance(subjects43[0], Add):
                        ...
                        matcher = CommutativeMatcher41584.get()
                        tmp46 = subjects45
                        subjects45 = []
                        for s in tmp46:
                            matcher.add_subject(s)
            ...
            if len(subjects27) >= 1 and isinstance(subjects27[0], Mul):
                ...
                matcher = CommutativeMatcher41606.get()
                tmp70 = subjects69
                subjects69 = []
                for s in tmp70:
                    matcher.add_subject(s)
...
from .generated_part000027 import *
from .generated_part000029 import *
from .generated_part000040 import *
from .generated_part000036 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000038 import *
from collections import deque
from .generated_part000031 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset