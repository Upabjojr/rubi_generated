...
class CommutativeMatcher146443(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146443._instance is None:
            CommutativeMatcher146443._instance = CommutativeMatcher146443()
        return CommutativeMatcher146443._instance
