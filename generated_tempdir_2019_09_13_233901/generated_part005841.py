...
class CommutativeMatcher79181(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79181._instance is None:
            CommutativeMatcher79181._instance = CommutativeMatcher79181()
        return CommutativeMatcher79181._instance
