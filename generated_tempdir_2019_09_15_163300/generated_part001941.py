...
class CommutativeMatcher31354(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31354._instance is None:
            CommutativeMatcher31354._instance = CommutativeMatcher31354()
        return CommutativeMatcher31354._instance
