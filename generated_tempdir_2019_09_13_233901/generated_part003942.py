...
class CommutativeMatcher65998(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65998._instance is None:
            CommutativeMatcher65998._instance = CommutativeMatcher65998()
        return CommutativeMatcher65998._instance
