...
class CommutativeMatcher129325(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129325._instance is None:
            CommutativeMatcher129325._instance = CommutativeMatcher129325()
        return CommutativeMatcher129325._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129329.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001844 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset