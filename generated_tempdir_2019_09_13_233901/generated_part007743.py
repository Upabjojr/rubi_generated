...
class CommutativeMatcher131916(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher131916._instance is None:
            CommutativeMatcher131916._instance = CommutativeMatcher131916()
        return CommutativeMatcher131916._instance
