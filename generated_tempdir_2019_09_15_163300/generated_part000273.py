...
class CommutativeMatcher120356(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120356._instance is None:
            CommutativeMatcher120356._instance = CommutativeMatcher120356()
        return CommutativeMatcher120356._instance
