...
class CommutativeMatcher121849(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121849._instance is None:
            CommutativeMatcher121849._instance = CommutativeMatcher121849()
        return CommutativeMatcher121849._instance
