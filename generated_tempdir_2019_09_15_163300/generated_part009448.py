...
class CommutativeMatcher13459(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13459._instance is None:
            CommutativeMatcher13459._instance = CommutativeMatcher13459()
        return CommutativeMatcher13459._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13466.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part009449 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset