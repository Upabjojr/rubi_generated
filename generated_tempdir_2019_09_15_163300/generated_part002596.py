...
class CommutativeMatcher22481(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22481._instance is None:
            CommutativeMatcher22481._instance = CommutativeMatcher22481()
        return CommutativeMatcher22481._instance
