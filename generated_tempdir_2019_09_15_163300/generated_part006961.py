...
class CommutativeMatcher111891(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111891._instance is None:
            CommutativeMatcher111891._instance = CommutativeMatcher111891()
        return CommutativeMatcher111891._instance
