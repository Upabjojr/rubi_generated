...
class CommutativeMatcher30642(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30642._instance is None:
            CommutativeMatcher30642._instance = CommutativeMatcher30642()
        return CommutativeMatcher30642._instance
