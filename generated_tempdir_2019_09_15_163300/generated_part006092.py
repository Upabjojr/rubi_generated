...
class CommutativeMatcher38606(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher38606._instance is None:
            CommutativeMatcher38606._instance = CommutativeMatcher38606()
        return CommutativeMatcher38606._instance
    ...
    def get_match_iter(subject):
        ...
        try:
                ...
                try:
                    ...
                    try:
                        ...
                        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                            ...
                            matcher = CommutativeMatcher38617.get()
                            tmp14 = subjects13
                            subjects13 = []
                            for s in tmp14:
                    ...
                    if len(subjects) >= 1 and isinstance(subjects[0], Add):
                        ...
                        matcher = CommutativeMatcher38624.get()
                        tmp17 = subjects16
                        subjects16 = []
                        for s in tmp17:
                            matcher.add_subject(s)
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                    ...
                    try:
                        ...
                        if len(subjects19) >= 1 and isinstance(subjects19[0], Mul):
                            ...
                            matcher = CommutativeMatcher38648.get()
                            tmp33 = subjects32
                            subjects32 = []
                            for s in tmp33:
                                matcher.add_subject(s)
                    ...
                    if len(subjects19) >= 1 and isinstance(subjects19[0], Add):
                        ...
                        matcher = CommutativeMatcher38657.get()
                        tmp40 = subjects39
                        subjects39 = []
                        for s in tmp40:
                            matcher.add_subject(s)
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                ...
                matcher = CommutativeMatcher38674.get()
                tmp47 = subjects46
                subjects46 = []
                for s in tmp47:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    try:
                        ...
                        if len(subjects49) >= 1 and isinstance(subjects49[0], Mul):
                            ...
                            matcher = CommutativeMatcher38752.get()
                            tmp65 = subjects64
                            subjects64 = []
                            for s in tmp65:
                                matcher.add_subject(s)
                    ...
                    if len(subjects49) >= 1 and isinstance(subjects49[0], Add):
                        ...
                        matcher = CommutativeMatcher38761.get()
                        tmp72 = subjects71
                        subjects71 = []
                        for s in tmp72:
                            matcher.add_subject(s)
                ...
                if len(subjects49) >= 1 and isinstance(subjects49[0], Pow):
                    ...
                    try:
                        ...
                        if len(subjects78) >= 1 and isinstance(subjects78[0], Mul):
                            ...
                            matcher = CommutativeMatcher38789.get()
                            tmp98 = subjects97
                            subjects97 = []
                            for s in tmp98:
                                matcher.add_subject(s)
                    ...
                    if len(subjects78) >= 1 and isinstance(subjects78[0], Add):
                        ...
                        matcher = CommutativeMatcher38800.get()
                        tmp111 = subjects110
                        subjects110 = []
                        for s in tmp111:
                            matcher.add_subject(s)
            ...
            if len(subjects49) >= 1 and isinstance(subjects49[0], Mul):
                ...
                matcher = CommutativeMatcher38819.get()
                tmp124 = subjects123
                subjects123 = []
                for s in tmp124:
                    matcher.add_subject(s)
...
from .generated_part006110 import *
from .generated_part006097 import *
from .generated_part006106 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006107 import *
from .generated_part006112 import *
from collections import deque
from .generated_part006096 import *
from .generated_part006109 import *
from .generated_part006093 import *
from .generated_part006099 import *
from .generated_part006094 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset