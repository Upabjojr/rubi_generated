...
class CommutativeMatcher121968(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121968._instance is None:
            CommutativeMatcher121968._instance = CommutativeMatcher121968()
        return CommutativeMatcher121968._instance
