...
class CommutativeMatcher41999(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41999._instance is None:
            CommutativeMatcher41999._instance = CommutativeMatcher41999()
        return CommutativeMatcher41999._instance
