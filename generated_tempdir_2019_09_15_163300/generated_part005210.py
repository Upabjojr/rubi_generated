...
class CommutativeMatcher12642(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12642._instance is None:
            CommutativeMatcher12642._instance = CommutativeMatcher12642()
        return CommutativeMatcher12642._instance
