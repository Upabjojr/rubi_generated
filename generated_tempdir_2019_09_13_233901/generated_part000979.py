...
class CommutativeMatcher140974(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140974._instance is None:
            CommutativeMatcher140974._instance = CommutativeMatcher140974()
        return CommutativeMatcher140974._instance
