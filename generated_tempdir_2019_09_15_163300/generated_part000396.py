...
class CommutativeMatcher43121(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43121._instance is None:
            CommutativeMatcher43121._instance = CommutativeMatcher43121()
        return CommutativeMatcher43121._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43128.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part000397 import *