...
class CommutativeMatcher111089(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111089._instance is None:
            CommutativeMatcher111089._instance = CommutativeMatcher111089()
        return CommutativeMatcher111089._instance
