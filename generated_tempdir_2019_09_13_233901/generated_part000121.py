...
class CommutativeMatcher40578(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40578._instance is None:
            CommutativeMatcher40578._instance = CommutativeMatcher40578()
        return CommutativeMatcher40578._instance
