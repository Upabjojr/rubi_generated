...
class CommutativeMatcher65974(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65974._instance is None:
            CommutativeMatcher65974._instance = CommutativeMatcher65974()
        return CommutativeMatcher65974._instance
