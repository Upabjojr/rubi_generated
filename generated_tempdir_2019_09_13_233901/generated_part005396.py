...
class CommutativeMatcher33683(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33683._instance is None:
            CommutativeMatcher33683._instance = CommutativeMatcher33683()
        return CommutativeMatcher33683._instance
