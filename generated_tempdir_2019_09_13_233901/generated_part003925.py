...
class CommutativeMatcher142699(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142699._instance is None:
            CommutativeMatcher142699._instance = CommutativeMatcher142699()
        return CommutativeMatcher142699._instance
