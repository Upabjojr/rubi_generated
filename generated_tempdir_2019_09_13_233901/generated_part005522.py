...
class CommutativeMatcher20761(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20761._instance is None:
            CommutativeMatcher20761._instance = CommutativeMatcher20761()
        return CommutativeMatcher20761._instance
