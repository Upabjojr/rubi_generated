...
class CommutativeMatcher32971(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32971._instance is None:
            CommutativeMatcher32971._instance = CommutativeMatcher32971()
        return CommutativeMatcher32971._instance
