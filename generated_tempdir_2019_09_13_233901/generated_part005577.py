...
class CommutativeMatcher32143(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32143._instance is None:
            CommutativeMatcher32143._instance = CommutativeMatcher32143()
        return CommutativeMatcher32143._instance
