...
class CommutativeMatcher22735(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22735._instance is None:
            CommutativeMatcher22735._instance = CommutativeMatcher22735()
        return CommutativeMatcher22735._instance
