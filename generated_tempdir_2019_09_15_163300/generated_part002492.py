...
class CommutativeMatcher81289(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81289._instance is None:
            CommutativeMatcher81289._instance = CommutativeMatcher81289()
        return CommutativeMatcher81289._instance
