...
class CommutativeMatcher21034(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21034._instance is None:
            CommutativeMatcher21034._instance = CommutativeMatcher21034()
        return CommutativeMatcher21034._instance
