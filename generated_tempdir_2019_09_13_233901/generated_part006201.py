...
class CommutativeMatcher64155(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64155._instance is None:
            CommutativeMatcher64155._instance = CommutativeMatcher64155()
        return CommutativeMatcher64155._instance
