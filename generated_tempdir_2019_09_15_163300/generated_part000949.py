...
class CommutativeMatcher116571(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116571._instance is None:
            CommutativeMatcher116571._instance = CommutativeMatcher116571()
        return CommutativeMatcher116571._instance
