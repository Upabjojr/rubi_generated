...
class CommutativeMatcher139990(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher139990._instance is None:
            CommutativeMatcher139990._instance = CommutativeMatcher139990()
        return CommutativeMatcher139990._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher139994.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001113 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset