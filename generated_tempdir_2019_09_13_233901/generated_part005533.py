...
class CommutativeMatcher20793(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20793._instance is None:
            CommutativeMatcher20793._instance = CommutativeMatcher20793()
        return CommutativeMatcher20793._instance
