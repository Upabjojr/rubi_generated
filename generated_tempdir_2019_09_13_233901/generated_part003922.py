...
class CommutativeMatcher138406(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138406._instance is None:
            CommutativeMatcher138406._instance = CommutativeMatcher138406()
        return CommutativeMatcher138406._instance
