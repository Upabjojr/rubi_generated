...
class CommutativeMatcher65039(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65039._instance is None:
            CommutativeMatcher65039._instance = CommutativeMatcher65039()
        return CommutativeMatcher65039._instance
