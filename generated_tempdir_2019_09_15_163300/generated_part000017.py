...
class CommutativeMatcher41382(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41382._instance is None:
            CommutativeMatcher41382._instance = CommutativeMatcher41382()
        return CommutativeMatcher41382._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41389.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
