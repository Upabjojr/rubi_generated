...
class CommutativeMatcher126043(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126043._instance is None:
            CommutativeMatcher126043._instance = CommutativeMatcher126043()
        return CommutativeMatcher126043._instance
