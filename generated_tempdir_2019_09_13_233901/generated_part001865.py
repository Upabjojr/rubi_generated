...
class CommutativeMatcher22959(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22959._instance is None:
            CommutativeMatcher22959._instance = CommutativeMatcher22959()
        return CommutativeMatcher22959._instance
