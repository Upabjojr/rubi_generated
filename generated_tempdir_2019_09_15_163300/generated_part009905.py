...
class CommutativeMatcher105822(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105822._instance is None:
            CommutativeMatcher105822._instance = CommutativeMatcher105822()
        return CommutativeMatcher105822._instance
