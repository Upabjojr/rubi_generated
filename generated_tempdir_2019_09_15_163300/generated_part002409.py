...
class CommutativeMatcher23527(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23527._instance is None:
            CommutativeMatcher23527._instance = CommutativeMatcher23527()
        return CommutativeMatcher23527._instance
