...
class CommutativeMatcher43384(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43384._instance is None:
            CommutativeMatcher43384._instance = CommutativeMatcher43384()
        return CommutativeMatcher43384._instance
