...
class CommutativeMatcher21578(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21578._instance is None:
            CommutativeMatcher21578._instance = CommutativeMatcher21578()
        return CommutativeMatcher21578._instance
