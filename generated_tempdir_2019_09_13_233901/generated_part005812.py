...
class CommutativeMatcher21392(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21392._instance is None:
            CommutativeMatcher21392._instance = CommutativeMatcher21392()
        return CommutativeMatcher21392._instance
