...
class CommutativeMatcher133870(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133870._instance is None:
            CommutativeMatcher133870._instance = CommutativeMatcher133870()
        return CommutativeMatcher133870._instance
        ...
        try:
            ...
            if len(subjects) >= 1:
                ...
                try:
                    ...
                    if len(subjects) == 0:
                        pass
                        # 0: RFx**p /; (cons_f2) and (cons_f3) and (cons_f8) and (cons_f4) and (cons_f1879)
                        yield 0, subst2
