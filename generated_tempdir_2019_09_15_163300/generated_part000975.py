...
class CommutativeMatcher140922(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140922._instance is None:
            CommutativeMatcher140922._instance = CommutativeMatcher140922()
        return CommutativeMatcher140922._instance
