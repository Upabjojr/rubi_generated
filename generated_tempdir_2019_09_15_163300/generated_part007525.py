...
class CommutativeMatcher77606(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77606._instance is None:
            CommutativeMatcher77606._instance = CommutativeMatcher77606()
        return CommutativeMatcher77606._instance
