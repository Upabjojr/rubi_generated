...
class CommutativeMatcher129014(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129014._instance is None:
            CommutativeMatcher129014._instance = CommutativeMatcher129014()
        return CommutativeMatcher129014._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher129021.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part010112 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset