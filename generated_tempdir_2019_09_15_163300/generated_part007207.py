...
class CommutativeMatcher49538(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49538._instance is None:
            CommutativeMatcher49538._instance = CommutativeMatcher49538()
        return CommutativeMatcher49538._instance
