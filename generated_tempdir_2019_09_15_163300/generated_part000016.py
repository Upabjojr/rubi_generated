...
class CommutativeMatcher41364(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41364._instance is None:
            CommutativeMatcher41364._instance = CommutativeMatcher41364()
        return CommutativeMatcher41364._instance
