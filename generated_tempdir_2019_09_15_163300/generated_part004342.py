...
class CommutativeMatcher149734(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149734._instance is None:
            CommutativeMatcher149734._instance = CommutativeMatcher149734()
        return CommutativeMatcher149734._instance
