...
class CommutativeMatcher30330(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30330._instance is None:
            CommutativeMatcher30330._instance = CommutativeMatcher30330()
        return CommutativeMatcher30330._instance
