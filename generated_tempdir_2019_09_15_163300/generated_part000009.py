...
class CommutativeMatcher41301(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41301._instance is None:
            CommutativeMatcher41301._instance = CommutativeMatcher41301()
        return CommutativeMatcher41301._instance
