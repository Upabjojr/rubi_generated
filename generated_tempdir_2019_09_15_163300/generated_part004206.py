...
class CommutativeMatcher105157(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105157._instance is None:
            CommutativeMatcher105157._instance = CommutativeMatcher105157()
        return CommutativeMatcher105157._instance
