...
class CommutativeMatcher135403(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135403._instance is None:
            CommutativeMatcher135403._instance = CommutativeMatcher135403()
        return CommutativeMatcher135403._instance
