...
class CommutativeMatcher126016(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126016._instance is None:
            CommutativeMatcher126016._instance = CommutativeMatcher126016()
        return CommutativeMatcher126016._instance
