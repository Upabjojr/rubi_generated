...
class CommutativeMatcher43485(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43485._instance is None:
            CommutativeMatcher43485._instance = CommutativeMatcher43485()
        return CommutativeMatcher43485._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher43492.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000516 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset