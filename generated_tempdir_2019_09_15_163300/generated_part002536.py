...
class CommutativeMatcher22282(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22282._instance is None:
            CommutativeMatcher22282._instance = CommutativeMatcher22282()
        return CommutativeMatcher22282._instance
