...
class CommutativeMatcher92676(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher92676._instance is None:
            CommutativeMatcher92676._instance = CommutativeMatcher92676()
        return CommutativeMatcher92676._instance
