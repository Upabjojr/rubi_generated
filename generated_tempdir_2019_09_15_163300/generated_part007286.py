...
class CommutativeMatcher58594(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58594._instance is None:
            CommutativeMatcher58594._instance = CommutativeMatcher58594()
        return CommutativeMatcher58594._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher58598.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part007287 import *