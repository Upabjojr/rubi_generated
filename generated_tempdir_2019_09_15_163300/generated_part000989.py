...
class CommutativeMatcher145786(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145786._instance is None:
            CommutativeMatcher145786._instance = CommutativeMatcher145786()
        return CommutativeMatcher145786._instance
