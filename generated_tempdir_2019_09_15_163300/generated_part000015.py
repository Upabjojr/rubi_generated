...
class CommutativeMatcher41357(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41357._instance is None:
            CommutativeMatcher41357._instance = CommutativeMatcher41357()
        return CommutativeMatcher41357._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41364.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
