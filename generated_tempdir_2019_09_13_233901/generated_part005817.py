...
class CommutativeMatcher32738(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32738._instance is None:
            CommutativeMatcher32738._instance = CommutativeMatcher32738()
        return CommutativeMatcher32738._instance
