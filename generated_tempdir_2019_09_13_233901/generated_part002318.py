...
class CommutativeMatcher126067(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126067._instance is None:
            CommutativeMatcher126067._instance = CommutativeMatcher126067()
        return CommutativeMatcher126067._instance
