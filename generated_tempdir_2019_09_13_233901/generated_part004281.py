...
class CommutativeMatcher134323(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134323._instance is None:
            CommutativeMatcher134323._instance = CommutativeMatcher134323()
        return CommutativeMatcher134323._instance
