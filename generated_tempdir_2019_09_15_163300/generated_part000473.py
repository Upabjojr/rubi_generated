...
class CommutativeMatcher43202(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43202._instance is None:
            CommutativeMatcher43202._instance = CommutativeMatcher43202()
        return CommutativeMatcher43202._instance
