...
class CommutativeMatcher43268(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43268._instance is None:
            CommutativeMatcher43268._instance = CommutativeMatcher43268()
        return CommutativeMatcher43268._instance
