...
class CommutativeMatcher146261(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146261._instance is None:
            CommutativeMatcher146261._instance = CommutativeMatcher146261()
        return CommutativeMatcher146261._instance
