...
class CommutativeMatcher97890(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher97890._instance is None:
            CommutativeMatcher97890._instance = CommutativeMatcher97890()
        return CommutativeMatcher97890._instance
