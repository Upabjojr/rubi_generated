...
class CommutativeMatcher21059(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21059._instance is None:
            CommutativeMatcher21059._instance = CommutativeMatcher21059()
        return CommutativeMatcher21059._instance
