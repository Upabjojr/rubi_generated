...
class CommutativeMatcher99549(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher99549._instance is None:
            CommutativeMatcher99549._instance = CommutativeMatcher99549()
        return CommutativeMatcher99549._instance
