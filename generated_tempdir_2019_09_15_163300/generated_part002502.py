...
class CommutativeMatcher126438(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126438._instance is None:
            CommutativeMatcher126438._instance = CommutativeMatcher126438()
        return CommutativeMatcher126438._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher126442.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part002503 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset