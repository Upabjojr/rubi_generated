...
class CommutativeMatcher135376(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135376._instance is None:
            CommutativeMatcher135376._instance = CommutativeMatcher135376()
        return CommutativeMatcher135376._instance
