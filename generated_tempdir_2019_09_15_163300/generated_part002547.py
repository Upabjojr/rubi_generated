...
class CommutativeMatcher30215(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30215._instance is None:
            CommutativeMatcher30215._instance = CommutativeMatcher30215()
        return CommutativeMatcher30215._instance
