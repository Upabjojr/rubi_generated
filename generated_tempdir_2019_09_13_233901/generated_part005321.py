...
class CommutativeMatcher21918(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21918._instance is None:
            CommutativeMatcher21918._instance = CommutativeMatcher21918()
        return CommutativeMatcher21918._instance
