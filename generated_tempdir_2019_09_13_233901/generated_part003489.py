...
class CommutativeMatcher64075(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64075._instance is None:
            CommutativeMatcher64075._instance = CommutativeMatcher64075()
        return CommutativeMatcher64075._instance
