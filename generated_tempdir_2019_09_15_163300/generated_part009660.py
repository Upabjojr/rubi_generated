...
class CommutativeMatcher67271(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67271._instance is None:
            CommutativeMatcher67271._instance = CommutativeMatcher67271()
        return CommutativeMatcher67271._instance
