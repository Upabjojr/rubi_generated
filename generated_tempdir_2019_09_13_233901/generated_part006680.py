...
class CommutativeMatcher128973(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128973._instance is None:
            CommutativeMatcher128973._instance = CommutativeMatcher128973()
        return CommutativeMatcher128973._instance
