...
class CommutativeMatcher77657(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77657._instance is None:
            CommutativeMatcher77657._instance = CommutativeMatcher77657()
        return CommutativeMatcher77657._instance
