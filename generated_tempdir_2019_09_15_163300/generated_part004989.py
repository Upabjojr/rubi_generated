...
class CommutativeMatcher60262(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60262._instance is None:
            CommutativeMatcher60262._instance = CommutativeMatcher60262()
        return CommutativeMatcher60262._instance
