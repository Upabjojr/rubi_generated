...
class CommutativeMatcher12678(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12678._instance is None:
            CommutativeMatcher12678._instance = CommutativeMatcher12678()
        return CommutativeMatcher12678._instance
