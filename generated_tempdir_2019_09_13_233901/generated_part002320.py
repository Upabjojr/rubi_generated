...
class CommutativeMatcher126077(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126077._instance is None:
            CommutativeMatcher126077._instance = CommutativeMatcher126077()
        return CommutativeMatcher126077._instance
