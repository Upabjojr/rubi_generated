...
class CommutativeMatcher78615(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78615._instance is None:
            CommutativeMatcher78615._instance = CommutativeMatcher78615()
        return CommutativeMatcher78615._instance
