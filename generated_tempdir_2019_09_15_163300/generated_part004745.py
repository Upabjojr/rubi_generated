...
class CommutativeMatcher58468(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58468._instance is None:
            CommutativeMatcher58468._instance = CommutativeMatcher58468()
        return CommutativeMatcher58468._instance
