...
class CommutativeMatcher42085(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42085._instance is None:
            CommutativeMatcher42085._instance = CommutativeMatcher42085()
        return CommutativeMatcher42085._instance
