...
class CommutativeMatcher136041(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136041._instance is None:
            CommutativeMatcher136041._instance = CommutativeMatcher136041()
        return CommutativeMatcher136041._instance
