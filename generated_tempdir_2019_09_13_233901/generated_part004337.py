...
class CommutativeMatcher146385(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146385._instance is None:
            CommutativeMatcher146385._instance = CommutativeMatcher146385()
        return CommutativeMatcher146385._instance
