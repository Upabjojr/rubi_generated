...
class CommutativeMatcher54011(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher54011._instance is None:
            CommutativeMatcher54011._instance = CommutativeMatcher54011()
        return CommutativeMatcher54011._instance
