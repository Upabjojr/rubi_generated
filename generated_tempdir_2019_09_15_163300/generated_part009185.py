...
class CommutativeMatcher126700(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126700._instance is None:
            CommutativeMatcher126700._instance = CommutativeMatcher126700()
        return CommutativeMatcher126700._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher126707.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part009186 import *