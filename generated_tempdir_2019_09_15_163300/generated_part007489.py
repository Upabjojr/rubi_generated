...
class CommutativeMatcher25975(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25975._instance is None:
            CommutativeMatcher25975._instance = CommutativeMatcher25975()
        return CommutativeMatcher25975._instance
