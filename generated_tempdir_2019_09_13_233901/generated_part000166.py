...
class CommutativeMatcher40978(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher40978._instance is None:
            CommutativeMatcher40978._instance = CommutativeMatcher40978()
        return CommutativeMatcher40978._instance
