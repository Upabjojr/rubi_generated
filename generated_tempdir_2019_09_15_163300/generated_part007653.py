...
class CommutativeMatcher27575(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher27575._instance is None:
            CommutativeMatcher27575._instance = CommutativeMatcher27575()
        return CommutativeMatcher27575._instance
