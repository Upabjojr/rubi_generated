...
class CommutativeMatcher67480(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67480._instance is None:
            CommutativeMatcher67480._instance = CommutativeMatcher67480()
        return CommutativeMatcher67480._instance
