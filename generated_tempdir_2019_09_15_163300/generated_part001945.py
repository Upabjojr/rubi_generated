...
class CommutativeMatcher23226(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23226._instance is None:
            CommutativeMatcher23226._instance = CommutativeMatcher23226()
        return CommutativeMatcher23226._instance
