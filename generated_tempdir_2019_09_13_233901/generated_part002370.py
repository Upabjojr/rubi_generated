...
class CommutativeMatcher23411(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23411._instance is None:
            CommutativeMatcher23411._instance = CommutativeMatcher23411()
        return CommutativeMatcher23411._instance
