...
class CommutativeMatcher141558(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141558._instance is None:
            CommutativeMatcher141558._instance = CommutativeMatcher141558()
        return CommutativeMatcher141558._instance
