...
class CommutativeMatcher31641(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31641._instance is None:
            CommutativeMatcher31641._instance = CommutativeMatcher31641()
        return CommutativeMatcher31641._instance
