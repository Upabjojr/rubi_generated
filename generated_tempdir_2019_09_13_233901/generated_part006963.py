...
class CommutativeMatcher111911(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111911._instance is None:
            CommutativeMatcher111911._instance = CommutativeMatcher111911()
        return CommutativeMatcher111911._instance
