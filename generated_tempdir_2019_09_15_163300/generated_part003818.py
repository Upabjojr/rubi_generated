...
class CommutativeMatcher65917(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65917._instance is None:
            CommutativeMatcher65917._instance = CommutativeMatcher65917()
        return CommutativeMatcher65917._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher65921.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from .generated_part003819 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset