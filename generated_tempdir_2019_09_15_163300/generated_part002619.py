...
class CommutativeMatcher64954(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64954._instance is None:
            CommutativeMatcher64954._instance = CommutativeMatcher64954()
        return CommutativeMatcher64954._instance
