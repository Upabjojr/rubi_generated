...
class CommutativeMatcher67127(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67127._instance is None:
            CommutativeMatcher67127._instance = CommutativeMatcher67127()
        return CommutativeMatcher67127._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher67131.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part009654 import *