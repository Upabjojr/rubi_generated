...
class CommutativeMatcher134928(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134928._instance is None:
            CommutativeMatcher134928._instance = CommutativeMatcher134928()
        return CommutativeMatcher134928._instance
