...
class CommutativeMatcher42535(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42535._instance is None:
            CommutativeMatcher42535._instance = CommutativeMatcher42535()
        return CommutativeMatcher42535._instance
