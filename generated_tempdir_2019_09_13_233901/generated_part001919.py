...
class CommutativeMatcher23137(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23137._instance is None:
            CommutativeMatcher23137._instance = CommutativeMatcher23137()
        return CommutativeMatcher23137._instance
