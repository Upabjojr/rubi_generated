...
class CommutativeMatcher133506(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133506._instance is None:
            CommutativeMatcher133506._instance = CommutativeMatcher133506()
        return CommutativeMatcher133506._instance
