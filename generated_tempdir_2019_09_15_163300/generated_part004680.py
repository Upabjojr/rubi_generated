...
class CommutativeMatcher21666(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21666._instance is None:
            CommutativeMatcher21666._instance = CommutativeMatcher21666()
        return CommutativeMatcher21666._instance
