...
class CommutativeMatcher32280(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32280._instance is None:
            CommutativeMatcher32280._instance = CommutativeMatcher32280()
        return CommutativeMatcher32280._instance
