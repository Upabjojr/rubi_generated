...
class CommutativeMatcher145777(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher145777._instance is None:
            CommutativeMatcher145777._instance = CommutativeMatcher145777()
        return CommutativeMatcher145777._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher145786.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part000989 import *