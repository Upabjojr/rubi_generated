...
class CommutativeMatcher146281(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146281._instance is None:
            CommutativeMatcher146281._instance = CommutativeMatcher146281()
        return CommutativeMatcher146281._instance
