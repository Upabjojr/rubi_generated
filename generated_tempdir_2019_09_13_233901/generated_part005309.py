...
class CommutativeMatcher33342(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33342._instance is None:
            CommutativeMatcher33342._instance = CommutativeMatcher33342()
        return CommutativeMatcher33342._instance
