...
class CommutativeMatcher77711(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77711._instance is None:
            CommutativeMatcher77711._instance = CommutativeMatcher77711()
        return CommutativeMatcher77711._instance
