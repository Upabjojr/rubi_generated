...
class CommutativeMatcher42814(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42814._instance is None:
            CommutativeMatcher42814._instance = CommutativeMatcher42814()
        return CommutativeMatcher42814._instance
