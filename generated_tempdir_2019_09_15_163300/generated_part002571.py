...
class CommutativeMatcher22401(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22401._instance is None:
            CommutativeMatcher22401._instance = CommutativeMatcher22401()
        return CommutativeMatcher22401._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22405.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part002572 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset