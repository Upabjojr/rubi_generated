...
class CommutativeMatcher58086(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58086._instance is None:
            CommutativeMatcher58086._instance = CommutativeMatcher58086()
        return CommutativeMatcher58086._instance
