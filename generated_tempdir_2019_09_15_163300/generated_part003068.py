...
class CommutativeMatcher63743(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63743._instance is None:
            CommutativeMatcher63743._instance = CommutativeMatcher63743()
        return CommutativeMatcher63743._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher63747.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part003069 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset