...
class CommutativeMatcher20977(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20977._instance is None:
            CommutativeMatcher20977._instance = CommutativeMatcher20977()
        return CommutativeMatcher20977._instance
