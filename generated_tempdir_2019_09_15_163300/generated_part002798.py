...
class CommutativeMatcher30953(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30953._instance is None:
            CommutativeMatcher30953._instance = CommutativeMatcher30953()
        return CommutativeMatcher30953._instance
