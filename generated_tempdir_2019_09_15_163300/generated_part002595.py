...
class CommutativeMatcher30413(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30413._instance is None:
            CommutativeMatcher30413._instance = CommutativeMatcher30413()
        return CommutativeMatcher30413._instance
