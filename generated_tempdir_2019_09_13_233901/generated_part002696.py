...
class CommutativeMatcher22560(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22560._instance is None:
            CommutativeMatcher22560._instance = CommutativeMatcher22560()
        return CommutativeMatcher22560._instance
