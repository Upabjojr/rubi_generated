...
class CommutativeMatcher111260(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111260._instance is None:
            CommutativeMatcher111260._instance = CommutativeMatcher111260()
        return CommutativeMatcher111260._instance
