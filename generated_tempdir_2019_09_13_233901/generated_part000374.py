...
class CommutativeMatcher42978(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42978._instance is None:
            CommutativeMatcher42978._instance = CommutativeMatcher42978()
        return CommutativeMatcher42978._instance
