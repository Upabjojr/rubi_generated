...
class CommutativeMatcher30304(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30304._instance is None:
            CommutativeMatcher30304._instance = CommutativeMatcher30304()
        return CommutativeMatcher30304._instance
