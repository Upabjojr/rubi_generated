...
class CommutativeMatcher41485(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41485._instance is None:
            CommutativeMatcher41485._instance = CommutativeMatcher41485()
        return CommutativeMatcher41485._instance
