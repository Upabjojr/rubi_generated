...
class CommutativeMatcher42133(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42133._instance is None:
            CommutativeMatcher42133._instance = CommutativeMatcher42133()
        return CommutativeMatcher42133._instance
