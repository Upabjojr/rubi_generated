...
class CommutativeMatcher58422(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58422._instance is None:
            CommutativeMatcher58422._instance = CommutativeMatcher58422()
        return CommutativeMatcher58422._instance
