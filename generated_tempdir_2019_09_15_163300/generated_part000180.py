...
class CommutativeMatcher41118(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41118._instance is None:
            CommutativeMatcher41118._instance = CommutativeMatcher41118()
        return CommutativeMatcher41118._instance
