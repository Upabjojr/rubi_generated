...
class CommutativeMatcher63876(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63876._instance is None:
            CommutativeMatcher63876._instance = CommutativeMatcher63876()
        return CommutativeMatcher63876._instance
