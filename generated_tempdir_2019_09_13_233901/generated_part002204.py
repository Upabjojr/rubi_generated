...
class CommutativeMatcher84582(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher84582._instance is None:
            CommutativeMatcher84582._instance = CommutativeMatcher84582()
        return CommutativeMatcher84582._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher84586.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
