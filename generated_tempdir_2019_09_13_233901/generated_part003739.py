                            ...
                            if len(subjects70) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects70) == 0:
                                        pass
                                        # State 63931
                                        if len(subjects45) >= 1 and subjects45[0] == -1:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                if len(subjects237) >= 1:
                    ...
                    try:
                        ...
                        pass
                        # State 5496
                        if len(subjects237) >= 1 and subjects237[0] == 2:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                if len(subjects264) >= 1:
                    ...
                    try:
                        ...
                        pass
                        # State 5858
                        if len(subjects264) >= 1 and subjects264[0] == 2:
                            ...
                            if len(subjects304) >= 1:
                                ...
                                try:
                                    ...
                                    if len(subjects304) == 0:
                                        pass
                                        # State 93178
                                        if len(subjects264) >= 1 and subjects264[0] == -1:
