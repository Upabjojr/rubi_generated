...
class CommutativeMatcher22005(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22005._instance is None:
            CommutativeMatcher22005._instance = CommutativeMatcher22005()
        return CommutativeMatcher22005._instance
