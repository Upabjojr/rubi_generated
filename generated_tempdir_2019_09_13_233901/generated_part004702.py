...
class CommutativeMatcher21728(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21728._instance is None:
            CommutativeMatcher21728._instance = CommutativeMatcher21728()
        return CommutativeMatcher21728._instance
