...
class CommutativeMatcher69085(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69085._instance is None:
            CommutativeMatcher69085._instance = CommutativeMatcher69085()
        return CommutativeMatcher69085._instance
