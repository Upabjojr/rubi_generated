...
class CommutativeMatcher109967(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher109967._instance is None:
            CommutativeMatcher109967._instance = CommutativeMatcher109967()
        return CommutativeMatcher109967._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher111460.get()
                    tmp24 = subjects23
                    subjects23 = []
                    for s in tmp24:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher111471.get()
                tmp28 = subjects27
                subjects27 = []
                for s in tmp28:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006756 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006757 import *