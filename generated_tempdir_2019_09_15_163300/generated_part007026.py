...
class CommutativeMatcher134206(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134206._instance is None:
            CommutativeMatcher134206._instance = CommutativeMatcher134206()
        return CommutativeMatcher134206._instance
