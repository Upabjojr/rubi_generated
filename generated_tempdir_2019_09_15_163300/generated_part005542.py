...
class CommutativeMatcher20823(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20823._instance is None:
            CommutativeMatcher20823._instance = CommutativeMatcher20823()
        return CommutativeMatcher20823._instance
