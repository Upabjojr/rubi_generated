...
class CommutativeMatcher108803(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108803._instance is None:
            CommutativeMatcher108803._instance = CommutativeMatcher108803()
        return CommutativeMatcher108803._instance
