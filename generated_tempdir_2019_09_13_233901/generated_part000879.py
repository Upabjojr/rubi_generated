...
class CommutativeMatcher111711(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111711._instance is None:
            CommutativeMatcher111711._instance = CommutativeMatcher111711()
        return CommutativeMatcher111711._instance
