...
class CommutativeMatcher133795(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133795._instance is None:
            CommutativeMatcher133795._instance = CommutativeMatcher133795()
        return CommutativeMatcher133795._instance
