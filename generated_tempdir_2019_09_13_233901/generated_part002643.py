...
class CommutativeMatcher122202(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122202._instance is None:
            CommutativeMatcher122202._instance = CommutativeMatcher122202()
        return CommutativeMatcher122202._instance
