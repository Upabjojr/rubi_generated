...
class CommutativeMatcher23219(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23219._instance is None:
            CommutativeMatcher23219._instance = CommutativeMatcher23219()
        return CommutativeMatcher23219._instance
