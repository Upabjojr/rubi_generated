...
class CommutativeMatcher42104(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42104._instance is None:
            CommutativeMatcher42104._instance = CommutativeMatcher42104()
        return CommutativeMatcher42104._instance
