...
class CommutativeMatcher23503(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23503._instance is None:
            CommutativeMatcher23503._instance = CommutativeMatcher23503()
        return CommutativeMatcher23503._instance
