...
class CommutativeMatcher79189(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79189._instance is None:
            CommutativeMatcher79189._instance = CommutativeMatcher79189()
        return CommutativeMatcher79189._instance
