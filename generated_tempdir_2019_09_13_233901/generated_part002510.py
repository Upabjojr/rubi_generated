...
class CommutativeMatcher22196(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22196._instance is None:
            CommutativeMatcher22196._instance = CommutativeMatcher22196()
        return CommutativeMatcher22196._instance
