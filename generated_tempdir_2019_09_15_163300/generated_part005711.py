...
class CommutativeMatcher126509(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126509._instance is None:
            CommutativeMatcher126509._instance = CommutativeMatcher126509()
        return CommutativeMatcher126509._instance
