...
class CommutativeMatcher121912(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121912._instance is None:
            CommutativeMatcher121912._instance = CommutativeMatcher121912()
        return CommutativeMatcher121912._instance
