...
class CommutativeMatcher25383(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25383._instance is None:
            CommutativeMatcher25383._instance = CommutativeMatcher25383()
        return CommutativeMatcher25383._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25387.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part007485 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset