...
class CommutativeMatcher23407(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23407._instance is None:
            CommutativeMatcher23407._instance = CommutativeMatcher23407()
        return CommutativeMatcher23407._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher23411.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from .generated_part002370 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset