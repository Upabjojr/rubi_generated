...
class CommutativeMatcher12722(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12722._instance is None:
            CommutativeMatcher12722._instance = CommutativeMatcher12722()
        return CommutativeMatcher12722._instance
