        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects66) >= 1:
                ...
                try:
                    ...
                    if len(subjects66) >= 1 and subjects66[0] == 2:
                ...
                if len(subjects66) >= 1 and isinstance(subjects66[0], Pow):
                    ...
                    if len(subjects117) >= 1:
                        ...
                        try:
                            ...
                            pass
                            # State 10784
                            if len(subjects117) >= 1 and subjects117[0] == -1:
            ...
            if len(subjects66) >= 1 and isinstance(subjects66[0], Add):
                ...
                for pattern_index, subst1 in matcher.match(tmp147, subst0):
                    ...
                    if pattern_index == 0:
                        pass
                        # State 13998
                        if len(subjects66) >= 1 and subjects66[0] == 1/2:
                        ...
                        if len(subjects214) >= 1:
                            ...
                            try:
                                ...
                                if len(subjects214) == 0:
                                    pass
                                    # State 63806
                                    if len(subjects66) >= 1 and subjects66[0] == -1:
