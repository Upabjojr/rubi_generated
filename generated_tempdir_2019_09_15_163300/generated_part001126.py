...
class CommutativeMatcher13173(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13173._instance is None:
            CommutativeMatcher13173._instance = CommutativeMatcher13173()
        return CommutativeMatcher13173._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher13180.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part001127 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset