...
class CommutativeMatcher22467(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22467._instance is None:
            CommutativeMatcher22467._instance = CommutativeMatcher22467()
        return CommutativeMatcher22467._instance
