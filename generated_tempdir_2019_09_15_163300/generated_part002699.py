...
class CommutativeMatcher30530(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30530._instance is None:
            CommutativeMatcher30530._instance = CommutativeMatcher30530()
        return CommutativeMatcher30530._instance
