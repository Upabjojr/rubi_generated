...
class CommutativeMatcher129783(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129783._instance is None:
            CommutativeMatcher129783._instance = CommutativeMatcher129783()
        return CommutativeMatcher129783._instance
