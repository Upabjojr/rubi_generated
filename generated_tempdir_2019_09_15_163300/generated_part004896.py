...
class CommutativeMatcher63995(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63995._instance is None:
            CommutativeMatcher63995._instance = CommutativeMatcher63995()
        return CommutativeMatcher63995._instance
