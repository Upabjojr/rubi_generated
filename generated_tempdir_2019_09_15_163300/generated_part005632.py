...
class CommutativeMatcher60049(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60049._instance is None:
            CommutativeMatcher60049._instance = CommutativeMatcher60049()
        return CommutativeMatcher60049._instance
