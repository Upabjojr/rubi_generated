...
class CommutativeMatcher21908(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21908._instance is None:
            CommutativeMatcher21908._instance = CommutativeMatcher21908()
        return CommutativeMatcher21908._instance
