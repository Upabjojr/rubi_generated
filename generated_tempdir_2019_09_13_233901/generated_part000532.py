...
class CommutativeMatcher42057(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42057._instance is None:
            CommutativeMatcher42057._instance = CommutativeMatcher42057()
        return CommutativeMatcher42057._instance
