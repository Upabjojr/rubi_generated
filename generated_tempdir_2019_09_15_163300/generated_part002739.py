...
class CommutativeMatcher22708(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22708._instance is None:
            CommutativeMatcher22708._instance = CommutativeMatcher22708()
        return CommutativeMatcher22708._instance
