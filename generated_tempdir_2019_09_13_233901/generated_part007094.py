...
class CommutativeMatcher150283(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150283._instance is None:
            CommutativeMatcher150283._instance = CommutativeMatcher150283()
        return CommutativeMatcher150283._instance
