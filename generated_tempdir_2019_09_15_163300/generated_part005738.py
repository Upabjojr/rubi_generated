...
class CommutativeMatcher32427(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32427._instance is None:
            CommutativeMatcher32427._instance = CommutativeMatcher32427()
        return CommutativeMatcher32427._instance
