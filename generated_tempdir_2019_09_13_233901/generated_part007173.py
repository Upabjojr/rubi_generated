...
class CommutativeMatcher65531(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65531._instance is None:
            CommutativeMatcher65531._instance = CommutativeMatcher65531()
        return CommutativeMatcher65531._instance
