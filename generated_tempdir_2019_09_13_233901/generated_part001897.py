...
class CommutativeMatcher23074(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23074._instance is None:
            CommutativeMatcher23074._instance = CommutativeMatcher23074()
        return CommutativeMatcher23074._instance
