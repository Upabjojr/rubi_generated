...
class CommutativeMatcher129474(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129474._instance is None:
            CommutativeMatcher129474._instance = CommutativeMatcher129474()
        return CommutativeMatcher129474._instance
