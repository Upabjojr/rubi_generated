...
class CommutativeMatcher41635(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41635._instance is None:
            CommutativeMatcher41635._instance = CommutativeMatcher41635()
        return CommutativeMatcher41635._instance
