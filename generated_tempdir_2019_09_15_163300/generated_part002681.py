...
class CommutativeMatcher93288(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93288._instance is None:
            CommutativeMatcher93288._instance = CommutativeMatcher93288()
        return CommutativeMatcher93288._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher93292.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part002682 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset