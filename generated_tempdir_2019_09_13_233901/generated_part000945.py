...
class CommutativeMatcher116514(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116514._instance is None:
            CommutativeMatcher116514._instance = CommutativeMatcher116514()
        return CommutativeMatcher116514._instance
