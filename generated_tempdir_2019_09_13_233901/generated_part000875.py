...
class CommutativeMatcher111659(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111659._instance is None:
            CommutativeMatcher111659._instance = CommutativeMatcher111659()
        return CommutativeMatcher111659._instance
