...
class CommutativeMatcher120283(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120283._instance is None:
            CommutativeMatcher120283._instance = CommutativeMatcher120283()
        return CommutativeMatcher120283._instance
