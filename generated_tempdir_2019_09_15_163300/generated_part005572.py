...
class CommutativeMatcher20932(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20932._instance is None:
            CommutativeMatcher20932._instance = CommutativeMatcher20932()
        return CommutativeMatcher20932._instance
