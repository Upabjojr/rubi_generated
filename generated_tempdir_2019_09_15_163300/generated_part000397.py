...
class CommutativeMatcher43128(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43128._instance is None:
            CommutativeMatcher43128._instance = CommutativeMatcher43128()
        return CommutativeMatcher43128._instance
