...
class CommutativeMatcher79220(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79220._instance is None:
            CommutativeMatcher79220._instance = CommutativeMatcher79220()
        return CommutativeMatcher79220._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher79224.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part005498 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset