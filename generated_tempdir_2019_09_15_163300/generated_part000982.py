...
class CommutativeMatcher141353(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141353._instance is None:
            CommutativeMatcher141353._instance = CommutativeMatcher141353()
        return CommutativeMatcher141353._instance
