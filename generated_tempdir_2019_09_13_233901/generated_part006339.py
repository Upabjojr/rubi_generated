...
class CommutativeMatcher124352(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124352._instance is None:
            CommutativeMatcher124352._instance = CommutativeMatcher124352()
        return CommutativeMatcher124352._instance
