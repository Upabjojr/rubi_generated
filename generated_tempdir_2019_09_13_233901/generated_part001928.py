...
class CommutativeMatcher31297(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31297._instance is None:
            CommutativeMatcher31297._instance = CommutativeMatcher31297()
        return CommutativeMatcher31297._instance
