...
class CommutativeMatcher22869(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22869._instance is None:
            CommutativeMatcher22869._instance = CommutativeMatcher22869()
        return CommutativeMatcher22869._instance
