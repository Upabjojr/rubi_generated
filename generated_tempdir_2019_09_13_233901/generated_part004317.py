...
class CommutativeMatcher141458(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141458._instance is None:
            CommutativeMatcher141458._instance = CommutativeMatcher141458()
        return CommutativeMatcher141458._instance
