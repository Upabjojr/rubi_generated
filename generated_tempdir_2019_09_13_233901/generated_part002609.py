...
class CommutativeMatcher22523(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22523._instance is None:
            CommutativeMatcher22523._instance = CommutativeMatcher22523()
        return CommutativeMatcher22523._instance
