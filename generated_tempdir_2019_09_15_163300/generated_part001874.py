...
class CommutativeMatcher31069(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31069._instance is None:
            CommutativeMatcher31069._instance = CommutativeMatcher31069()
        return CommutativeMatcher31069._instance
