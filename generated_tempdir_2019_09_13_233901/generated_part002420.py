...
class CommutativeMatcher31810(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31810._instance is None:
            CommutativeMatcher31810._instance = CommutativeMatcher31810()
        return CommutativeMatcher31810._instance
