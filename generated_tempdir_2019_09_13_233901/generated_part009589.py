...
class CommutativeMatcher77457(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77457._instance is None:
            CommutativeMatcher77457._instance = CommutativeMatcher77457()
        return CommutativeMatcher77457._instance
