...
class CommutativeMatcher31840(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31840._instance is None:
            CommutativeMatcher31840._instance = CommutativeMatcher31840()
        return CommutativeMatcher31840._instance
