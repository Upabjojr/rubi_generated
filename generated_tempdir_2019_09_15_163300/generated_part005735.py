...
class CommutativeMatcher21157(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21157._instance is None:
            CommutativeMatcher21157._instance = CommutativeMatcher21157()
        return CommutativeMatcher21157._instance
