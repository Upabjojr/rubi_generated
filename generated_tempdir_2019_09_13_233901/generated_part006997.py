...
class CommutativeMatcher121107(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121107._instance is None:
            CommutativeMatcher121107._instance = CommutativeMatcher121107()
        return CommutativeMatcher121107._instance
