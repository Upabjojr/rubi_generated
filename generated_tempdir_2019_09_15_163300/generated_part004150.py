...
class CommutativeMatcher47641(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher47641._instance is None:
            CommutativeMatcher47641._instance = CommutativeMatcher47641()
        return CommutativeMatcher47641._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher47645.get()
            tmp11 = subjects10
            subjects10 = []
            for s in tmp11:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004151 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset