...
class CommutativeMatcher58138(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58138._instance is None:
            CommutativeMatcher58138._instance = CommutativeMatcher58138()
        return CommutativeMatcher58138._instance
