...
class CommutativeMatcher31499(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31499._instance is None:
            CommutativeMatcher31499._instance = CommutativeMatcher31499()
        return CommutativeMatcher31499._instance
