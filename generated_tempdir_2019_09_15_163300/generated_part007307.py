...
class CommutativeMatcher138423(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138423._instance is None:
            CommutativeMatcher138423._instance = CommutativeMatcher138423()
        return CommutativeMatcher138423._instance
