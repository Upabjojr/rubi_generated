...
class CommutativeMatcher61833(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61833._instance is None:
            CommutativeMatcher61833._instance = CommutativeMatcher61833()
        return CommutativeMatcher61833._instance
