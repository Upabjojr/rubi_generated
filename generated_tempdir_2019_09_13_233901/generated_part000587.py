...
class CommutativeMatcher42425(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42425._instance is None:
            CommutativeMatcher42425._instance = CommutativeMatcher42425()
        return CommutativeMatcher42425._instance
