...
class CommutativeMatcher111142(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111142._instance is None:
            CommutativeMatcher111142._instance = CommutativeMatcher111142()
        return CommutativeMatcher111142._instance
