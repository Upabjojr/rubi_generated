...
class CommutativeMatcher74199(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74199._instance is None:
            CommutativeMatcher74199._instance = CommutativeMatcher74199()
        return CommutativeMatcher74199._instance
