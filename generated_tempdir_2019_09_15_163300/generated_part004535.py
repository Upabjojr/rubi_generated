...
class CommutativeMatcher12595(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12595._instance is None:
            CommutativeMatcher12595._instance = CommutativeMatcher12595()
        return CommutativeMatcher12595._instance
