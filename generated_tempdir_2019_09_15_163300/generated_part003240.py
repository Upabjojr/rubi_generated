...
class CommutativeMatcher123990(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher123990._instance is None:
            CommutativeMatcher123990._instance = CommutativeMatcher123990()
        return CommutativeMatcher123990._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher123997.get()
            tmp18 = subjects17
            subjects17 = []
            for s in tmp18:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part003241 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset