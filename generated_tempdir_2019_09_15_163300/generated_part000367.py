...
class CommutativeMatcher42930(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42930._instance is None:
            CommutativeMatcher42930._instance = CommutativeMatcher42930()
        return CommutativeMatcher42930._instance
