...
class CommutativeMatcher22361(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22361._instance is None:
            CommutativeMatcher22361._instance = CommutativeMatcher22361()
        return CommutativeMatcher22361._instance
