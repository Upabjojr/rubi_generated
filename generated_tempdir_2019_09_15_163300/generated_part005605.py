...
class CommutativeMatcher32252(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32252._instance is None:
            CommutativeMatcher32252._instance = CommutativeMatcher32252()
        return CommutativeMatcher32252._instance
