...
class CommutativeMatcher134149(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134149._instance is None:
            CommutativeMatcher134149._instance = CommutativeMatcher134149()
        return CommutativeMatcher134149._instance
