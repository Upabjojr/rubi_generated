...
class CommutativeMatcher111280(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111280._instance is None:
            CommutativeMatcher111280._instance = CommutativeMatcher111280()
        return CommutativeMatcher111280._instance
