...
class CommutativeMatcher77682(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77682._instance is None:
            CommutativeMatcher77682._instance = CommutativeMatcher77682()
        return CommutativeMatcher77682._instance
