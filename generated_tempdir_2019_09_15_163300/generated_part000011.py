...
class CommutativeMatcher41321(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41321._instance is None:
            CommutativeMatcher41321._instance = CommutativeMatcher41321()
        return CommutativeMatcher41321._instance
