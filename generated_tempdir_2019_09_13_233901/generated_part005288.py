...
class CommutativeMatcher129508(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129508._instance is None:
            CommutativeMatcher129508._instance = CommutativeMatcher129508()
        return CommutativeMatcher129508._instance
