...
class CommutativeMatcher22595(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22595._instance is None:
            CommutativeMatcher22595._instance = CommutativeMatcher22595()
        return CommutativeMatcher22595._instance
