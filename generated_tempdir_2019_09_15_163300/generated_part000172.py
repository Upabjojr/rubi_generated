...
class CommutativeMatcher41044(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41044._instance is None:
            CommutativeMatcher41044._instance = CommutativeMatcher41044()
        return CommutativeMatcher41044._instance
