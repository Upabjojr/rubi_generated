...
class CommutativeMatcher64244(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64244._instance is None:
            CommutativeMatcher64244._instance = CommutativeMatcher64244()
        return CommutativeMatcher64244._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher64248.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part003790 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset