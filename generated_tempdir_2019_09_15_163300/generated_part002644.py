...
class CommutativeMatcher122206(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher122206._instance is None:
            CommutativeMatcher122206._instance = CommutativeMatcher122206()
        return CommutativeMatcher122206._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher122210.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part002645 import *
from multiset import Multiset