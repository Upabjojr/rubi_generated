...
class CommutativeMatcher110255(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher110255._instance is None:
            CommutativeMatcher110255._instance = CommutativeMatcher110255()
        return CommutativeMatcher110255._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher110259.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001092 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset