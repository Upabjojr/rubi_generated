...
class CommutativeMatcher21378(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21378._instance is None:
            CommutativeMatcher21378._instance = CommutativeMatcher21378()
        return CommutativeMatcher21378._instance
