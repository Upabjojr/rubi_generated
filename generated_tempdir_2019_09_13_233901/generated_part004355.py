...
class CommutativeMatcher106634(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106634._instance is None:
            CommutativeMatcher106634._instance = CommutativeMatcher106634()
        return CommutativeMatcher106634._instance
