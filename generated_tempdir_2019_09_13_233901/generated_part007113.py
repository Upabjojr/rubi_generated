...
class CommutativeMatcher66391(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher66391._instance is None:
            CommutativeMatcher66391._instance = CommutativeMatcher66391()
        return CommutativeMatcher66391._instance
