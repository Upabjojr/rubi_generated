...
class CommutativeMatcher105002(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105002._instance is None:
            CommutativeMatcher105002._instance = CommutativeMatcher105002()
        return CommutativeMatcher105002._instance
