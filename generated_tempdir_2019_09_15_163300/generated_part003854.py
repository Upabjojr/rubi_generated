...
class CommutativeMatcher24181(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher24181._instance is None:
            CommutativeMatcher24181._instance = CommutativeMatcher24181()
        return CommutativeMatcher24181._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher24185.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part003855 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset