...
class CommutativeMatcher32223(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32223._instance is None:
            CommutativeMatcher32223._instance = CommutativeMatcher32223()
        return CommutativeMatcher32223._instance
