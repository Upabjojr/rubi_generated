...
class CommutativeMatcher41861(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41861._instance is None:
            CommutativeMatcher41861._instance = CommutativeMatcher41861()
        return CommutativeMatcher41861._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41868.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000093 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset