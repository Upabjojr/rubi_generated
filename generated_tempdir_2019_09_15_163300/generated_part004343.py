...
class CommutativeMatcher149745(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149745._instance is None:
            CommutativeMatcher149745._instance = CommutativeMatcher149745()
        return CommutativeMatcher149745._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher149754.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part004344 import *