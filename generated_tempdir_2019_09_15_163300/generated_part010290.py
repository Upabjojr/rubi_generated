...
class CommutativeMatcher104668(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104668._instance is None:
            CommutativeMatcher104668._instance = CommutativeMatcher104668()
        return CommutativeMatcher104668._instance
