...
class CommutativeMatcher26411(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher26411._instance is None:
            CommutativeMatcher26411._instance = CommutativeMatcher26411()
        return CommutativeMatcher26411._instance
