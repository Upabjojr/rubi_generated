...
class CommutativeMatcher150072(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150072._instance is None:
            CommutativeMatcher150072._instance = CommutativeMatcher150072()
        return CommutativeMatcher150072._instance
