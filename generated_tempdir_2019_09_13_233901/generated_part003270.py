...
class CommutativeMatcher74096(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74096._instance is None:
            CommutativeMatcher74096._instance = CommutativeMatcher74096()
        return CommutativeMatcher74096._instance
