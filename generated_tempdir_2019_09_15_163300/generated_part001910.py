...
class CommutativeMatcher23109(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23109._instance is None:
            CommutativeMatcher23109._instance = CommutativeMatcher23109()
        return CommutativeMatcher23109._instance
