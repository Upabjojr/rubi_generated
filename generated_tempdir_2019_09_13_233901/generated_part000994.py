...
class CommutativeMatcher146204(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146204._instance is None:
            CommutativeMatcher146204._instance = CommutativeMatcher146204()
        return CommutativeMatcher146204._instance
