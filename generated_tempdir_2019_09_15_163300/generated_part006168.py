...
class CommutativeMatcher78585(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78585._instance is None:
            CommutativeMatcher78585._instance = CommutativeMatcher78585()
        return CommutativeMatcher78585._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher78589.get()
            tmp15 = subjects14
            subjects14 = []
            for s in tmp15:
...
from .generated_part006169 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset