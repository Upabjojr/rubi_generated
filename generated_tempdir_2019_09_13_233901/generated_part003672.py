...
class CommutativeMatcher78029(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78029._instance is None:
            CommutativeMatcher78029._instance = CommutativeMatcher78029()
        return CommutativeMatcher78029._instance
