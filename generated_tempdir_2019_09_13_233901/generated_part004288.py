...
class CommutativeMatcher134381(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134381._instance is None:
            CommutativeMatcher134381._instance = CommutativeMatcher134381()
        return CommutativeMatcher134381._instance
