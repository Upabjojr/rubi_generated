...
class CommutativeMatcher22572(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22572._instance is None:
            CommutativeMatcher22572._instance = CommutativeMatcher22572()
        return CommutativeMatcher22572._instance
