...
class CommutativeMatcher57017(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher57017._instance is None:
            CommutativeMatcher57017._instance = CommutativeMatcher57017()
        return CommutativeMatcher57017._instance
