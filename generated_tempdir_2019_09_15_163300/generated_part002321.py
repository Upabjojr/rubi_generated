...
class CommutativeMatcher129343(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129343._instance is None:
            CommutativeMatcher129343._instance = CommutativeMatcher129343()
        return CommutativeMatcher129343._instance
