...
class CommutativeMatcher117196(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher117196._instance is None:
            CommutativeMatcher117196._instance = CommutativeMatcher117196()
        return CommutativeMatcher117196._instance
