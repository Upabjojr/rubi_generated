...
class CommutativeMatcher42759(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42759._instance is None:
            CommutativeMatcher42759._instance = CommutativeMatcher42759()
        return CommutativeMatcher42759._instance
