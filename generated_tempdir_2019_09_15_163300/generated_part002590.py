...
class CommutativeMatcher22458(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22458._instance is None:
            CommutativeMatcher22458._instance = CommutativeMatcher22458()
        return CommutativeMatcher22458._instance
