...
class CommutativeMatcher121000(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121000._instance is None:
            CommutativeMatcher121000._instance = CommutativeMatcher121000()
        return CommutativeMatcher121000._instance
