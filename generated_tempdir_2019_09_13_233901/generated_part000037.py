...
class CommutativeMatcher41570(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41570._instance is None:
            CommutativeMatcher41570._instance = CommutativeMatcher41570()
        return CommutativeMatcher41570._instance
