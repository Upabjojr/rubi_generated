...
class CommutativeMatcher43492(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43492._instance is None:
            CommutativeMatcher43492._instance = CommutativeMatcher43492()
        return CommutativeMatcher43492._instance
