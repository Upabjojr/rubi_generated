...
class CommutativeMatcher42687(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42687._instance is None:
            CommutativeMatcher42687._instance = CommutativeMatcher42687()
        return CommutativeMatcher42687._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher42694.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part000627 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset