...
class CommutativeMatcher113920(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113920._instance is None:
            CommutativeMatcher113920._instance = CommutativeMatcher113920()
        return CommutativeMatcher113920._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher113927.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004071 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset