...
class CommutativeMatcher42488(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42488._instance is None:
            CommutativeMatcher42488._instance = CommutativeMatcher42488()
        return CommutativeMatcher42488._instance
