...
class CommutativeMatcher58894(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58894._instance is None:
            CommutativeMatcher58894._instance = CommutativeMatcher58894()
        return CommutativeMatcher58894._instance
