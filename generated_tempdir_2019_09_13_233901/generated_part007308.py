...
class CommutativeMatcher138461(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138461._instance is None:
            CommutativeMatcher138461._instance = CommutativeMatcher138461()
        return CommutativeMatcher138461._instance
