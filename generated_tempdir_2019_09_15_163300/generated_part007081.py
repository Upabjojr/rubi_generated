...
class CommutativeMatcher149788(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149788._instance is None:
            CommutativeMatcher149788._instance = CommutativeMatcher149788()
        return CommutativeMatcher149788._instance
