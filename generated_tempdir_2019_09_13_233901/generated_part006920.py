...
class CommutativeMatcher104955(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104955._instance is None:
            CommutativeMatcher104955._instance = CommutativeMatcher104955()
        return CommutativeMatcher104955._instance
