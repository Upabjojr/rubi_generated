...
class CommutativeMatcher141535(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141535._instance is None:
            CommutativeMatcher141535._instance = CommutativeMatcher141535()
        return CommutativeMatcher141535._instance
