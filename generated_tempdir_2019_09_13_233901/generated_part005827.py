...
class CommutativeMatcher21443(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21443._instance is None:
            CommutativeMatcher21443._instance = CommutativeMatcher21443()
        return CommutativeMatcher21443._instance
