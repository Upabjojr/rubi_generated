...
class CommutativeMatcher42208(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42208._instance is None:
            CommutativeMatcher42208._instance = CommutativeMatcher42208()
        return CommutativeMatcher42208._instance
