...
class CommutativeMatcher23055(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23055._instance is None:
            CommutativeMatcher23055._instance = CommutativeMatcher23055()
        return CommutativeMatcher23055._instance
