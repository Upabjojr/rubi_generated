...
class CommutativeMatcher12742(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher12742._instance is None:
            CommutativeMatcher12742._instance = CommutativeMatcher12742()
        return CommutativeMatcher12742._instance
