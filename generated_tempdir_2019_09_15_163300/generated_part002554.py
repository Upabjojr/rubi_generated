...
class CommutativeMatcher30246(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30246._instance is None:
            CommutativeMatcher30246._instance = CommutativeMatcher30246()
        return CommutativeMatcher30246._instance
