...
class CommutativeMatcher22246(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22246._instance is None:
            CommutativeMatcher22246._instance = CommutativeMatcher22246()
        return CommutativeMatcher22246._instance
