...
class CommutativeMatcher78535(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78535._instance is None:
            CommutativeMatcher78535._instance = CommutativeMatcher78535()
        return CommutativeMatcher78535._instance
