...
class CommutativeMatcher21263(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21263._instance is None:
            CommutativeMatcher21263._instance = CommutativeMatcher21263()
        return CommutativeMatcher21263._instance
