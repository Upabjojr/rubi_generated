...
class CommutativeMatcher116753(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116753._instance is None:
            CommutativeMatcher116753._instance = CommutativeMatcher116753()
        return CommutativeMatcher116753._instance
