...
class CommutativeMatcher116794(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116794._instance is None:
            CommutativeMatcher116794._instance = CommutativeMatcher116794()
        return CommutativeMatcher116794._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher116803.get()
            tmp23 = subjects22
            subjects22 = []
            for s in tmp23:
...
from .generated_part006973 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset