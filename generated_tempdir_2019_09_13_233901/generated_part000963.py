...
class CommutativeMatcher120454(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120454._instance is None:
            CommutativeMatcher120454._instance = CommutativeMatcher120454()
        return CommutativeMatcher120454._instance
