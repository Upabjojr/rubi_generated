...
class CommutativeMatcher81236(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81236._instance is None:
            CommutativeMatcher81236._instance = CommutativeMatcher81236()
        return CommutativeMatcher81236._instance
