...
class CommutativeMatcher93124(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93124._instance is None:
            CommutativeMatcher93124._instance = CommutativeMatcher93124()
        return CommutativeMatcher93124._instance
