...
class CommutativeMatcher124403(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124403._instance is None:
            CommutativeMatcher124403._instance = CommutativeMatcher124403()
        return CommutativeMatcher124403._instance
