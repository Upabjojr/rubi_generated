...
class CommutativeMatcher78589(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78589._instance is None:
            CommutativeMatcher78589._instance = CommutativeMatcher78589()
        return CommutativeMatcher78589._instance
