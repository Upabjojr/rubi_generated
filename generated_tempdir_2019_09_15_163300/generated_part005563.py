...
class CommutativeMatcher20912(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20912._instance is None:
            CommutativeMatcher20912._instance = CommutativeMatcher20912()
        return CommutativeMatcher20912._instance
