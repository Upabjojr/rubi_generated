...
class CommutativeMatcher22913(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22913._instance is None:
            CommutativeMatcher22913._instance = CommutativeMatcher22913()
        return CommutativeMatcher22913._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22917.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001852 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset