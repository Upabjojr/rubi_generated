...
class CommutativeMatcher89136(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89136._instance is None:
            CommutativeMatcher89136._instance = CommutativeMatcher89136()
        return CommutativeMatcher89136._instance
