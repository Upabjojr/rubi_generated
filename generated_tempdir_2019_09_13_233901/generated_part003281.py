...
class CommutativeMatcher124014(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124014._instance is None:
            CommutativeMatcher124014._instance = CommutativeMatcher124014()
        return CommutativeMatcher124014._instance
