...
class CommutativeMatcher135223(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135223._instance is None:
            CommutativeMatcher135223._instance = CommutativeMatcher135223()
        return CommutativeMatcher135223._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher135235.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from .generated_part009927 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset