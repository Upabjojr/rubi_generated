...
class CommutativeMatcher32019(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32019._instance is None:
            CommutativeMatcher32019._instance = CommutativeMatcher32019()
        return CommutativeMatcher32019._instance
