...
class CommutativeMatcher126545(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126545._instance is None:
            CommutativeMatcher126545._instance = CommutativeMatcher126545()
        return CommutativeMatcher126545._instance
