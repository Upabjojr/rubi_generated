...
class CommutativeMatcher22084(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22084._instance is None:
            CommutativeMatcher22084._instance = CommutativeMatcher22084()
        return CommutativeMatcher22084._instance
