...
class CommutativeMatcher129458(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129458._instance is None:
            CommutativeMatcher129458._instance = CommutativeMatcher129458()
        return CommutativeMatcher129458._instance
