...
class CommutativeMatcher32569(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32569._instance is None:
            CommutativeMatcher32569._instance = CommutativeMatcher32569()
        return CommutativeMatcher32569._instance
