...
class CommutativeMatcher22676(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22676._instance is None:
            CommutativeMatcher22676._instance = CommutativeMatcher22676()
        return CommutativeMatcher22676._instance
