...
class CommutativeMatcher124156(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124156._instance is None:
            CommutativeMatcher124156._instance = CommutativeMatcher124156()
        return CommutativeMatcher124156._instance
