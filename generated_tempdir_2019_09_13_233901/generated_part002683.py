...
class CommutativeMatcher126455(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126455._instance is None:
            CommutativeMatcher126455._instance = CommutativeMatcher126455()
        return CommutativeMatcher126455._instance
