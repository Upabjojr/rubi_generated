...
class CommutativeMatcher50691(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher50691._instance is None:
            CommutativeMatcher50691._instance = CommutativeMatcher50691()
        return CommutativeMatcher50691._instance
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                    ...
                    matcher = CommutativeMatcher52792.get()
                    tmp13 = subjects12
                    subjects12 = []
                    for s in tmp13:
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Add):
                ...
                matcher = CommutativeMatcher52797.get()
                tmp17 = subjects16
                subjects16 = []
                for s in tmp17:
                    matcher.add_subject(s)
...
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part009537 import *
from .generated_part009538 import *