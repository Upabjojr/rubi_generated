...
class CommutativeMatcher116982(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116982._instance is None:
            CommutativeMatcher116982._instance = CommutativeMatcher116982()
        return CommutativeMatcher116982._instance
