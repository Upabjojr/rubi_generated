...
class CommutativeMatcher20996(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20996._instance is None:
            CommutativeMatcher20996._instance = CommutativeMatcher20996()
        return CommutativeMatcher20996._instance
