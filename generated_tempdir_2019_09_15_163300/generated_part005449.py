...
class CommutativeMatcher121895(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121895._instance is None:
            CommutativeMatcher121895._instance = CommutativeMatcher121895()
        return CommutativeMatcher121895._instance
