...
class CommutativeMatcher21111(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21111._instance is None:
            CommutativeMatcher21111._instance = CommutativeMatcher21111()
        return CommutativeMatcher21111._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21115.get()
            tmp16 = subjects15
            subjects15 = []
            for s in tmp16:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part005722 import *
from multiset import Multiset