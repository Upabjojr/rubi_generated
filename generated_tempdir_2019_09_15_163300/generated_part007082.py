...
class CommutativeMatcher149802(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149802._instance is None:
            CommutativeMatcher149802._instance = CommutativeMatcher149802()
        return CommutativeMatcher149802._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher149811.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part007083 import *