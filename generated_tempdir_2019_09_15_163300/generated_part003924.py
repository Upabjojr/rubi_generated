...
class CommutativeMatcher142678(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142678._instance is None:
            CommutativeMatcher142678._instance = CommutativeMatcher142678()
        return CommutativeMatcher142678._instance
