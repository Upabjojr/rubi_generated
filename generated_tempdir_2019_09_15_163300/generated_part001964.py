...
class CommutativeMatcher78359(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78359._instance is None:
            CommutativeMatcher78359._instance = CommutativeMatcher78359()
        return CommutativeMatcher78359._instance
