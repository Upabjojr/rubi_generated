...
class CommutativeMatcher133714(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133714._instance is None:
            CommutativeMatcher133714._instance = CommutativeMatcher133714()
        return CommutativeMatcher133714._instance
