...
class CommutativeMatcher104645(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104645._instance is None:
            CommutativeMatcher104645._instance = CommutativeMatcher104645()
        return CommutativeMatcher104645._instance
