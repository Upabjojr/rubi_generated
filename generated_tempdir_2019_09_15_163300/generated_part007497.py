...
class CommutativeMatcher25980(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25980._instance is None:
            CommutativeMatcher25980._instance = CommutativeMatcher25980()
        return CommutativeMatcher25980._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25984.get()
            tmp21 = subjects20
            subjects20 = []
            for s in tmp21:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007498 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset