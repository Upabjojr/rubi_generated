...
class CommutativeMatcher79240(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher79240._instance is None:
            CommutativeMatcher79240._instance = CommutativeMatcher79240()
        return CommutativeMatcher79240._instance
