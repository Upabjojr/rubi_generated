...
class CommutativeMatcher23486(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23486._instance is None:
            CommutativeMatcher23486._instance = CommutativeMatcher23486()
        return CommutativeMatcher23486._instance
