...
class CommutativeMatcher53661(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53661._instance is None:
            CommutativeMatcher53661._instance = CommutativeMatcher53661()
        return CommutativeMatcher53661._instance
