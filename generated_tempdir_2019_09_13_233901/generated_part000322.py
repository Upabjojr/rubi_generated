...
class CommutativeMatcher149974(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149974._instance is None:
            CommutativeMatcher149974._instance = CommutativeMatcher149974()
        return CommutativeMatcher149974._instance
