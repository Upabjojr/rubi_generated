...
class CommutativeMatcher106455(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106455._instance is None:
            CommutativeMatcher106455._instance = CommutativeMatcher106455()
        return CommutativeMatcher106455._instance
