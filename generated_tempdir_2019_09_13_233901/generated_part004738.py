...
class CommutativeMatcher58355(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58355._instance is None:
            CommutativeMatcher58355._instance = CommutativeMatcher58355()
        return CommutativeMatcher58355._instance
