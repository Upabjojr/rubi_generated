...
class CommutativeMatcher41437(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41437._instance is None:
            CommutativeMatcher41437._instance = CommutativeMatcher41437()
        return CommutativeMatcher41437._instance
