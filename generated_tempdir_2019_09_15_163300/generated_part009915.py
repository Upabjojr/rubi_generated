...
class CommutativeMatcher135086(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135086._instance is None:
            CommutativeMatcher135086._instance = CommutativeMatcher135086()
        return CommutativeMatcher135086._instance
