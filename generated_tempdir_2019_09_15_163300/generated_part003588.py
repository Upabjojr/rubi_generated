...
class CommutativeMatcher78078(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78078._instance is None:
            CommutativeMatcher78078._instance = CommutativeMatcher78078()
        return CommutativeMatcher78078._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher78082.get()
            tmp25 = subjects24
            subjects24 = []
            for s in tmp25:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part003589 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset