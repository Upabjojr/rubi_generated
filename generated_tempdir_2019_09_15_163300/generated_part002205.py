...
class CommutativeMatcher84586(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher84586._instance is None:
            CommutativeMatcher84586._instance = CommutativeMatcher84586()
        return CommutativeMatcher84586._instance
