...
class CommutativeMatcher41546(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41546._instance is None:
            CommutativeMatcher41546._instance = CommutativeMatcher41546()
        return CommutativeMatcher41546._instance
