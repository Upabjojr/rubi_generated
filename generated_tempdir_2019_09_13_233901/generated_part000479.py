...
class CommutativeMatcher43246(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43246._instance is None:
            CommutativeMatcher43246._instance = CommutativeMatcher43246()
        return CommutativeMatcher43246._instance
