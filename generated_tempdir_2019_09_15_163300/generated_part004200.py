...
class CommutativeMatcher105321(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105321._instance is None:
            CommutativeMatcher105321._instance = CommutativeMatcher105321()
        return CommutativeMatcher105321._instance
