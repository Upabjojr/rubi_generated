...
class CommutativeMatcher25056(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25056._instance is None:
            CommutativeMatcher25056._instance = CommutativeMatcher25056()
        return CommutativeMatcher25056._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher25060.get()
            tmp10 = subjects9
            subjects9 = []
            for s in tmp10:
...
from .generated_part007261 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset