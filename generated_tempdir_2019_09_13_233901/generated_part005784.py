...
class CommutativeMatcher21307(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21307._instance is None:
            CommutativeMatcher21307._instance = CommutativeMatcher21307()
        return CommutativeMatcher21307._instance
