...
class CommutativeMatcher113048(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher113048._instance is None:
            CommutativeMatcher113048._instance = CommutativeMatcher113048()
        return CommutativeMatcher113048._instance
