...
class CommutativeMatcher31043(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31043._instance is None:
            CommutativeMatcher31043._instance = CommutativeMatcher31043()
        return CommutativeMatcher31043._instance
