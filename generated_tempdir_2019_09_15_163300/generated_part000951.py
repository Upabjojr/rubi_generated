...
class CommutativeMatcher116591(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116591._instance is None:
            CommutativeMatcher116591._instance = CommutativeMatcher116591()
        return CommutativeMatcher116591._instance
