...
class CommutativeMatcher143660(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher143660._instance is None:
            CommutativeMatcher143660._instance = CommutativeMatcher143660()
        return CommutativeMatcher143660._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Add):
            ...
            matcher = CommutativeMatcher143889.get()
            tmp3 = subjects2
            subjects2 = []
            for s in tmp3:
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects5) >= 1 and isinstance(subjects5[0], Mul):
                    ...
                    matcher = CommutativeMatcher144092.get()
                    tmp13 = subjects12
                    subjects12 = []
                    for s in tmp13:
                        matcher.add_subject(s)
            ...
            if len(subjects5) >= 1 and isinstance(subjects5[0], Add):
                ...
                matcher = CommutativeMatcher144097.get()
                tmp17 = subjects16
                subjects16 = []
                for s in tmp17:
                    matcher.add_subject(s)
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part006806 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part006803 import *
from .generated_part006805 import *