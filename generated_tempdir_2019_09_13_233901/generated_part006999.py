...
class CommutativeMatcher121127(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121127._instance is None:
            CommutativeMatcher121127._instance = CommutativeMatcher121127()
        return CommutativeMatcher121127._instance
