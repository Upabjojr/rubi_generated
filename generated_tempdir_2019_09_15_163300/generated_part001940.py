...
class CommutativeMatcher31345(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31345._instance is None:
            CommutativeMatcher31345._instance = CommutativeMatcher31345()
        return CommutativeMatcher31345._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher31354.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part001941 import *