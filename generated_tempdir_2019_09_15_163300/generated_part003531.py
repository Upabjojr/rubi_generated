...
class CommutativeMatcher124299(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124299._instance is None:
            CommutativeMatcher124299._instance = CommutativeMatcher124299()
        return CommutativeMatcher124299._instance
