...
class CommutativeMatcher14080(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher14080._instance is None:
            CommutativeMatcher14080._instance = CommutativeMatcher14080()
        return CommutativeMatcher14080._instance
