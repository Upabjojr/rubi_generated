...
class CommutativeMatcher58128(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58128._instance is None:
            CommutativeMatcher58128._instance = CommutativeMatcher58128()
        return CommutativeMatcher58128._instance
