...
class CommutativeMatcher104575(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104575._instance is None:
            CommutativeMatcher104575._instance = CommutativeMatcher104575()
        return CommutativeMatcher104575._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher104587.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part001616 import *
from multiset import Multiset