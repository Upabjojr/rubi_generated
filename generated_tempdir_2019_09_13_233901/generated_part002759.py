...
class CommutativeMatcher30786(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30786._instance is None:
            CommutativeMatcher30786._instance = CommutativeMatcher30786()
        return CommutativeMatcher30786._instance
