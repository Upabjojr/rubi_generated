...
class CommutativeMatcher31987(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher31987._instance is None:
            CommutativeMatcher31987._instance = CommutativeMatcher31987()
        return CommutativeMatcher31987._instance
