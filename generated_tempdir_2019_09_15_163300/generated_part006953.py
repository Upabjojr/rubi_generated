...
class CommutativeMatcher89176(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher89176._instance is None:
            CommutativeMatcher89176._instance = CommutativeMatcher89176()
        return CommutativeMatcher89176._instance
