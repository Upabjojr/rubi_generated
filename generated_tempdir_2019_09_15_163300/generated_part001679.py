...
class CommutativeMatcher106171(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106171._instance is None:
            CommutativeMatcher106171._instance = CommutativeMatcher106171()
        return CommutativeMatcher106171._instance
