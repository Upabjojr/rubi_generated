...
class CommutativeMatcher41868(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41868._instance is None:
            CommutativeMatcher41868._instance = CommutativeMatcher41868()
        return CommutativeMatcher41868._instance
