...
class CommutativeMatcher102108(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher102108._instance is None:
            CommutativeMatcher102108._instance = CommutativeMatcher102108()
        return CommutativeMatcher102108._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher102112.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
