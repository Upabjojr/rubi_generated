...
class CommutativeMatcher83376(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher83376._instance is None:
            CommutativeMatcher83376._instance = CommutativeMatcher83376()
        return CommutativeMatcher83376._instance
