...
class CommutativeMatcher74306(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74306._instance is None:
            CommutativeMatcher74306._instance = CommutativeMatcher74306()
        return CommutativeMatcher74306._instance
