...
class CommutativeMatcher149754(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149754._instance is None:
            CommutativeMatcher149754._instance = CommutativeMatcher149754()
        return CommutativeMatcher149754._instance
