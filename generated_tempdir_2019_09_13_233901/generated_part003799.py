...
class CommutativeMatcher62291(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62291._instance is None:
            CommutativeMatcher62291._instance = CommutativeMatcher62291()
        return CommutativeMatcher62291._instance
