...
class CommutativeMatcher121920(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher121920._instance is None:
            CommutativeMatcher121920._instance = CommutativeMatcher121920()
        return CommutativeMatcher121920._instance
