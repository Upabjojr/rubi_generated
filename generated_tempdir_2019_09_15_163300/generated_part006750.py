...
class CommutativeMatcher111410(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111410._instance is None:
            CommutativeMatcher111410._instance = CommutativeMatcher111410()
        return CommutativeMatcher111410._instance
