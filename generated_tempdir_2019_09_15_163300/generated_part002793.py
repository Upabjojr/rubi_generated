...
class CommutativeMatcher22879(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22879._instance is None:
            CommutativeMatcher22879._instance = CommutativeMatcher22879()
        return CommutativeMatcher22879._instance
