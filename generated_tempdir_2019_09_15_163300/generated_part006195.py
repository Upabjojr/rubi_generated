...
class CommutativeMatcher63872(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63872._instance is None:
            CommutativeMatcher63872._instance = CommutativeMatcher63872()
        return CommutativeMatcher63872._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher63876.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part006196 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset