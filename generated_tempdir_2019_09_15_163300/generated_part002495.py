...
class CommutativeMatcher93072(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93072._instance is None:
            CommutativeMatcher93072._instance = CommutativeMatcher93072()
        return CommutativeMatcher93072._instance
