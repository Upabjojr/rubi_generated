...
class CommutativeMatcher105301(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105301._instance is None:
            CommutativeMatcher105301._instance = CommutativeMatcher105301()
        return CommutativeMatcher105301._instance
