...
class CommutativeMatcher135582(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135582._instance is None:
            CommutativeMatcher135582._instance = CommutativeMatcher135582()
        return CommutativeMatcher135582._instance
