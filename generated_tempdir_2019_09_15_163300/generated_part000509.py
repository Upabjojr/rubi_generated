...
class CommutativeMatcher43448(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43448._instance is None:
            CommutativeMatcher43448._instance = CommutativeMatcher43448()
        return CommutativeMatcher43448._instance
