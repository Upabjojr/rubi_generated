...
class CommutativeMatcher21253(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21253._instance is None:
            CommutativeMatcher21253._instance = CommutativeMatcher21253()
        return CommutativeMatcher21253._instance
