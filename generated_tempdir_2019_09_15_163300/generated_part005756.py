...
class CommutativeMatcher21231(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21231._instance is None:
            CommutativeMatcher21231._instance = CommutativeMatcher21231()
        return CommutativeMatcher21231._instance
