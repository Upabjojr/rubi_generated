...
class CommutativeMatcher108748(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher108748._instance is None:
            CommutativeMatcher108748._instance = CommutativeMatcher108748()
        return CommutativeMatcher108748._instance
