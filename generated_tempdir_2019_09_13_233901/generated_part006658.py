...
class CommutativeMatcher135930(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135930._instance is None:
            CommutativeMatcher135930._instance = CommutativeMatcher135930()
        return CommutativeMatcher135930._instance
