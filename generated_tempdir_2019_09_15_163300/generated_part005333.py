...
class CommutativeMatcher21964(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21964._instance is None:
            CommutativeMatcher21964._instance = CommutativeMatcher21964()
        return CommutativeMatcher21964._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher21968.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005334 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset