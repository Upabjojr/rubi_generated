...
class CommutativeMatcher62327(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62327._instance is None:
            CommutativeMatcher62327._instance = CommutativeMatcher62327()
        return CommutativeMatcher62327._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher62331.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part003759 import *
from multiset import Multiset