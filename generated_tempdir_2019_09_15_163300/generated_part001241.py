...
class CommutativeMatcher69053(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69053._instance is None:
            CommutativeMatcher69053._instance = CommutativeMatcher69053()
        return CommutativeMatcher69053._instance
