...
class CommutativeMatcher87241(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher87241._instance is None:
            CommutativeMatcher87241._instance = CommutativeMatcher87241()
        return CommutativeMatcher87241._instance
