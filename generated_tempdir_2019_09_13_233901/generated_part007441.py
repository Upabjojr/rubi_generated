...
class CommutativeMatcher49667(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49667._instance is None:
            CommutativeMatcher49667._instance = CommutativeMatcher49667()
        return CommutativeMatcher49667._instance
