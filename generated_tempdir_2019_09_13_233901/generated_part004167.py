...
class CommutativeMatcher111312(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111312._instance is None:
            CommutativeMatcher111312._instance = CommutativeMatcher111312()
        return CommutativeMatcher111312._instance
