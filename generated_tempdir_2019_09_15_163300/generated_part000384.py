...
class CommutativeMatcher43039(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43039._instance is None:
            CommutativeMatcher43039._instance = CommutativeMatcher43039()
        return CommutativeMatcher43039._instance
