...
class CommutativeMatcher23308(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23308._instance is None:
            CommutativeMatcher23308._instance = CommutativeMatcher23308()
        return CommutativeMatcher23308._instance
