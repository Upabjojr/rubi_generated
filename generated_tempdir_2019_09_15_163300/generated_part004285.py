...
class CommutativeMatcher134343(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134343._instance is None:
            CommutativeMatcher134343._instance = CommutativeMatcher134343()
        return CommutativeMatcher134343._instance
