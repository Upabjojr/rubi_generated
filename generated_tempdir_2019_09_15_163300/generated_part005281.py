...
class CommutativeMatcher126123(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126123._instance is None:
            CommutativeMatcher126123._instance = CommutativeMatcher126123()
        return CommutativeMatcher126123._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher126127.get()
            tmp19 = subjects18
            subjects18 = []
            for s in tmp19:
...
from matchpy.utils import VariableWithCount
from collections import deque
from .generated_part005282 import *
from multiset import Multiset