...
class CommutativeMatcher74079(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74079._instance is None:
            CommutativeMatcher74079._instance = CommutativeMatcher74079()
        return CommutativeMatcher74079._instance
