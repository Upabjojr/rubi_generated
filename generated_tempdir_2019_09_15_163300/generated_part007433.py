...
class CommutativeMatcher25155(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25155._instance is None:
            CommutativeMatcher25155._instance = CommutativeMatcher25155()
        return CommutativeMatcher25155._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher25161.get()
                    tmp12 = subjects11
                    subjects11 = []
                    for s in tmp12:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher25164.get()
                tmp15 = subjects14
                subjects14 = []
                for s in tmp15:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects17) >= 1 and isinstance(subjects17[0], Mul):
                    ...
                    matcher = CommutativeMatcher25178.get()
                    tmp37 = subjects36
                    subjects36 = []
                    for s in tmp37:
                        matcher.add_subject(s)
            ...
            if len(subjects17) >= 1 and isinstance(subjects17[0], Add):
                ...
                matcher = CommutativeMatcher25183.get()
                tmp52 = subjects51
                subjects51 = []
                for s in tmp52:
                    matcher.add_subject(s)
...
from .generated_part007437 import *
from .generated_part007438 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part007435 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part007434 import *