...
class CommutativeMatcher104164(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104164._instance is None:
            CommutativeMatcher104164._instance = CommutativeMatcher104164()
        return CommutativeMatcher104164._instance
