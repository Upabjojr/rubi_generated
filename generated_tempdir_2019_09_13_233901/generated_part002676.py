...
class CommutativeMatcher81323(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81323._instance is None:
            CommutativeMatcher81323._instance = CommutativeMatcher81323()
        return CommutativeMatcher81323._instance
