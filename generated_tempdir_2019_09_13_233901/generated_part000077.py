...
class CommutativeMatcher41709(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41709._instance is None:
            CommutativeMatcher41709._instance = CommutativeMatcher41709()
        return CommutativeMatcher41709._instance
