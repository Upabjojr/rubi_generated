...
class CommutativeMatcher124062(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher124062._instance is None:
            CommutativeMatcher124062._instance = CommutativeMatcher124062()
        return CommutativeMatcher124062._instance
