...
class CommutativeMatcher149630(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149630._instance is None:
            CommutativeMatcher149630._instance = CommutativeMatcher149630()
        return CommutativeMatcher149630._instance
