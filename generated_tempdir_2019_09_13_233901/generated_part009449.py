...
class CommutativeMatcher13466(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13466._instance is None:
            CommutativeMatcher13466._instance = CommutativeMatcher13466()
        return CommutativeMatcher13466._instance
