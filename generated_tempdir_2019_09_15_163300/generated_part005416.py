...
class CommutativeMatcher58373(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58373._instance is None:
            CommutativeMatcher58373._instance = CommutativeMatcher58373()
        return CommutativeMatcher58373._instance
