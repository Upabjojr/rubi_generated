...
class CommutativeMatcher30671(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30671._instance is None:
            CommutativeMatcher30671._instance = CommutativeMatcher30671()
        return CommutativeMatcher30671._instance
