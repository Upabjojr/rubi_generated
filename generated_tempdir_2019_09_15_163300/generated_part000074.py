...
class CommutativeMatcher41685(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41685._instance is None:
            CommutativeMatcher41685._instance = CommutativeMatcher41685()
        return CommutativeMatcher41685._instance
