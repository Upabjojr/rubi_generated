...
class CommutativeMatcher13819(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13819._instance is None:
            CommutativeMatcher13819._instance = CommutativeMatcher13819()
        return CommutativeMatcher13819._instance
