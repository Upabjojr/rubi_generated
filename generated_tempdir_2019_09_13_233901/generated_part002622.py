...
class CommutativeMatcher65047(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65047._instance is None:
            CommutativeMatcher65047._instance = CommutativeMatcher65047()
        return CommutativeMatcher65047._instance
