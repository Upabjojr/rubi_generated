...
class CommutativeMatcher105200(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105200._instance is None:
            CommutativeMatcher105200._instance = CommutativeMatcher105200()
        return CommutativeMatcher105200._instance
