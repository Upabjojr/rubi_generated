...
class CommutativeMatcher22046(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22046._instance is None:
            CommutativeMatcher22046._instance = CommutativeMatcher22046()
        return CommutativeMatcher22046._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher22050.get()
            tmp20 = subjects19
            subjects19 = []
            for s in tmp20:
...
from .generated_part005365 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset