...
class CommutativeMatcher111228(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111228._instance is None:
            CommutativeMatcher111228._instance = CommutativeMatcher111228()
        return CommutativeMatcher111228._instance
