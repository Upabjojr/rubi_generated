...
class CommutativeMatcher19602(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher19602._instance is None:
            CommutativeMatcher19602._instance = CommutativeMatcher19602()
        return CommutativeMatcher19602._instance
        ...
        try:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher19608.get()
                    tmp8 = subjects7
                    subjects7 = []
                    for s in tmp8:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher19611.get()
                tmp11 = subjects10
                subjects10 = []
                for s in tmp11:
                    matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            try:
                ...
                if len(subjects13) >= 1 and isinstance(subjects13[0], Mul):
                    ...
                    matcher = CommutativeMatcher19625.get()
                    tmp23 = subjects22
                    subjects22 = []
                    for s in tmp23:
                        matcher.add_subject(s)
            ...
            if len(subjects13) >= 1 and isinstance(subjects13[0], Add):
                ...
                matcher = CommutativeMatcher19630.get()
                tmp30 = subjects29
                subjects29 = []
                for s in tmp30:
                    matcher.add_subject(s)
...
from .generated_part009280 import *
from .generated_part009281 import *
from .generated_part009277 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part009278 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset