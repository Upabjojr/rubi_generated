...
class CommutativeMatcher30728(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30728._instance is None:
            CommutativeMatcher30728._instance = CommutativeMatcher30728()
        return CommutativeMatcher30728._instance
