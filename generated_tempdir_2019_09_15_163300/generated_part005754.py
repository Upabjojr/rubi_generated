...
class CommutativeMatcher21219(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21219._instance is None:
            CommutativeMatcher21219._instance = CommutativeMatcher21219()
        return CommutativeMatcher21219._instance
