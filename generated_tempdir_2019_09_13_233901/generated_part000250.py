...
class CommutativeMatcher111573(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher111573._instance is None:
            CommutativeMatcher111573._instance = CommutativeMatcher111573()
        return CommutativeMatcher111573._instance
