...
class CommutativeMatcher20949(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20949._instance is None:
            CommutativeMatcher20949._instance = CommutativeMatcher20949()
        return CommutativeMatcher20949._instance
