...
class CommutativeMatcher140836(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140836._instance is None:
            CommutativeMatcher140836._instance = CommutativeMatcher140836()
        return CommutativeMatcher140836._instance
