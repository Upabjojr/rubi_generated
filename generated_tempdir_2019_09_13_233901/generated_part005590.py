...
class CommutativeMatcher32197(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32197._instance is None:
            CommutativeMatcher32197._instance = CommutativeMatcher32197()
        return CommutativeMatcher32197._instance
