...
class CommutativeMatcher33674(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33674._instance is None:
            CommutativeMatcher33674._instance = CommutativeMatcher33674()
        return CommutativeMatcher33674._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher33683.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part005396 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset