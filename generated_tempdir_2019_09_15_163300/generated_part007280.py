...
class CommutativeMatcher58549(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58549._instance is None:
            CommutativeMatcher58549._instance = CommutativeMatcher58549()
        return CommutativeMatcher58549._instance
