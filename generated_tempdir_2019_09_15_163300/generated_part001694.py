...
class CommutativeMatcher134830(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134830._instance is None:
            CommutativeMatcher134830._instance = CommutativeMatcher134830()
        return CommutativeMatcher134830._instance
