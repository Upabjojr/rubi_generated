...
class CommutativeMatcher65057(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher65057._instance is None:
            CommutativeMatcher65057._instance = CommutativeMatcher65057()
        return CommutativeMatcher65057._instance
