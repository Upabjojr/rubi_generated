...
class CommutativeMatcher41842(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41842._instance is None:
            CommutativeMatcher41842._instance = CommutativeMatcher41842()
        return CommutativeMatcher41842._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41849.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000091 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset