...
class CommutativeMatcher64617(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher64617._instance is None:
            CommutativeMatcher64617._instance = CommutativeMatcher64617()
        return CommutativeMatcher64617._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects12) >= 1 and isinstance(subjects12[0], Mul):
                ...
                matcher = CommutativeMatcher106429.get()
                tmp26 = subjects25
                subjects25 = []
                for s in tmp26:
...
from .generated_part006646 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset