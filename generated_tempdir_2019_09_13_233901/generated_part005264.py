...
class CommutativeMatcher62060(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher62060._instance is None:
            CommutativeMatcher62060._instance = CommutativeMatcher62060()
        return CommutativeMatcher62060._instance
