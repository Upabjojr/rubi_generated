...
class CommutativeMatcher42794(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42794._instance is None:
            CommutativeMatcher42794._instance = CommutativeMatcher42794()
        return CommutativeMatcher42794._instance
