...
class CommutativeMatcher13372(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13372._instance is None:
            CommutativeMatcher13372._instance = CommutativeMatcher13372()
        return CommutativeMatcher13372._instance
