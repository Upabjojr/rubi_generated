...
class CommutativeMatcher59418(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59418._instance is None:
            CommutativeMatcher59418._instance = CommutativeMatcher59418()
        return CommutativeMatcher59418._instance
