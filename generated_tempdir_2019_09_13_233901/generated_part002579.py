...
class CommutativeMatcher22424(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22424._instance is None:
            CommutativeMatcher22424._instance = CommutativeMatcher22424()
        return CommutativeMatcher22424._instance
