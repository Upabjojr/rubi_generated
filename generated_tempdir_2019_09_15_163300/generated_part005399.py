...
class CommutativeMatcher22158(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22158._instance is None:
            CommutativeMatcher22158._instance = CommutativeMatcher22158()
        return CommutativeMatcher22158._instance
