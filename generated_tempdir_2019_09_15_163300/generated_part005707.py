...
class CommutativeMatcher93162(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93162._instance is None:
            CommutativeMatcher93162._instance = CommutativeMatcher93162()
        return CommutativeMatcher93162._instance
