...
class CommutativeMatcher104810(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher104810._instance is None:
            CommutativeMatcher104810._instance = CommutativeMatcher104810()
        return CommutativeMatcher104810._instance
