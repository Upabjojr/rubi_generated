...
class CommutativeMatcher149841(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149841._instance is None:
            CommutativeMatcher149841._instance = CommutativeMatcher149841()
        return CommutativeMatcher149841._instance
