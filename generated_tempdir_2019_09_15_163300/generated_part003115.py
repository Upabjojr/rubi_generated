...
class CommutativeMatcher78559(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78559._instance is None:
            CommutativeMatcher78559._instance = CommutativeMatcher78559()
        return CommutativeMatcher78559._instance
