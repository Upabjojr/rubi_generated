...
class CommutativeMatcher116957(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116957._instance is None:
            CommutativeMatcher116957._instance = CommutativeMatcher116957()
        return CommutativeMatcher116957._instance
