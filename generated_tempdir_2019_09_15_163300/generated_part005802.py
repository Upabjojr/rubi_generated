...
class CommutativeMatcher32681(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32681._instance is None:
            CommutativeMatcher32681._instance = CommutativeMatcher32681()
        return CommutativeMatcher32681._instance
