...
class CommutativeMatcher77506(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher77506._instance is None:
            CommutativeMatcher77506._instance = CommutativeMatcher77506()
        return CommutativeMatcher77506._instance
