...
class CommutativeMatcher42949(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42949._instance is None:
            CommutativeMatcher42949._instance = CommutativeMatcher42949()
        return CommutativeMatcher42949._instance
