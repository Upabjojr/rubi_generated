...
class CommutativeMatcher129369(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher129369._instance is None:
            CommutativeMatcher129369._instance = CommutativeMatcher129369()
        return CommutativeMatcher129369._instance
