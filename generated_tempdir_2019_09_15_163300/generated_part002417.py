...
class CommutativeMatcher23561(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23561._instance is None:
            CommutativeMatcher23561._instance = CommutativeMatcher23561()
        return CommutativeMatcher23561._instance
