...
class CommutativeMatcher67107(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher67107._instance is None:
            CommutativeMatcher67107._instance = CommutativeMatcher67107()
        return CommutativeMatcher67107._instance
