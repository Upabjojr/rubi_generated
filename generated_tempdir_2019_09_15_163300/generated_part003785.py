...
class CommutativeMatcher63969(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63969._instance is None:
            CommutativeMatcher63969._instance = CommutativeMatcher63969()
        return CommutativeMatcher63969._instance
