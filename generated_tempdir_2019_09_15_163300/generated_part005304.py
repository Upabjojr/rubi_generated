...
class CommutativeMatcher21865(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21865._instance is None:
            CommutativeMatcher21865._instance = CommutativeMatcher21865()
        return CommutativeMatcher21865._instance
