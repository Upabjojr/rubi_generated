...
class CommutativeMatcher105682(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105682._instance is None:
            CommutativeMatcher105682._instance = CommutativeMatcher105682()
        return CommutativeMatcher105682._instance
