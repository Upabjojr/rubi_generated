...
class CommutativeMatcher142657(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher142657._instance is None:
            CommutativeMatcher142657._instance = CommutativeMatcher142657()
        return CommutativeMatcher142657._instance
