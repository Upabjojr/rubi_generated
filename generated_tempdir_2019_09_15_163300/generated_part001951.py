...
class CommutativeMatcher23245(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23245._instance is None:
            CommutativeMatcher23245._instance = CommutativeMatcher23245()
        return CommutativeMatcher23245._instance
