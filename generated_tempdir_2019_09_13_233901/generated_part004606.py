...
class CommutativeMatcher126103(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126103._instance is None:
            CommutativeMatcher126103._instance = CommutativeMatcher126103()
        return CommutativeMatcher126103._instance
