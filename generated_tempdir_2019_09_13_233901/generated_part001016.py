...
class CommutativeMatcher53752(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher53752._instance is None:
            CommutativeMatcher53752._instance = CommutativeMatcher53752()
        return CommutativeMatcher53752._instance
