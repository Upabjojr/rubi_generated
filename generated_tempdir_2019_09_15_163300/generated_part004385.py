...
class CommutativeMatcher128812(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher128812._instance is None:
            CommutativeMatcher128812._instance = CommutativeMatcher128812()
        return CommutativeMatcher128812._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects12) >= 1 and isinstance(subjects12[0], Mul):
                ...
                matcher = CommutativeMatcher136338.get()
                tmp26 = subjects25
                subjects25 = []
                for s in tmp26:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part004386 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset