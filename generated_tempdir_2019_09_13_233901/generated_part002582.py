...
class CommutativeMatcher30358(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30358._instance is None:
            CommutativeMatcher30358._instance = CommutativeMatcher30358()
        return CommutativeMatcher30358._instance
