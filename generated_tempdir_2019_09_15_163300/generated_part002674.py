...
class CommutativeMatcher81313(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher81313._instance is None:
            CommutativeMatcher81313._instance = CommutativeMatcher81313()
        return CommutativeMatcher81313._instance
