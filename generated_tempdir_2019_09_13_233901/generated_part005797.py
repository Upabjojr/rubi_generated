...
class CommutativeMatcher21345(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21345._instance is None:
            CommutativeMatcher21345._instance = CommutativeMatcher21345()
        return CommutativeMatcher21345._instance
