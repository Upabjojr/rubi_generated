...
class CommutativeMatcher83408(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher83408._instance is None:
            CommutativeMatcher83408._instance = CommutativeMatcher83408()
        return CommutativeMatcher83408._instance
