...
class CommutativeMatcher42628(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42628._instance is None:
            CommutativeMatcher42628._instance = CommutativeMatcher42628()
        return CommutativeMatcher42628._instance
