...
class CommutativeMatcher33227(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher33227._instance is None:
            CommutativeMatcher33227._instance = CommutativeMatcher33227()
        return CommutativeMatcher33227._instance
