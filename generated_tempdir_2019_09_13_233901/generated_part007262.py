...
class CommutativeMatcher25930(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher25930._instance is None:
            CommutativeMatcher25930._instance = CommutativeMatcher25930()
        return CommutativeMatcher25930._instance
