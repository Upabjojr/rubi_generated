...
class CommutativeMatcher41249(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41249._instance is None:
            CommutativeMatcher41249._instance = CommutativeMatcher41249()
        return CommutativeMatcher41249._instance
