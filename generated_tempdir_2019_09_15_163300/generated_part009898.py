...
class CommutativeMatcher105702(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher105702._instance is None:
            CommutativeMatcher105702._instance = CommutativeMatcher105702()
        return CommutativeMatcher105702._instance
