...
class CommutativeMatcher140052(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140052._instance is None:
            CommutativeMatcher140052._instance = CommutativeMatcher140052()
        return CommutativeMatcher140052._instance
