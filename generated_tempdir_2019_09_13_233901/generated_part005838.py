...
class CommutativeMatcher60071(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher60071._instance is None:
            CommutativeMatcher60071._instance = CommutativeMatcher60071()
        return CommutativeMatcher60071._instance
