...
class CommutativeMatcher74182(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher74182._instance is None:
            CommutativeMatcher74182._instance = CommutativeMatcher74182()
        return CommutativeMatcher74182._instance
