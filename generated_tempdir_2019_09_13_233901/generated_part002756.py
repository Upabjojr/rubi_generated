...
class CommutativeMatcher22761(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22761._instance is None:
            CommutativeMatcher22761._instance = CommutativeMatcher22761()
        return CommutativeMatcher22761._instance
