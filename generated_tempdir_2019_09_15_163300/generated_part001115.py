...
class CommutativeMatcher140086(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher140086._instance is None:
            CommutativeMatcher140086._instance = CommutativeMatcher140086()
        return CommutativeMatcher140086._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher140090.get()
            tmp6 = subjects5
            subjects5 = []
            for s in tmp6:
...
from multiset import Multiset
from matchpy.utils import VariableWithCount
from .generated_part001116 import *