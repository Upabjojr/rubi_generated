...
class CommutativeMatcher93136(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher93136._instance is None:
            CommutativeMatcher93136._instance = CommutativeMatcher93136()
        return CommutativeMatcher93136._instance
