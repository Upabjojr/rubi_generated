...
class CommutativeMatcher134230(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134230._instance is None:
            CommutativeMatcher134230._instance = CommutativeMatcher134230()
        return CommutativeMatcher134230._instance
