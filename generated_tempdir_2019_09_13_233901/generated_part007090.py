...
class CommutativeMatcher150230(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150230._instance is None:
            CommutativeMatcher150230._instance = CommutativeMatcher150230()
        return CommutativeMatcher150230._instance
