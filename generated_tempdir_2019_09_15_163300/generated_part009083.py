...
class CommutativeMatcher50515(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher50515._instance is None:
            CommutativeMatcher50515._instance = CommutativeMatcher50515()
        return CommutativeMatcher50515._instance
    ...
    def get_match_iter(subject):
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Pow):
                ...
                try:
                    ...
                    if len(subjects3) >= 1 and isinstance(subjects3[0], Mul):
                        ...
                        matcher = CommutativeMatcher52360.get()
                        tmp14 = subjects13
                        subjects13 = []
                        for s in tmp14:
                ...
                if len(subjects3) >= 1 and isinstance(subjects3[0], Add):
                    ...
                    matcher = CommutativeMatcher52365.get()
                    tmp18 = subjects17
                    subjects17 = []
                    for s in tmp18:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher50522.get()
            tmp22 = subjects21
            subjects21 = []
            for s in tmp22:
                matcher.add_subject(s)
...
from .generated_part009087 import *
from .generated_part009085 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part009084 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset