...
class CommutativeMatcher106546(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106546._instance is None:
            CommutativeMatcher106546._instance = CommutativeMatcher106546()
        return CommutativeMatcher106546._instance
