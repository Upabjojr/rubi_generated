...
class CommutativeMatcher87527(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher87527._instance is None:
            CommutativeMatcher87527._instance = CommutativeMatcher87527()
        return CommutativeMatcher87527._instance
