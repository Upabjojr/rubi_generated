...
class CommutativeMatcher23421(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23421._instance is None:
            CommutativeMatcher23421._instance = CommutativeMatcher23421()
        return CommutativeMatcher23421._instance
