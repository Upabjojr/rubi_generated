...
class CommutativeMatcher138452(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher138452._instance is None:
            CommutativeMatcher138452._instance = CommutativeMatcher138452()
        return CommutativeMatcher138452._instance
