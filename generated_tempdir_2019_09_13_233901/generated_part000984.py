...
class CommutativeMatcher141385(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher141385._instance is None:
            CommutativeMatcher141385._instance = CommutativeMatcher141385()
        return CommutativeMatcher141385._instance
