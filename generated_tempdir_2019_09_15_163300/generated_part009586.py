...
class CommutativeMatcher58120(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58120._instance is None:
            CommutativeMatcher58120._instance = CommutativeMatcher58120()
        return CommutativeMatcher58120._instance
