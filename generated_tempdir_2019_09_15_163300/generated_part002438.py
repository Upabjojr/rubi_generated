...
class CommutativeMatcher58335(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58335._instance is None:
            CommutativeMatcher58335._instance = CommutativeMatcher58335()
        return CommutativeMatcher58335._instance
