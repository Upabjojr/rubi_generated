...
class CommutativeMatcher58104(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58104._instance is None:
            CommutativeMatcher58104._instance = CommutativeMatcher58104()
        return CommutativeMatcher58104._instance
