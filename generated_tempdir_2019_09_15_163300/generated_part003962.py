...
class CommutativeMatcher49431(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher49431._instance is None:
            CommutativeMatcher49431._instance = CommutativeMatcher49431()
        return CommutativeMatcher49431._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher49438.get()
            tmp17 = subjects16
            subjects16 = []
            for s in tmp17:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part003963 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset