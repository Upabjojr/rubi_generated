...
class CommutativeMatcher133519(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133519._instance is None:
            CommutativeMatcher133519._instance = CommutativeMatcher133519()
        return CommutativeMatcher133519._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], log):
            ...
            if len(subjects2) >= 1 and isinstance(subjects2[0], Mul):
                ...
                matcher = CommutativeMatcher133531.get()
                tmp16 = subjects15
                subjects15 = []
                for s in tmp16:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from .generated_part001632 import *
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset