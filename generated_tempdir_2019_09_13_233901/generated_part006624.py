...
class CommutativeMatcher59216(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher59216._instance is None:
            CommutativeMatcher59216._instance = CommutativeMatcher59216()
        return CommutativeMatcher59216._instance
