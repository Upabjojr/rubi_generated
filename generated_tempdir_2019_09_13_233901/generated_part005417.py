...
class CommutativeMatcher58478(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher58478._instance is None:
            CommutativeMatcher58478._instance = CommutativeMatcher58478()
        return CommutativeMatcher58478._instance
