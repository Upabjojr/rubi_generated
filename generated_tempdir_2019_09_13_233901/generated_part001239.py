...
class CommutativeMatcher69043(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher69043._instance is None:
            CommutativeMatcher69043._instance = CommutativeMatcher69043()
        return CommutativeMatcher69043._instance
