...
class CommutativeMatcher63747(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher63747._instance is None:
            CommutativeMatcher63747._instance = CommutativeMatcher63747()
        return CommutativeMatcher63747._instance
