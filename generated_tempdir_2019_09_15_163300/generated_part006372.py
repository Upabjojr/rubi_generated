...
class CommutativeMatcher92745(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher92745._instance is None:
            CommutativeMatcher92745._instance = CommutativeMatcher92745()
        return CommutativeMatcher92745._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher92749.get()
            tmp13 = subjects12
            subjects12 = []
            for s in tmp13:
...
from .generated_part006373 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset