...
class CommutativeMatcher134719(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher134719._instance is None:
            CommutativeMatcher134719._instance = CommutativeMatcher134719()
        return CommutativeMatcher134719._instance
