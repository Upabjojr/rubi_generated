...
class CommutativeMatcher42302(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher42302._instance is None:
            CommutativeMatcher42302._instance = CommutativeMatcher42302()
        return CommutativeMatcher42302._instance
