...
class CommutativeMatcher106314(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher106314._instance is None:
            CommutativeMatcher106314._instance = CommutativeMatcher106314()
        return CommutativeMatcher106314._instance
