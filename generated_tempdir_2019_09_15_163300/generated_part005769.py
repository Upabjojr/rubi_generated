...
class CommutativeMatcher21272(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21272._instance is None:
            CommutativeMatcher21272._instance = CommutativeMatcher21272()
        return CommutativeMatcher21272._instance
