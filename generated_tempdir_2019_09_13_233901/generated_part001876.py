...
class CommutativeMatcher22995(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22995._instance is None:
            CommutativeMatcher22995._instance = CommutativeMatcher22995()
        return CommutativeMatcher22995._instance
