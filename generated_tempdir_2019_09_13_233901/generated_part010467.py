...
class CommutativeMatcher133819(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher133819._instance is None:
            CommutativeMatcher133819._instance = CommutativeMatcher133819()
        return CommutativeMatcher133819._instance
