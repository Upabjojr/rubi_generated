...
class CommutativeMatcher41934(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41934._instance is None:
            CommutativeMatcher41934._instance = CommutativeMatcher41934()
        return CommutativeMatcher41934._instance
