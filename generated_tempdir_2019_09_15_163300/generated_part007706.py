...
class CommutativeMatcher75496(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher75496._instance is None:
            CommutativeMatcher75496._instance = CommutativeMatcher75496()
        return CommutativeMatcher75496._instance
