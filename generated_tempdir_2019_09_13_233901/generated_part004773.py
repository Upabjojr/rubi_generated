...
class CommutativeMatcher126208(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126208._instance is None:
            CommutativeMatcher126208._instance = CommutativeMatcher126208()
        return CommutativeMatcher126208._instance
