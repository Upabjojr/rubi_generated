...
class CommutativeMatcher30101(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30101._instance is None:
            CommutativeMatcher30101._instance = CommutativeMatcher30101()
        return CommutativeMatcher30101._instance
