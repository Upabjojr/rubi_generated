...
class CommutativeMatcher22638(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22638._instance is None:
            CommutativeMatcher22638._instance = CommutativeMatcher22638()
        return CommutativeMatcher22638._instance
