...
class CommutativeMatcher135432(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135432._instance is None:
            CommutativeMatcher135432._instance = CommutativeMatcher135432()
        return CommutativeMatcher135432._instance
