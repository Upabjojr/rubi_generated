...
class CommutativeMatcher43192(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43192._instance is None:
            CommutativeMatcher43192._instance = CommutativeMatcher43192()
        return CommutativeMatcher43192._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher43195.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher55043.get()
                    tmp13 = subjects12
                    subjects12 = []
                    for s in tmp13:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects15) >= 1 and isinstance(subjects15[0], Add):
                ...
                matcher = CommutativeMatcher43214.get()
                tmp18 = subjects17
                subjects17 = []
                for s in tmp18:
                    matcher.add_subject(s)
            ...
            try:
                ...
                if len(subjects15) >= 1 and isinstance(subjects15[0], Mul):
                    ...
                    matcher = CommutativeMatcher55054.get()
                    tmp41 = subjects40
                    subjects40 = []
                    for s in tmp41:
                        matcher.add_subject(s)
...
from .generated_part000474 import *
from .generated_part000475 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part000472 import *
from .generated_part000477 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset