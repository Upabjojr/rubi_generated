...
class CommutativeMatcher149901(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149901._instance is None:
            CommutativeMatcher149901._instance = CommutativeMatcher149901()
        return CommutativeMatcher149901._instance
