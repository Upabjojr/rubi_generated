...
class CommutativeMatcher23377(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23377._instance is None:
            CommutativeMatcher23377._instance = CommutativeMatcher23377()
        return CommutativeMatcher23377._instance
