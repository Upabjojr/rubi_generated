...
class CommutativeMatcher23325(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23325._instance is None:
            CommutativeMatcher23325._instance = CommutativeMatcher23325()
        return CommutativeMatcher23325._instance
