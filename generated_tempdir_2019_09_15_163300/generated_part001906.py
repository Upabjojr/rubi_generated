...
class CommutativeMatcher23099(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23099._instance is None:
            CommutativeMatcher23099._instance = CommutativeMatcher23099()
        return CommutativeMatcher23099._instance
