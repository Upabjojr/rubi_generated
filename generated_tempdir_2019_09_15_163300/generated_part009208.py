...
class CommutativeMatcher13430(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher13430._instance is None:
            CommutativeMatcher13430._instance = CommutativeMatcher13430()
        return CommutativeMatcher13430._instance
