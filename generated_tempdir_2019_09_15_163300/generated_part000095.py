...
class CommutativeMatcher41884(CommutativeMatcher):
    _instance = None
    patterns = {
    ...
    @staticmethod
    def get():
        if CommutativeMatcher41884._instance is None:
            CommutativeMatcher41884._instance = CommutativeMatcher41884()
        return CommutativeMatcher41884._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher41891.get()
            tmp12 = subjects11
            subjects11 = []
            for s in tmp12:
...
from .generated_part000096 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset