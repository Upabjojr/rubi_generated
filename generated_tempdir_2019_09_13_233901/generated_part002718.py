...
class CommutativeMatcher30612(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30612._instance is None:
            CommutativeMatcher30612._instance = CommutativeMatcher30612()
        return CommutativeMatcher30612._instance
