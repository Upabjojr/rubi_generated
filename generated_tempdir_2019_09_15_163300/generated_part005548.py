...
class CommutativeMatcher20855(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher20855._instance is None:
            CommutativeMatcher20855._instance = CommutativeMatcher20855()
        return CommutativeMatcher20855._instance
