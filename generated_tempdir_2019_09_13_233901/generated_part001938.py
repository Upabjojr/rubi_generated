...
class CommutativeMatcher23205(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher23205._instance is None:
            CommutativeMatcher23205._instance = CommutativeMatcher23205()
        return CommutativeMatcher23205._instance
