...
class CommutativeMatcher120864(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher120864._instance is None:
            CommutativeMatcher120864._instance = CommutativeMatcher120864()
        return CommutativeMatcher120864._instance
