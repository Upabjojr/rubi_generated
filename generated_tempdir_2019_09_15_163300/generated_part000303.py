...
class CommutativeMatcher146104(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher146104._instance is None:
            CommutativeMatcher146104._instance = CommutativeMatcher146104()
        return CommutativeMatcher146104._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher146113.get()
            tmp14 = subjects13
            subjects13 = []
            for s in tmp14:
...
from .generated_part000304 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset