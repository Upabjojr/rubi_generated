...
class CommutativeMatcher116695(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher116695._instance is None:
            CommutativeMatcher116695._instance = CommutativeMatcher116695()
        return CommutativeMatcher116695._instance
