...
class CommutativeMatcher151521(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher151521._instance is None:
            CommutativeMatcher151521._instance = CommutativeMatcher151521()
        return CommutativeMatcher151521._instance
