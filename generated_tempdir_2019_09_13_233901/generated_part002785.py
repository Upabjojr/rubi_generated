...
class CommutativeMatcher30897(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher30897._instance is None:
            CommutativeMatcher30897._instance = CommutativeMatcher30897()
        return CommutativeMatcher30897._instance
