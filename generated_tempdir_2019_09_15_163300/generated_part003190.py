...
class CommutativeMatcher78460(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78460._instance is None:
            CommutativeMatcher78460._instance = CommutativeMatcher78460()
        return CommutativeMatcher78460._instance
