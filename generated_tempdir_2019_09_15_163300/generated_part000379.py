...
class CommutativeMatcher43010(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher43010._instance is None:
            CommutativeMatcher43010._instance = CommutativeMatcher43010()
        return CommutativeMatcher43010._instance
    ...
    def get_match_iter(subject):
        ...
        try:
            ...
            if len(subjects) >= 1 and isinstance(subjects[0], Add):
                ...
                matcher = CommutativeMatcher43013.get()
                tmp4 = subjects3
                subjects3 = []
                for s in tmp4:
            ...
            try:
                ...
                if len(subjects) >= 1 and isinstance(subjects[0], Mul):
                    ...
                    matcher = CommutativeMatcher54923.get()
                    tmp13 = subjects12
                    subjects12 = []
                    for s in tmp13:
                        matcher.add_subject(s)
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Pow):
            ...
            if len(subjects15) >= 1 and isinstance(subjects15[0], Add):
                ...
                matcher = CommutativeMatcher43032.get()
                tmp18 = subjects17
                subjects17 = []
                for s in tmp18:
                    matcher.add_subject(s)
            ...
            try:
                ...
                if len(subjects15) >= 1 and isinstance(subjects15[0], Mul):
                    ...
                    matcher = CommutativeMatcher54934.get()
                    tmp41 = subjects40
                    subjects40 = []
                    for s in tmp41:
                        matcher.add_subject(s)
...
from .generated_part000385 import *
from .generated_part000380 import *
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from matchpy.utils import VariableWithCount
from multiset import Multiset
from .generated_part000382 import *
from .generated_part000383 import *