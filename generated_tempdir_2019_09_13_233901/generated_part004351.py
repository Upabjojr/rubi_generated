...
class CommutativeMatcher150196(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher150196._instance is None:
            CommutativeMatcher150196._instance = CommutativeMatcher150196()
        return CommutativeMatcher150196._instance
