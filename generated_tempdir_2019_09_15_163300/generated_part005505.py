...
class CommutativeMatcher126482(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher126482._instance is None:
            CommutativeMatcher126482._instance = CommutativeMatcher126482()
        return CommutativeMatcher126482._instance
