...
class CommutativeMatcher21474(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher21474._instance is None:
            CommutativeMatcher21474._instance = CommutativeMatcher21474()
        return CommutativeMatcher21474._instance
