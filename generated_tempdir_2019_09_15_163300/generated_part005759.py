...
class CommutativeMatcher32512(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32512._instance is None:
            CommutativeMatcher32512._instance = CommutativeMatcher32512()
        return CommutativeMatcher32512._instance
