...
class CommutativeMatcher70487(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher70487._instance is None:
            CommutativeMatcher70487._instance = CommutativeMatcher70487()
        return CommutativeMatcher70487._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher70491.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part001742 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset