...
class CommutativeMatcher149954(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher149954._instance is None:
            CommutativeMatcher149954._instance = CommutativeMatcher149954()
        return CommutativeMatcher149954._instance
