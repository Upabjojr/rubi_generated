...
class CommutativeMatcher22031(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher22031._instance is None:
            CommutativeMatcher22031._instance = CommutativeMatcher22031()
        return CommutativeMatcher22031._instance
