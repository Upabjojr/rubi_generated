...
class CommutativeMatcher32768(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher32768._instance is None:
            CommutativeMatcher32768._instance = CommutativeMatcher32768()
        return CommutativeMatcher32768._instance
