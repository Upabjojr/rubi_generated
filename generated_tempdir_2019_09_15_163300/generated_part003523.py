...
class CommutativeMatcher78011(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher78011._instance is None:
            CommutativeMatcher78011._instance = CommutativeMatcher78011()
        return CommutativeMatcher78011._instance
