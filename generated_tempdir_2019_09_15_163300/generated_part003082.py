...
class CommutativeMatcher61468(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher61468._instance is None:
            CommutativeMatcher61468._instance = CommutativeMatcher61468()
        return CommutativeMatcher61468._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher61472.get()
            tmp9 = subjects8
            subjects8 = []
            for s in tmp9:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part003083 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset