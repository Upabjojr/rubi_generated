...
class CommutativeMatcher135981(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher135981._instance is None:
            CommutativeMatcher135981._instance = CommutativeMatcher135981()
        return CommutativeMatcher135981._instance
