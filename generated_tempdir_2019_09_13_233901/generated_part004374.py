...
class CommutativeMatcher136207(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher136207._instance is None:
            CommutativeMatcher136207._instance = CommutativeMatcher136207()
        return CommutativeMatcher136207._instance
