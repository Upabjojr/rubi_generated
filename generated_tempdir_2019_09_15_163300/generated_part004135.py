...
class CommutativeMatcher47505(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher47505._instance is None:
            CommutativeMatcher47505._instance = CommutativeMatcher47505()
        return CommutativeMatcher47505._instance
    ...
    def get_match_iter(subject):
        ...
        if len(subjects) >= 1 and isinstance(subjects[0], Mul):
            ...
            matcher = CommutativeMatcher47509.get()
            tmp11 = subjects10
            subjects10 = []
            for s in tmp11:
...
from matchpy.matching.many_to_one import CommutativeMatcher
from collections import deque
from .generated_part004136 import *
from matchpy.utils import VariableWithCount
from multiset import Multiset